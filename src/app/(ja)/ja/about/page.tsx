...
const chapters = [
  {
    ...
    body: 'ホステル、SIMカード、銀行口座、そしてできるだけ早く仕事。TFN（タックスファイルナンバー）もリストのどこかにはありました。オーストラリアの会計年度の仕組みを説明してくれる人は誰もいませんでした。',
  },
  {
    stage: '最初の給与明細',
    title: 'TFNが届く前に、最初の仕事が始まった',
    body: 'TFNが登録されていないと、雇用主はワーホリの通常の税率である15%ではなく、最も高い税率で源泉徴収することが義務づけられています。だから最初の数週間分は、半分近くが引かれています。\n\nこの分は、自動で戻ってくるものではありません。',
  },
  {
    stage: 'クリスマスまでに',
    title: '雇用主は4つ、半分はカジュアル、誰も何も教えてくれない',
    body: 'ホステルの仕事、カフェ、3週間だけの倉庫、そして最後の給与明細をもらえないまま辞めた仕事。オーストラリアの会計年度は、12月ではなく6月に終わります。\n\n給与明細をなくしていても問題ありません。雇用主が報告した内容は、ATOを通じて私たちに見えます。',
  },
  {
    stage: '88日',
    title: 'やったのなら、そのためにかなり遠くまで行ったはずです',
    body: '西へ、北へ、聞いたこともない町からさらに3時間。\n\n宿泊費は受け取る前の給料から直接引かれ、給与明細も都市部のものとは形が違っていて、この期間についてはみなさん一番自信がありません。',
  },
  {
    stage: '帰りの飛行機',
    title: 'あなたは帰り、お金は残った',
    body: 'スーパーアニュエーションは、オーストラリアを出国してビザが失効した後でなければ請求できません。だからあなたの分は、自分で選んだ覚えもないファンドにまだ残っています。最初の数週間に引かれすぎた税金も、ATOにそのままあります。',
  },
]
...
const faqs = [
  {
    ...
    answer: 'ワーキングホリデーの方だけです。お客様は全員、417または462ビザでオーストラリアにいる方か、かつてそのビザで滞在して現在は帰国された方です。オーストラリアの居住者、学生ビザの方、就労ビザの方、法人のお客様はお受けしていません。',
  },
  {
  ...
  },
  {
    ...
    answer: '料金は、当社チームによる確定申告の全面的な確認作業に対するものであり、結果によって変わることはありません。還付や課税額はATOが決定するため、料金の返金はできません。すべてのワーホリの1年に還付が出るわけではないので、見込みが薄いのであれば、引き受けて期待させるより先にお伝えします。',
  },
]
        ...
        <div className="max-w-[1280px] mx-auto px-5 md:px-8 lg:px-12">
          <div className="max-w-[680px] mx-auto">
            ...
            <p style={{ ...bodyStyle, marginBottom: '30px' }}>
              417・462ビザのほぼ全員に、おおよそこの順番で5つのことが起きます。そのうち4つは、あとから取り戻せることが多いお金の話です。
            </p>
            ...
            <ol style={{ listStyle: 'none', margin: 0, padding: 0 }}>
              {chapters.map((c, i) => (
                <li key={i} style={{
                  ...
                  {/* 段落ごとに1つの<p>。4文の章はスマホでは壁になる。空行は
                      話の転換点に置いてあり、途中で切ってはいない。 */}
                  {c.body.split('\n\n').map((para, j, all) => (
        ...
        <div className="max-w-[1280px] mx-auto px-5 md:px-8 lg:px-12">
          <div className="max-w-[680px] mx-auto">
            ...
            <p style={{ ...bodyStyle, marginBottom: '14px' }}>
              お客様は全員417または462ビザの方なので、あなたの還付額を左右する要素は、調べ直さなければならない珍しいケースではありません。毎日それを見ています。
            </p>
            {/* 移動3：会計士の一文と、その1年に何が入っているかの列挙が
                1段落で、スマホでは8行の塊になっていた。 */}
            <p style={{ ...bodyStyle, marginBottom: '14px' }}>
              一般の会計士がバックパッカーに会うのは、7月に、200件の普通の申告の合間に年に数回です。
            </p>
            <p style={{ ...bodyStyle, marginBottom: '14px' }}>
              417・462の税率表、思い込みで済ませずきちんと確認すべき居住区分の判断、パスポート（国籍）で変わるメディケア免除、出国から11か月後に東京や大阪の自室から出すスーパーアニュエーションの請求。私たちにとっては、どれもごく普通の1日の仕事です。
            </p>
            <p style={bodyStyle}>
            ...
            <div className="rounded-2xl" style={{ marginTop: '28px', padding: '20px', background: '#F2FAF7', border: '1.5px solid #C8EAE0' }}>
              ...
              <p style={{ ...bodyStyle, fontSize: '15px' }}>
                すべてのワーホリの1年に還付が出るわけではありません。見込みが薄い場合は、そのこともお伝えします。
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-11 lg:py-16" style={{ background: '#F5F9F7' }}>
        <div className="max-w-[1280px] mx-auto px-5 md:px-8 lg:px-12">
          <div className="max-w-[680px] mx-auto">
            ...
            <p style={{ ...bodyStyle, marginBottom: '14px' }}>
              WhatsAppです。ボットでも、チケット番号でも、「5〜7営業日お待ちください」という自動フォームでもありません。質問ひとつだけ送って、それで終わりにしても構いません。
            </p>
            <p style={{ ...bodyStyle, marginBottom: '22px' }}>
              始めるのにmyGovのアカウントも、オーストラリアのIDも、給与明細も必要ありませんし、オーストラリアに滞在中でも、帰国して2年経っていても同じです。返信が何語で来るか、そのあと何が起きるかは{' '}
