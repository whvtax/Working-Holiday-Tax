...
誰に頼むにせよ、避けたいものが1つあります。還付金の何%という成功報酬型の料金です。金額が大きくなるほど作成した側の取り分が増えます。当社の[料金](/ja/tax-return)は作業を始める前に固定額でお伝えし、還付金から差し引くことはありません。料金は当社チームによる確認作業に対するものであり、結果によって変わることはありません。
...
最初の1ドルから45,000ドルまでが15%で、それを超える部分は外国人居住者の区分に沿って段階的に上がります。1会計年度で見ればほぼすべてのワーキングホリデーメーカーが最初の区分に収まるので、その年を決めるのは15%です。

これを通常のオーストラリアの課税と分けているのは、免税枠がないという一点です。オーストラリア人は最初の18,200ドルに税金を払いませんが、ワーキングホリデーメーカーはその部分にも15%を払います。ほかの要素を考える前に、2,730ドルの差がついています。
...
あります。ただし稀で、ビザで決まるものでもありません。ワーキングホリデーメーカーは原則として18,200ドルの免税枠を得られませんが、狭い例外があり、届くかどうかはその年度の税務上の居住区分の判定を含む複数の条件が重なるかで決まります。

そして居住区分が難しいほうの半分です。ビザでは決まらず、ご本人の事情によって決まるためきちんと確認する必要があり、自信を持って答えた人ほどどちらの方向にも間違えやすいものです。ほぼ同じに見える1年を過ごした2人が反対の判定になることもあります。当社は1年の実態を確認してからでなければ立場を決めません。なぜ判定がそれほど難しいのかは[ワーキングホリデーメーカーの居住性判定](/ja/blog/tax-residency-working-holiday-makers)で説明しています。

## 雇用主の登録はなぜ関係するのか？

どの税率を適用してよいかがそれで決まるからです。事業者は15%で源泉徴収する前に、ワーキングホリデーメーカーの雇用主としてオーストラリア税務署（ATO）に登録する必要があり、登録していなければ外国人居住者の税率、該当区分では30%を使う義務があります。

外から見分けることはできません。登録していないことが多いのはファームと地方の小規模な飲食店、つまりバックパッカーが多く働く場所です。失われるものはなく超過分は申告のときに還付されますが、金額は大きくなります。収穫シーズン1回分の30%と15%の差はたいていその年の還付で単独最大の項目で、見つけるには合計ではなく雇用主ごとに分けて見る必要があります。

## TFNは何を変えるのか？

税率を即座に、完全に変えます。Tax File Number Declarationを通してTFNが記録されていない場合、雇用主は登録の有無にかかわらず45%を源泉徴収しなければならず、本来払うべき額より1ドルにつき30セント多い水準です。

[TFN](/ja/tfn)の申請にはオーストラリア国内にいる必要があり、番号そのものは無料、ATOの発行期限の目安は28日です。お金がかかるのは申請ではなく宣言書のほうで、雇用主ごとに別々の宣言書が必要です。バックパッカーの1年で最も静かな損失は、1社目は正しく15%なのに、2社目で誰も2枚目の宣言書を出さず何か月も45%が続く、という形で起きます。

## メディケア税の免除にはいくらの価値があるのか？

課税所得の2%です。25,000ドルの収入なら約500ドルで、対象になる人の多くが一度も申請しないまま終わります。この2%は居住者だからではなく、メディケアの受給資格がある人に課されます。

外せるかどうかはパスポートで決まります。英国やアイルランドの国民は相互医療協定により原則としてメディケアの受給資格があるので、この税は適用されます。ドイツと日本の国民は原則として受給資格がないので、免除を使えます。

どちらの場合も自動ではありません。免除にはServices Australiaが発行するMedicare Entitlement Statementが必要で、取得に数週間かかります。そのリードタイムが、この免除が申請されないまま終わる理由のすべてです。詳細は[メディケア税の免除ガイド](/ja/blog/medicare-levy-working-holiday-makers)にあります。

## スーパーアニュエーションはどうなるのか？

雇用主は給与とは別に、通常の賃金の12%をスーパーファンドに拠出します。滞在中は手を付けられず、タックスリターンの一部でもないので、申告の結果に影響されません。

出国してビザが終了したあと、Departing Australia Superannuation Payment（DASP）として請求します。課税対象部分に65%が課され、承認までの目安は28日程度です。いくら待っているかは、稼いだ額といくつのファンドに分かれたかで決まります。ファンドを指定させなかった雇用主は、そのたびに新しい口座を作っています。請求については[スーパーアニュエーションのページ](/ja/superannuation)で扱っています。

## 417と462のどちらを持っているかは関係するのか？

税金に関しては関係ありません。417と462はまったく同じ扱いで、15%の税率も65%のDASP源泉もメディケアの位置づけも提出期限も同じです。どちらかが税制上有利だと言う人がいたら、それは誤りです。

違うのはビザの仕組みです。417は英国、アイルランド、ヨーロッパの多く、日本、韓国、台湾などが対象で、指定地域での就労により延長できます。462は米国、中国、イスラエル、ラテンアメリカの多くが対象で、学歴要件と国別の上限があり、北部オーストラリアの選択肢を含む独自の指定就労ルールを持ちます。

それが間接的に税金に返ってきます。延長を狙うと地方の郵便番号と農業系の雇用主に向かうことになり、そこは[未登録雇用主の源泉徴収](/ja/blog/backpacker-tax-rate-australia)や[ファーム仕事のABN](/ja/blog/farm-work-and-abns)が集中する場所です。

## 重要な日付はいつか？

オーストラリアの会計年度は7月1日から6月30日まで、雇用主が報告を確定させた7月以降に提出でき、自分で提出する場合の期限は10月31日です。登録税理士を通す場合は翌年5月まで延長されますが、10月より前にその税理士の名簿に載っている必要があります。

永久に帰国する場合は1つだけ日付が変わります。会計年度の途中で完全に離れる人は、7月を待たずにその年度の早期申告を提出でき、還付が数か月早まります。オーストラリアの銀行口座が開いているうちのほうが手続きしやすいので、航空券を取る前に知っておく価値があります。給与明細の合計が手元にあれば、[還付金の試算](/ja/calculator)でおおよその数字が出せます。

## 15%のあと、金額を動かすのは何か？

15%はワーホリの1年の出発点であって結論ではありません。最終的にいくら戻るかを決めるのは、次のような自分についての事実です。
...
- **TFNが雇用主に届く前の週。**[宣言書](/ja/blog/tax-file-number-declaration-form)が提出されるまで源泉徴収は15%ではなく45%で、その期間は1ドルにつき30セントの差です。収入4,000ドル分がこの状態だったなら差は1,200ドルです
...
正常な結果であって、何かがうまくいかなかった証拠ではありません。その年の本当のお金は税金ではなく[スーパーアニュエーション](/ja/superannuation)の側にあり、スーパーは源泉徴収が正しかったかに関係なく12%で積み上がります。
...
出国時に本当に請求できるのはスーパーで、完全に別の制度です。[DASPの請求](/ja/superannuation)は残高から課税対象部分に対する65%の源泉を引いた額を支払い、所得税の結果がどうであれ利用できます。
...
給与明細が揃っていなくても、収入の記録はATO側に残っています。[お問い合わせ](/ja/contact)いただければ、提出前に全雇用主の源泉徴収を確認します。料金は当社チームによる確認作業に対するものであり、結果によって変わることはありません。
`,
  },
...
還付の大きさを決めるのは稼いだ額ではなく、源泉徴収がどれだけ間違っていたかです。1年を通して正しく源泉徴収されて40,000ドル稼いだ人より、45%の期間が6週間あって20,000ドル稼いだ人のほうが取り戻す額は大きくなります。給与明細の合計が手元にあれば、[還付金の試算](/ja/calculator)が同じ計算をします。
...
ただし2つ知っておくことがあります。還付が生じる年度でも、遅れた申告にFailure to Lodgeのペナルティが課されえます。オーストラリア税務署（ATO）はこれを選択的に適用していますが、未提出の年度がいくつも重なっているケースは実際に適用される場所です。そして手元に何を残していたかに関係なく、所得明細はATOのシステムに残っています。書類がないことは、感じられるほどの障害ではありません。線引きについては[期限後申告とペナルティのルール](/ja/blog/late-tax-return-penalty-working-holiday)で扱っています。

## スーパーアニュエーションはどうなるのか？

別の請求で、金額としてはこちらのほうが大きいことも多くあります。雇用主は1年を通して通常の賃金の12%をスーパーファンドに払い込んでおり、その一切はタックスリターンの還付には含まれず、影響も受けません。

[Departing Australia Superannuation Payment](/ja/superannuation)は、出国してビザが終了した時点で請求できるようになり、残高から課税対象部分に対する65%の源泉を引いた額が支払われます。税金の還付が同額の2人でも、稼いだ額といくつのファンドに分かれたかで、そこで待っている金額はまったく違います。完全に置き去りにされることが最も多いのがこのお金です。
...
[お問い合わせ](/ja/contact)いただければ、すべての雇用主の源泉徴収を確認したうえでお答えします。当社では、当チームが申告書を作成し、提出前に登録税理士が確認し署名します。料金は当社チームによる確認作業に対するものであり、結果によって変わることはありません。
`,
  },
  ...
  'what-is-a-tfn': {
    ...
    body: `
タックスファイルナンバー（TFN）は、オーストラリアで収入を得るすべての人にオーストラリア税務署（ATO）が発行する9桁の識別番号です。無料で、一度取れば一生変わりません。雇用主が、TFNがない場合の45%ではなくワーキングホリデーメーカー税率の15%で源泉徴収できるようにするのがこの番号で、ここから先のすべてがこれに紐づきます。

## なぜひとつの番号がこれほど重要なのか？

4つの別々のシステムが、この番号をあなたと結びつける糸として使っているからです。ATOは税金と還付のために、雇用主の給与システムは源泉徴収率を決めるために、スーパーファンドは拠出金をあなたに結びつけるために、銀行は利息への源泉徴収を避けるために使います。

だからTFNの問題がTFNだけの問題で収まることはありません。給与明細の税率がおかしい、誰とも紐づかないスーパー口座がある、還付が処理できない。表に出る形は違っても原因は同じです。

## 登録されていないと実際にいくらかかるのか？

1ドルにつき30セントです。TFNが登録されていればワーキングホリデーメーカーの給与は15%で源泉徴収され、登録されていなければ雇用主は45%で源泉徴収しなければならず、裁量の余地はありません。

- 週給1,000ドル：15%なら150ドル、45%なら450ドル、差は300ドル
- 週給1,500ドル：225ドルに対して675ドル、差は450ドル
- 週給2,000ドル：300ドルに対して900ドル、差は600ドル

永久に失われるものはありません。取りすぎた税金は申告のときに戻ります。失われるのはその間の数か月、そのお金を使えないことです。

## 誰が取得でき、どれくらい大変なのか？

オーストラリアで働く権利を持つ人なら誰でも取得できます。417と462のワーキングホリデービザ、就労許可のある学生ビザ、ほとんどの一時的就労ビザが含まれます。申請は無料で、オーストラリア国内にいることが条件です。

簡単な手続きで、誰かにお金を払う必要はありません。簡単でなくなるのは、初日に雇用主から渡される宣言書のほうです。その居住性の欄は、年度末に還付額を決めるのと同じ質問であり、最も多く間違って答えられている項目です。

## なぜ番号そのものより宣言書のほうが重要なのか？

実際に税率を設定しているのが宣言書だからです。店長に口頭でTFNを伝えても、通知書の写真を見せても給与システムは変わりません。変えるのはTax File Number Declarationで、この書類はあなたの番号と、ワーキングホリデーメーカーであるという区分を同時に記録します。

そして雇用主ごとに1枚ずつ必要です。シェパートン近郊のパッキング工場にTFNを渡しても、メルボルンのバーには効果がありません。バックパッカーの1年で最も静かな損失は、1社目は正しく15%なのに、2社目は誰も2枚目の宣言書を出さず何か月も45%が続く、という形で起きます。

## どれくらい時間がかかり、もう働き始めている場合はどうなるのか？

ATOの上限は28日、実際には2週間前後が典型で、オーストラリアの住所に郵送される手紙として届きます。番号が届く前に働き始めることはできます。

初日から28日以内に提出すればよいことになっています。宣言書に申請中であることを記録すれば、その期間はワーキングホリデーメーカーの税率が適用されます。何も言わなければ45%はその場から始まります。取りすぎられた分は給与を通してではなく、申告のときに戻ります。

## どれくらい慎重に扱う必要があるのか？

かなり慎重に、です。TFNとパスポートのスキャンが揃えば、それだけで本人確認の道具一式になります。ワーキングホリデーメーカーは狙われやすい層です。来たばかりで何が普通か判断がつかず、ホステルの掲示板やSNSから連絡が取れるからです。

尋ねる資格がある相手のリストは短いものです。採用が決まったあとの雇用主、銀行、スーパーファンド、あなたのために動く登録税理士、Services Australia、ATO。家主、ホステル、採用前のリクルーター、グループチャットの誰かは入っておらず、断って困ることはありません。[渡してよい相手の一覧と詐欺の手口](/ja/blog/who-can-ask-for-your-tfn)は一度読んでおく価値があります。

## 番号より高くつくのはどの手続きか？

TFNを取ること自体は誰にとっても同じ短い作業です。違いが出るのは、すでに持っているかどうかと、その周りの書類が正しく処理されたかどうかで、お金がかかるのはそちらです。
...
書類をアップロードすることはありません。ATOはパスポートを入国管理の記録と電子的に照合するため、入力内容とパスポートの記載のわずかな食い違いが、申請がうまくいかない最も多い原因になります。照合が何を見ているかは[TFNに必要な本人確認書類](/ja/blog/tfn-identity-documents-required)で扱っています。

## どの住所を書けばよいのか？

今日いる住所ではなく、1か月後にもいる住所です。TFNは現物の手紙として届き、戻ってきた手紙は転送されず手続きがやり直しになります。住所が、この手続きにかかる時間を決める最大の要素です。

しばらく滞在すると決めているならホステルの住所でも機能します。10日後に出るホステルでは機能しません。まだ入居していなくても、友人の家や長期のシェアハウスのほうが良い選択です。すでに自分のものでなくなった住所は、28日の手続きが2か月になる最も多い理由です。

## 届く前に働き始めてもよいのか？

働き始められます。ここで実際のお金が決まります。雇用主はTFNが登録されるまで15%ではなく45%で源泉徴収する義務がありますが、申請中であることを記録したTax File Number Declarationがあれば、28日の期間はワーキングホリデーメーカーの税率が維持されます。

つまり重要なのは申請の順番ではなく、初日に雇用主へ申請中だと伝え、宣言書にそのとおり記録することです。何も言わなければ45%はその場から始まります。週給1,000ドルなら差は毎週300ドルで、直るまで毎週続きます。

取りすぎられた分は申告のときに戻るので、永久に失われるものはありません。失われるのはその間そのお金を使えないことで、家賃が週払いのときに効いてきます。

## 届いたあとは何をするのか？

雇用主1社につき1通のTax File Number Declarationが必要になります。1社に渡したTFNが他社に共有されることはなく、それぞれの給与システムが正しい税率を適用するには、それぞれの宣言書が必要です。

それが効いてくるのは次の給与明細です。宣言書には居住性の質問も載っており、後に還付額を決めるのと同じ質問で、ワーキングホリデーメーカーが最も多く記入を誤る欄です。各欄が何を尋ねているかは[Tax File Number Declarationの解説](/ja/blog/tax-file-number-declaration-form)にあります。

## 番号そのものは無料なのか？

無料です。番号はオーストラリア税務署（ATO）が無償で発行するもので、当社の[TFNページ](/ja/tfn)でも同じことをお伝えしています。

お金が得られたり失われたりするのは、その前後の部分です。入口側では宣言書と28日の期間、出口側では取りすぎた税金を回収する申告です。

## 届かない場合はどうするのか？

その後の問い合わせはすべて、確認メールに記載されたリファレンス番号で進むので保管してください。28日が過ぎても何も届かない場合、原因は審査ではなくほぼ必ず住所です。2番目に多い原因は、氏名か生年月日がパスポートと一致していなかったことです。

遅れているのではなく却下された申請は、原因の異なる別の問題で、[TFN申請が却下された場合](/ja/blog/tfn-application-rejected)で扱っています。

## 最初の1週間の何が損失を決めるのか？

申請の手続きは誰にとっても同じで、違うのは遅れがいくらの損失になるかです。無料で済む待ち時間と高くつく待ち時間を分けるのは次の点で、どれも最初の1週間で決まります。
...
スーパーアニュエーションは1ドル目から賃金の12%が支払われ、TFNの有無とは関係ありません。ワーキングホリデーメーカーは[出国後にスーパーを受け取る](/ja/superannuation)ことができます。ファンドがあなたと結びつけられない口座が、スーパーを置き去りにする最大の原因です。
...
その年の一部が現金でも、その収入はタックスリターンに含まれます。支払い方法が変えるのは申告するかどうかではなく、どんな証拠が必要かです。実務上の意味は[現金払いの仕事](/ja/blog/can-your-employer-pay-you-cash-in-hand)をご覧ください。

## 年度末を待たずに取り戻せるのか？

原則としては6月30日の会計年度末を待ちます。意味のある例外は、オーストラリアを永久に離れる場合です。出国予定でその年度にもう収入が発生しないなら、6月30日より前に早期申告ができます。

それが正しい選択かは、その年度の居住性の判定、同時に請求すべきスーパーがあるか、最終の所得明細をまだ出していない雇用主がいるかで変わります。まず[還付金の試算](/ja/calculator)ができますが、45%の期間があるケースは試算と最終額が最も乖離しやすい状況です。
`,
  },
...
TFNはATO（オーストラリア税務署）におけるあなたの恒久的な身元で、雇われていようと自営であろうと、収入を得るすべての人に必要です。賃金、源泉徴収、[スーパーアニュエーション](/ja/superannuation)、還付を一人の人物に結びつける番号で、失効も変更もありません。
...
ギグワーク、デリバリー、一部の出来高制のファーム作業、そして帳簿に載せる代わりに請求書を求めてくる仕事でよく使われます。それが正当なケースかどうかは[ABNとは何か](/ja/blog/what-is-an-abn)にまとめてあります。
...
決まった時間の監督下のシフト勤務にABNを要求する求人広告は、雇用を描写しています。偽装請負であり、判断基準と損失は[従業員か請負業者か](/ja/blog/employee-vs-contractor-australia)で説明しています。
...
ワーキングホリデーの1年は混ざっているのがほとんどです。メルボルンのバーのシフトと同じ月のデリバリーの仕事は別の取り決めで、二つの番号が共存する理由でもあります。問題なのは、ファームや紹介会社が勝手に「シフト勤務は請負だ」と決めることです。年度末ではなく最初の給与計算の前に確認してください。年度末にはスーパーが取り戻しにくくなります。提示された条件が実際の仕事の中身と合っていないなら[お問い合わせ](/ja/contact)ください。
`,
  },
  ...
  'apply-for-tfn-before-arriving': {
    ...
    body: `
できません。外国パスポート保持者向けのATO（オーストラリア税務署）のオンラインTFN申請は、オーストラリア国内にいることが前提です。渡航前にできるのは、初日に申請できるよう情報を揃えておくことです。45%の給与を一度でも見ることになるかどうかは、そこで決まります。

## なぜ到着まで待たなければならないのか？

オンライン申請は、入国がビザに対して記録されていることを前提とし、番号の送付先となるオーストラリアの郵送先住所も必要です。

ビザが数か月前に発給されていても変わりません。申請の条件はビザの発給ではなく、今オーストラリアにいることです。

## 初日に申請することは実際に意味があるのか？

処理期間そのものより意味があります。初出勤の日から28日以内に雇用主にTFNを渡さないと、15%のワーキングホリデーメーカーレートではなく45%で源泉徴収されます。ATOの発行には最大28日かかります。二つの時計はほぼ同じ長さなので、実質的な変数は入国から申請までに何日空けたかだけです。

初日に申請して2週目から働き始めれば、レターは就労の28日ウィンドウ内に届く可能性が高いです。1か月かけて海岸を北上してから申請の翌日に働き始めれば、1ドルにつき30セントかかる空白ができます。

## 渡航前に何を準備しておけばいいのか？

送信ボタン以外のすべてです。申請そのものに費用はかかりません。手間取るのはフォームではなく、住所の判断と、現物を見ながら正確に入力することです。

- パスポート情報はIDページの写真として保存しておく。記憶で入力した情報は、申請が手動審査に回る典型的な原因です
- ビザの許可通知（Grant Notice）をオフラインでも開ける状態にしておく
- オーストラリアの郵送先住所の判断。着陸前に考えておく価値があるのはこれだけです
- 実際に確認するメールアドレス。確認メールには、問題が起きたときに必要な参照番号が入っています

## どの住所を使えばいいのか？

4週間後にも郵便を保持してくれる場所であって、初日に寝る場所とは別の問題です。TFNはレターとしてのみ届くので、これが他のどの判断よりも多くの遅延を生みます。

郵便の仕組みがあるホステルで数週間の予約を入れているなら問題ありません。金曜に出るホステルは駄目です。オーストラリアのどこかに安定した住所を持つ友人や親族がいるなら、一度も行かないとしても通常はそちらが良い選択です。

## ビザが変わったらTFNはどうなるのか？

変わりません。タックスファイルナンバーは一度だけ発行され生涯有効です。ビザとともに失効せず、セカンドワーキングホリデービザでも変わらず、何年後かに別のビザで戻ったときも更新は不要です。

最新に保つ必要があるのは、その番号にATOが紐づけている住所です。通知と、紙で送られる場合の還付がそこに届きます。学生ビザや以前のワーキングホリデービザで来たことがある人は、すでにTFNを持っていると考え、新規申請ではなく番号の確認として扱ってください。

## 上陸後の空白が問題になるのはどんな人か？

国内から申請するルールは全員に同じく適用されるので、変数は着陸から申請までの空白がいくらの費用になるかです。決めるのは次の点です。

- 就労権のあるビザで以前オーストラリアにいたことがあるか。あるならすでにTFNを持っており、再申請は重複を作ってすべてを遅らせます
- どれくらい早く働き始めるか。6月のスレドボやフォールズクリークのスキーシーズンに仕事を決めて入る人は、先に旅行する人より余裕がありません
...
働き始めてしまえば、番号が登録される前に源泉徴収された税金は[ワーホリのタックスリターン](/ja/tax-return)で精算されます。年度のどの時点でも[還付金の試算](/ja/calculator)ができます。
`,
  },
...
請求していなければ、そのお金はいまもあなたのものです。元のファンドに残っているか、ファンドが連絡を取れなくなった場合は未請求としてATOに移管されています。いずれも回収可能で、これから使う同じTFNに紐づいています。今回のビザの終わりにまた出国するなら、二回の滞在分をまとめて[出国後のスーパー受取](/ja/superannuation)として処理できます。
...
過去年度の申告はいまでも可能で、以前の年度をカバーする[ワーホリのタックスリターン](/ja/tax-return)は日常的な処理です。どちらの年度についても[還付金の試算](/ja/calculator)ができます。
`,
  },
...
高くつくのはスーパーのほうです。国を出た後に起きる他のすべてと積み重なります。住所が変わり、銀行口座が解約され、ファンドはすでに残高を未請求として報告している。[出国後のスーパー受取](/ja/superannuation)を考えている人は、飛ぶ前にTFNを見つけておくべきです。
...
`,
  ...
  'how-to-update-address-with-ato': {
    ...
    body: `
ATO（オーストラリア税務署）に登録した住所は、ATOのオンラインサービス、電話（13 28 61）、またはあなたの代理人である税理士のいずれからでも変更できます。三つとも記録には短時間で反映されます。重要なのは次の郵便物が送られる前に済ませることで、すでに発送された郵便は古い住所を追いかけていきます。

## 還付金が銀行口座に振り込まれるなら、なぜATOは住所を持っているのか？

支払いまでに必要な手続きのいくつかが、いまも郵便を経由するか、ATOが確認できる住所を前提にしているからです。TFNレターと本人確認の書類は郵送でしか届きません。査定通知（Notice of Assessment）、修正の通知、情報提供の依頼はすべて登録住所に送られ、あなたが見なかった手紙も受け取ったものとして扱われます。

還付金そのものは、ほぼすべてオーストラリアの銀行口座に電子的に支払われるので、古い住所がお金を止めることは通常ありません。止まるのは、お金が動く前に起きるべきことすべてです。

## 住所が古いままだと実際には何が起きるのか？

いちばん高くつく失敗はTFNレターです。返送されたレターは28日の待ち時間をやり直させ、その間あなたは15%ではなく45%で働いているかもしれません。住所が古いことに週単位の金額が張りつくのはここです。

二番目はスーパーアニュエーションです。ファンドとATOはそれぞれ住所を保持しており、連絡が取れなくなったファンドは、やがてその口座を未請求として報告しATOに移管します。お金はあなたのもので請求もできますが、国を離れようとする瞬間に、手続きが一段階遠くなります。

三番目は静かに進みます。申告内容を質問するATOのレターが、3月に出たバイロンのホステルに届いて誰も答えないまま、あなたの説明なしに査定が確定します。

## 数週間ごとに移動する場合、どの住所を使えばいいのか？

4週間後にもあなたの郵便を保持してくれる場所であって、今夜寝る場所ではありません。季節労働をする人には現実的な問題で、収穫やホスピタリティは郵便が動くより速く人を移動させます。

- オーストラリアにいる友人や親族の恒久的な住所がいちばん良い答えで、そこに一度も行かなくても構いません
- 長期滞在型のホステルは、退去した宿泊者の郵便を保管してくれるなら使えますが、多くはしてくれません
...
あります。海外の住所をATOに登録することはでき、登録すべきです。出国後の連絡こそ見逃す余裕のない連絡で、審査中の還付、DASP（出国時のスーパー支払い）、本人確認の求めがそれにあたります。

銀行口座の情報も同じく重要です。空港へ向かう途中で解約した口座に還付金を指定していても、お金が消えることはありませんが、送金は差し戻され、送り先をATOに伝える人が現れるまであなたのATO口座に残高として残ります。

## 住所変更が急ぎになるのはどんな状況か？

住所の更新は誰にとっても同じ作業ですが、緊急度は違います。ただの事務作業から週単位の金額が張りついた問題に変わるのは、次のような状況です。
...
- 帰国後にオーストラリアの携帯番号やメールが使えなくなるかどうか。オンラインのアカウントに入れなくなる前に住所と連絡先を整理しておくほうが、後から復旧するより簡単です
...
領収書だと考えてください。申請が存在することを示し、ATOが電話でその申請をすぐ見つけられるようにし、まだTFNの登録がない理由を雇用主が示せるものです。
...
レートを変えるのは宣言書であって、リファレンス番号そのものではありません。リファレンス番号はその宣言が正直であることの証拠であり、これを見たことのない給与担当はたいてい見せてほしいと言ってきます。

## これでできないことは何か？

三つあり、それぞれよく起きる間違いです。リファレンス番号が本物の番号と見間違えるくらい公式に見えるからです。

どの書式でもTFNの欄には入れません。給与システムにTFNとして打ち込まれたリファレンス番号は、後で解消が必要な不一致を作ります。

タックスリターンの提出には使えません。使えるのは本物の番号だけです。

スーパーファンドにTFNの代わりとして渡すこともできません。TFNのないファンドは拠出金により高い税率をかけ、後の請求で口座をあなたと結びつけるのに苦労します。バックパッカーのスーパーが行方不明になる主な理由のひとつがこれです。

## 本物の番号が届くまでどれくらいかかるのか？

ATOが示す上限は最大28日で、実際には2週間程度が一般的です。申請書に書いたオーストラリアの住所への郵送でしか届かないので、申請する前にその住所をきちんと考えてください。

リファレンス番号が意味を持つのはレターが届く日までです。28日が過ぎて何も届かなかったときに必要になるので、確認メールは削除せずに取っておいてください。
...
リファレンス番号の役割は誰にとっても同じですが、意味を持つかどうかは、待っている間に何をしているかで決まります。決めるのは次の事実です。
...
最高裁のAddy v Commissioner of Taxation [2021] HCA 34判決にさかのぼる狭い例外です。届くかどうかは、その年度の税務上の居住区分の判定を含む複数の条件が重なるかで決まり、多くの人はここで落ちます。居住区分はビザでは決まらず、ご本人の事情によって決まるためきちんと確認する必要があり、どちらの方向にも間違えやすいものです。なぜそれほど難しいのかは[居住性の判定](/ja/blog/tax-residency-working-holiday-makers)にあります。
...
10日後に出るホステルは機能せず、これがこの手続きで最も多い自業自得の遅れです。手紙が届く前に引っ越してもATOに住所を更新することはでき、[ATOへの住所変更](/ja/blog/how-to-update-address-with-ato)で扱っています。
...
待つ間に取りすぎられた分は[ワーホリのタックスリターン](/ja/tax-return)を通して戻ります。期間の長さが分かれば[還付金の試算](/ja/calculator)ができます。
`,
  },
  ...
  'tfn-security-protect-from-fraud': {
    ...
    body: `
TFNを尋ねてよいのは5者だけです。働き始めたあとの雇用主、銀行、スーパーファンド、あなたの税理士、そして受給資格のある給付を扱う政府機関です。それ以外の誰にも、この番号を求める権利はありません。リストの外の相手が尋ねてきたなら、勘違いしているか詐欺を試みているかです。

## なぜTFNは盗む価値があるのか？

永久であり、あなたの名前でお金を動かせるからです。TFNと基本的な本人確認情報を持つ人物は、あなたとして申告を提出して還付金を自分の口座に振り向け、スーパーアニュエーションへのアクセスを試み、あなたに紐づくABN登録を作れます。

被害の解消に時間がかかるのは、この番号がカードのように止められないからです。あなたの名前で提出された偽の申告は、たいてい数か月後に本物の申告が重複として拒否されてはじめて表に出ます。調査の間、還付は凍結されます。

## なぜワーキングホリデーメーカーが名指しで狙われるのか？

制度に不慣れで、何が普通なのか判断がつかず、非公式な信頼の上に成り立つ環境を移動しているからです。ホステル、バックパッカーのFacebookグループ、WhatsAppのコミュニティ、掲示板は、税金に不案内な人が助けを探しに行く場所で、そこで手を挙げる人物は誰にも審査されていません。

手口は一貫しています。少額の手数料で申告を代行する、あるいはスーパーを請求すると持ちかけ、パスポートとビザグラントの写真、TFN、生年月日と住所、場合によっては銀行口座情報を求める。還付金の振込先を別にした申告が提出され、アカウントは消えます。

## 危険信号は何か？

最初のひとつでたいてい判断がつきます。政府の公的な税務専門家登録簿に確認できる登録がないことです。登録は公開されていて1分もかからず確認でき、番号を出すのを渋る相手は、それだけで答えを出しています。
...
パスワードの要求は特に重要です。登録税理士は税理士用チャネルからあなたの記録に到達するので、myGovの認証情報を必要としません。それを求める人物は、何を名乗っていようと税理士として動いていません。この1つが最も明快な判別方法です。

## 情報はたいていどのように漏れるのか？

高度な手口によるものはまれです。繰り返し原因になっているのは、仕事の話がまだ何もない段階で本人確認書類一式を求めてくる求人詐欺の登録フォーム、ホステルの共用パソコンで撮影したり置き忘れたりした書類、給与担当だと説明された相手にWhatsAppで送ったTFNです。

共通しているのは、比較する基準を持たない時期に、事務的にごく普通に見える要求が届くことです。5者のリストを知っていることが、どれだけ用心するよりも守りになります。判断の問題が、事実確認の問題に変わるからです。
...
そのうえで、その番号に紐づくものをすべて守ります。myGovの認証情報を変更して最も強いサインイン方法を有効にし、スーパーファンドにも連絡してください。残高はそれ自体が標的です。当年度に自分の名前で申告が提出されていないかも確認します。マーカーの設定に費用はかからず、その後何年も守りとして機能します。

## すでに偽の申告が提出されていた場合はどうなるのか？

本物の申告は提出できますし、還付金もあなたのものです。ただし重複の調査中、処理は遅い経路に移ります。これは損失ではなく数か月の遅れであり、多くの場合は警察ではなくATOを通して解決します。

報告し、やり取りの記録をすべて保管し、その後の手続きでは追加の本人確認があるものと考えてください。オーストラリアの外にいると手続きが実質的に難しくなるので、帰国後ではなく出国前に確認しておくべきです。

## 自分の露出はどこを見れば分かるのか？

守り方のルールは誰にとっても同じでも、どれだけ晒されているかは違います。次の点は、海外からの是正が相当に遅くなるので、今のうちに確認する価値があります。
...
`,
  ...
  'who-can-ask-for-your-tfn': {
    ...
    body: `
タックスファイルナンバーを合法的に求められるのは6つのグループだけです。採用後の雇用主、ATO（オーストラリア税務署）、スーパーファンド、銀行、代理人である登録税理士、給付を申請する場合のServices Australiaです。それ以外も尋ねること自体はできますが、断ることができ、断ったことを不利に扱うのは違法です。

## なぜこのリストはこんなに短いのか？

TFNとパスポートが揃えば、それだけで機能する身元情報一式になるからです。収集は正当な税務上の理由がある組織に限られ、それぞれがなぜ必要かを説明し、安全に保管し、その目的にのみ使う義務を負います。

この短いリストそのものが防御で、要求が妥当かを自分で判断する必要がありません。尋ねてきた相手がリストに載っていなければ答えはノーで、説明も要りません。

## 雇用主はいつ尋ねる権利があるのか？

採用された後で、その前ではありません。正当な要求は入社手続きでTax File Number Declarationという形で来ます。ATOの標準書式で、雇用主はその番号で15%のワーキングホリデーメーカーレートを適用し、収入をATOに報告します。

仕事を受ける前の要求が警戒サインで、バックパッカーが最も多く引っかかるパターンです。人材紹介会社は、あなたを仕事に推薦するためにTFNを必要としません。オファーを受けていないなら、宣言書を記入すべき対象がそもそも存在しません。

## 受け取る権利がないのは誰か？

求める理由が税務にない相手すべてです。実際に受け取る要求は、だいたい決まった顔ぶれから来ます。
...
断ることは犯罪ではなく、それを理由に住居やサービスや仕事を拒むことも認められません。

## 詐欺は実際にどんな形をしているのか？

手が込んでいる必要はなく、実際に手が込んでいません。狙われるのは、新しい国に来て数週間で、まだ何が普通かを知らない人だからです。繰り返し現れる形は見分けられるようにしておいてください。

**偽の求人。**応募していないのに届くオファーで、面接の前にTFNとパスポートの写真を求め、実際の仕事には進みません。生産物は仕事ではなく身元情報一式です。

**SNSの還付代行。**申告を代行すると持ちかけ、TFNと政府サービスのログイン情報を求め、収入を見ないうちに金額を約束するアカウントです。還付は被害者が管理していない銀行口座に振り込まれます。

**ホステルの掲示板にある給与フォーム。**実現しない現金仕事のためにTFNを集める紙のフォームが、100人が記入する場所に置かれます。

共通する見分け方は、誰も所得明細を見ていない段階で具体的な還付額を約束することです。その数字を事前に知ることは誰にもできず、知っていると主張する相手は税務の仕事をしていません。

## 渡す前に相手をどう確認すればいいのか？

オーストラリアで活動するすべての税理士は、政府の公的な税務代理人登録簿に掲載され、検索できます。確認は1分で終わり、まっとうな事務所なら確認されることを当然と考えます。

まっとうな税理士が決して必要としないものが二つあります。政府サービスのアカウントのパスワードと銀行のログイン情報です。ATO記録へのアクセスは、あなたとしてログインするのではなく専門家向けの経路から得られるもので、その資格情報を求められた時点で、それまでの会話がどうであれ詐欺です。当社で作成する申告書は、提出前に登録税理士が確認し署名します。その登録も同じ公的登録簿で確認できます。

## すでに誤った相手に渡してしまった場合はどうするのか？

自動的に破滅的なことは起きず、TFNだけで銀行口座を空にすることもできません。リスクはあなたの名義で不正な申告書が提出されること、あなたの身元で口座が開設されることで、どちらも検知できます。

ATOは身元情報が漏れた後、あなたの記録にフラグを立てられます。様子を見るより、そうしてもらう価値があります。13 28 61に連絡し、何を誰に開示したのかを伝えてください。政府サービスのログイン情報も渡した場合は、何よりも先に変更してください。

## その要求が正当かどうかは何で判断するのか？

合法的に尋ねられる相手のリストは固定ですが、個々の要求が正当かは文脈で決まります。実務上それを決めるのは次の状況です。

- その仕事をすでに受けたか。雇用主からの要求はこれで決まります
- 尋ねてきた相手が登録された実務家か。公的登録簿で1分で確認できます
- 政府サービスのログイン情報も相手が持っているか。TFN単独よりはるかに悪い状況です
- Services Australiaの給付を申請しているか。ATO以外で要求が正当になる唯一の政府の場面です
- スーパーファンドに渡したか。リスクではなく必要な手続きです。TFNのないファンドは拠出金により高い税率をかけ、[出国後のスーパー受取](/ja/superannuation)のときに口座をあなたと結びつけるのに苦労します
`,
  },
  ...
  'tfn-australian-address-no-fixed-address': {
    ...
    body: `
TFNの申請にオーストラリアの住所が必要なのは、TFNが郵送されるレターとして届くからです。賃貸契約は不要で、ホステル、友人の家、職場、郵便預かりサービスでも構いません。条件は、申請から4週間ほど郵便が確実に回収される場所であることです。

## ATOはどんな住所を受け付けるのか？

ATO（オーストラリア税務署）はオーストラリアの居住住所または郵送先住所を求めますが、そこに住んでいるかは確認しません。必要なのは、Australia Postからのレターが返送されずに回収される場所であることだけで、想像よりハードルは低いです。
...
申請フォームは私書箱より街路住所のほうが記入しやすい作りです。私書箱の料金を払う前に知っておく価値があります。

## なぜホステルの住所がいちばんリスクの高い選択なのか？

ホステルは最も多く選ばれ、最も多く失敗します。大きなホステルは週に何百通もの郵便を扱い、レターは紛失し、廃棄され、返送されます。チェックアウトした宿泊者に転送してくれるところもほとんどありません。

ホステルしか現実的な選択肢がないなら、宿泊者名で郵便を保管してくれるかをフロントで直接、掲示ではなく人から確認してください。10日を過ぎたら毎日確認します。ATOの上限は28日ですが、レターは通常2週間以内に届きます。

## レターが届く前に引っ越したらどうなるのか？

レターが届く前の移動が、ワーキングホリデーメーカーがTFNを受け取れない最大の原因です。旧住所に投函されると、ATOが自動的にもう一通送ることはなく、返送されたこと自体も再発行の引き金になりません。

番号そのものは失われていません。TFNは一度だけ恒久的に発行されるからです。失敗したのは配達で、回復する手段は再申請ではなく、ATOの記録上の住所を訂正して番号を確認してもらうことです。二度目の申請は、元の問題よりほどくのに時間のかかる重複記録を作ります。訂正は[ATOの住所変更](/ja/blog/how-to-update-address-with-ato)にあります。

## 実際にはどの住所を使うべきなのか？

人間がそのレターに気づくかどうかで優先順位をつけてください。最良は友人や親族の定着した住まいです。実在する家庭は郵便を開けるからです。次が雇用主の了解を得た職場で、ファームは季節労働者のために日常的にやっています。
...
配達が壊れる原因は一貫しています。レターが届く前のチェックアウト、引き取り手のない郵便を毎週処分するホステル、フォームのユニット番号の書き間違いです。

## 遅れることは実際に損になるのか？

直接には損になりません。TFNの申請は無料で、番号は恒久的で、引かれすぎた税金は申告で戻るので、レターが遅れても最終的にお金は失われません。

かかるのはその間の資金繰りで、レターとは別の要素で決まります。初出勤の日から28日以内に雇用主にTFNを渡さないと、15%ではなく45%で源泉徴収されます。宣言書は申請中であることを記録できるので、給料を決めるのはレターが届いたかではなく、雇用主に伝えたかです。その間に使えるものは[TFNリファレンス番号](/ja/blog/tfn-reference-number-before-tfn-arrives)にあります。

## 申請が円滑に進むかどうかを決めるのは何か？

三つの事実で、三つとも申請する日に自分で決められます。その住所が4週間後も郵便を回収しているか。申請の情報がパスポートと完全に一致しているか。入国管理の記録との不一致は却下の典型的な理由です。雇用主に申請中であることを伝えたか。待っている間の源泉徴収レートを守るのはこれです。

当社がTFN申請を扱う場合は、申請期間中ずっと郵便を保管できる確認済みの住所を使い、番号を本人に直接お伝えします。数週間ごとに移動する人にとって、失敗の起点をまるごと取り除く方法です。番号が届いたら、そのレターは価値の高い書類として扱ってください。誰に渡してよいかは[TFNを詐欺から守る](/ja/blog/tfn-security-protect-from-fraud)にあります。
`,
  },
...
この区別は当事者が選ぶものではなく法的なテストです。ロスターを決め、作業を監督し、道具を用意し、時給で支払う事業者がABNを取ってこいと言うなら、書類が何と書いていようとその取り決めは雇用である可能性が高く、決着をつけるのは[従業員か請負業者かのテスト](/ja/blog/employee-vs-contractor-australia)です。
...
賃金とABNの収入は同じ[ワーホリのタックスリターン](/ja/tax-return)で精算されます。それぞれの収入のおおよその額がわかれば[還付金の試算](/ja/calculator)ができます。
`,
  },
  ...
  'how-to-register-for-an-abn': {
    ...
    body: `
Australian Business RegisterでのABN登録に政府への手数料はかからず、多くの申請では番号が短時間で発行されます。あなたの申請がそうなるかどうかを決めるのは資格の質問です。ABNは実際に事業を営んでいる人に発行されるもので、取ってこいと言われた人に発行されるものではありません。当社ではその答えを正しく出すところまで含めて[ABN登録](/ja/abn)を扱っています。
...
この質問が申請の他のすべてを決め、最も考えずに答えられている質問でもあります。シフトが組まれ、監督され、道具も先方が用意する仕事について、初日の前にABNを取れと言われているなら、答えは「事業を営んでいない」です。その取り決めは請負ではなく偽装請負である可能性が高く、登録しても合法にはならず、[スーパーとアワードの権利](/ja/blog/employee-vs-contractor-australia)があなたに支払われるべきであることも変わりません。
...
売上75,000ドルのところです。これを超えると[GST](/ja/blog/gst-and-abn-for-working-holiday-makers)の登録が義務になります。ここに届くワーキングホリデーメーカーはほとんどおらず、下にとどまるかぎりGSTも四半期ごとのBusiness Activity Statementも関係しません。

誤って付いてしまったGST登録は無害ではありません。報告する収入があるかどうかに関係なく、四半期ごとの報告義務が続き、解除するには意識的にキャンセルする必要があります。

## ABNを取ると何が変わるのか？

税金の責任が誰にあるかが完全に変わります。請求書からは何も源泉徴収されないので、[タックスリターン](/ja/tax-return)を提出するまで負担はすべてあなたの側に残ります。税率は合算した収入の最初の45,000ドルまでがワーキングホリデーメーカーの15%です。その代わり、実際の事業経費は控除できます。
...
最後の請求書が未入金のまま早くキャンセルすると面倒が起き、遅いキャンセルは手続きが煩雑になります。先に片づけておくべきことは[出国前のABNキャンセル](/ja/blog/how-to-cancel-your-abn)にまとめてあります。
...
`,
  ...
  'farm-work-and-abns': {
    ...
    body: `
ファーム仕事でABNが必要になるのは、農園または人材派遣（レイバーハイヤー）会社があなたを請負として使う場合だけです。給与計算に載せてくれるなら[TFN](/ja/tfn)だけで足り、ABNは意味を持ちません。初日のシフトの前にどちらなのかを尋ねてください。その答えが税金もスーパーも権利も決めます。
...
まず支払方法を見てください。ほかの何よりも早く2つを分けます。従業員は時間に対する賃率で支払われ、入金の前にPAYGが源泉徴収され、給与明細に[スーパー](/ja/superannuation)が表示されます。請負業者は合意した仕事に対して請求書で支払われ、総額を受け取り、税金はあとから自分の責任です。
...
兼ねられますし、多くのワーキングホリデーメーカーがそうしています。カフェで[TFN](/ja/tfn)による雇用、デリバリーで[ABN](/ja/abn)による請負はごく普通で、それぞれの流れが自分のルールを保ちます。給与には15%の源泉徴収があり、請求書にはなく、スーパーは給与の側にだけ付きます。

年度末には両方が1通の[タックスリターン](/ja/tax-return)に着地します。給与からすでに引かれている源泉徴収が全体の税額に充当されるので、ABN収入が重く給与が軽い年は、還付が納付に変わりえます。どちらに転ぶかは、10月を過ぎてからではなく6月より前に確認する価値があります。
...
`,
  ...
  'can-you-have-tfn-and-abn': {
    ...
    body: `
持てます。ワーキングホリデーメーカーはタックスファイルナンバー（TFN）とオーストラリア事業者番号（ABN）を同時に保持でき、[ABN](/ja/abn)の登録にTFNが要るのでTFNが先です。TFNは雇用収入を、ABNは請負収入をカバーし、どちらも同じタックスリターンで申告します。
...
警戒すべきパターンは、同じ仕事、同じ時間、同じ上司、同じロスターのまま、給与計算から請求書方式に移されることです。これは偽装請負（sham contracting）で違法ですが、事業者に安上がりだから起きます。仕事の実態が雇用に見えるなら書類が何であれ法律上は雇用で、[従業員と請負業者の区別](/ja/blog/employee-vs-contractor-australia)は実際にどう仕事が行われているかで判断されます。
...
二つの収入は同じ[ワーホリのタックスリターン](/ja/tax-return)で精算されます。それぞれの収入のおおよその額がわかれば、[還付金の試算](/ja/calculator)ができます。
`,
  },
  ...
  'how-to-cancel-your-abn': {
    ...
    body: `
ABNは、思い出したときではなく請負をやめたときにキャンセルします。手数料はかからず、提出した日ではなく指定した日から効力を持ちます。帰国後も開いたままにすると、別の国から答え続ける申告の督促が生まれます。

## 帰国後にABNが開いたままだと、なぜ問題になるのか？

ABNは取得した証明書ではなく、継続的な義務を伴う登録だからです。有効である間、ATOは事業活動報告や申告を期待し、GST登録をしていれば請求書を1枚も出していなくてもBASを期待します。

郵便も登録された住所に届き続け、多くの場合それは何か月も前に出たホステルやシェアハウスです。転送はされず、通知は未回答のまま積み上がり、気づくのは事態が大きくなったあとです。放置された住所の開いた登録は、なりすまし詐欺の標的でもあります。

## キャンセルの前に終わらせておくべきことは何か？

ABNを通して動いていたことすべてです。キャンセルは登録を閉じるだけで、ぶら下がった義務は閉じません。キャンセル後は遅れて請求書を出すのが面倒になるので、順番が重要です。

- 未発行の請求書は、ABNが有効なうちにすべて発行する
- 未回収の入金を回収する。海外から追いかけるのは難しくなります
- GST登録をしていたなら期限の来ているBASを提出し、その登録も別途キャンセルする
- キャンセル日までのABN収入を控える。その分は申告に含まれます
- その収入に対して申請する控除の記録を残す

GST登録は忘れられやすい項目です。ABNのキャンセルが必ずGST登録を自動的に終わらせるわけではなく、生きているGST登録は四半期ごとの義務を生みます。

## キャンセルすれば申告の義務はなくなるのか？

なくなりません。これが最も多くの面倒を生む誤解です。キャンセルが終わらせるのはこれから先の登録だけで、すでに得た収入は課税対象のまま残り、その年度の申告は提出しなければなりません。

出国の時点で会計年度が終わっていなければ、申告は7月1日以降にどこからでも提出します。何が必要かは[海外からの申告](/ja/blog/how-to-lodge-tax-return-from-overseas)にありますが、まず必要なのは開いたままのオーストラリアの銀行口座です。

## どの日付を選ぶべきか？

今日の日付ではなく、実際に活動をやめた日です。3月に最後の請求書を出し、6月にキャンセルを思い出したバックパッカーは、3月付でキャンセルします。

日付が重要なのは、ATOがあなたを事業者とみなす期間を決めるからです。実際の終了より後ろの日付でキャンセルすると、収入も報告もない活動が数か月あったように見え、問い合わせを生みます。

## また戻ってくるかもしれないので開けておくべきか？

ほとんどの場合そうすべきではありません。ABNは番号があなたに紐づいたままという意味で永久で、戻って再び請負を始めるなら再開できます。生かしておいて得られるものはありません。

生かしておけば、その国にいなかった年まで申告を期待され続けます。実際に戻って必要になれば再開は短く、休眠登録の書類仕事を抱えてまで開けておく価値はありません。

## 出国時に閉じておくものは他にあるのか？

スーパーアニュエーションがあり、こちらは逆向きです。請負業者にスーパーの保証は支払われないので、ABNの請負は通常スーパーを生みません。ただし多くはその横で雇用もしていて、そちらは生みます。

スーパーはビザが終了しオーストラリアを離れたあとにしか請求できません。DASPの請求は承認まで28日程度が目安で、課税対象部分はワーキングホリデーメーカーの場合65%で課税されます。タイミングは[スーパーアニュエーションのページ](/ja/superannuation)にあります。一度請求すると取り消せません。

## キャンセル日の前に片づけるべきものは何か？

キャンセル自体は簡単で、その周りで何をしておくべきかはABNの使われ方によります。次はキャンセル日のあとではなく前に片づけることです。
...
- オーストラリアに戻る予定があるか。これが開けておく理由になることはほとんどありません

最後のABN収入は給与とあわせて[ワーホリのタックスリターン](/ja/tax-return)で申告します。還付になるか納付になるかは[還付金の試算](/ja/calculator)で見当がつきます。
`,
  },
...
任意の12か月間の、事業活動からの総売上です。経費を引く前の金額で、利益ではありません。[TFN](/ja/tfn)で受け取る給与は含まれないので、カフェで1年働いて少額のフリーランス収入が乗っている人は、合計の見た目が大きくても基準には届きません。
...
何も起きません。GSTを乗せずに請求書を発行し、Business Activity Statementは提出せず、ABNのもとでの義務は[タックスリターン](/ja/tax-return)で収入を申告し、純額に対してワーキングホリデーメーカーの税率、最初の45,000ドルまで15%の所得税を払うことだけです。
...
複雑になるのはこの3つの相互作用です。低所得者税額控除が使えるかは居住性の判定が決め、メディケアの問題はパスポートが決めます。その側面は[低所得者税額控除](/ja/blog/low-income-tax-offset-working-holiday)で扱っています。
...
実際には監督された時給仕事なのにABNに載せられる偽装請負は、ホスピタリティとファーム仕事で広く見られます。分類し直されると、アワードの賃金、スーパーアニュエーション、労災補償が戻ってくる一方で、この控除は外れます。線引きの仕方は[従業員と請負業者の判定](/ja/blog/employee-vs-contractor-australia)にあります。
...
常につきまとう問題は出口です。ビザに期限のある取締役が休眠状態の法人を残して離れても、ASICの義務は残り、不在の間も積み上がります。個人事業主なら[ABNをキャンセルする](/ja/blog/how-to-cancel-your-abn)だけで全部が閉じます。無料で、数分で終わります。
...
一方で、本来負うべき人から義務を遠ざけるために要求されている場合もあります。誰がどう見ても時給の監督された仕事で法人化を求められているなら、分類の問題が先に来ます。その判定の仕方は[従業員と請負業者の判定](/ja/blog/employee-vs-contractor-australia)で扱っています。
...
法人が足すのは控除ではなく事務作業で、それ自体が本来なくてよかった費用です。どちらの形態でも申請できるものは[ABNの経費控除](/ja/blog/abn-deductions-business-expenses)にまとめてあります。
...
`,
  ...
  'profit-loss-vs-personal-services-income-australia': {
    ...
    body: `
ワーキングホリデーの[ABN](/ja/abn)収入はほぼすべてが個人サービス所得（PSI）です。商品や資産や他人の労働ではなく、自分の労働に対して支払われているからです。PSIは罰則でも問題でもなく、制限されるのはバックパッカーがそもそも持っていない少数の控除だけです。
...
そもそもABNが適切でなかった場合にも意味を持ちます。決まった時間、監督、取引先の機材という形で雇用に見えるなら、本当の問題はPSIではなく偽装請負で、誰がスーパーと最低賃金を負うかが変わります。判定基準は[従業員か請負業者か](/ja/blog/employee-vs-contractor-australia)にあります。
...
PSIも偽装請負も通常の請負も、銀行の入出金の上では同じに見えますが、生み出す申告書は違います。ABN収入のある[タックスリターン](/ja/tax-return)を作成するとき、誰が支払ったか、どう支払われたか、誰の機材を使ったかを正確に説明すれば、どのルールが当てはまるかが分かります。
`,
  },
...
登録せずにGSTを表示すると、納付できない税を請求することになり、支払者も資格のない控除を申請します。旅客のライドシェアはこの基準の例外で、1ドル目から登録が必要です。詳しくは[GSTとABN](/ja/blog/gst-and-abn-for-working-holiday-makers)にあります。

## ABNを書かなかったらどうなるのか？

No-ABN源泉徴収のルールにより、ABNの記載がない相手から買う事業者は、支払額の47%を源泉徴収してATOに納付します。有効なABNを持っていて書き忘れただけの場合も同じです。

そのお金は失われません。納税額に充当され、超過分は[タックスリターン](/ja/tax-return)を提出したときに戻ります。失われるのは使えることで、2,000ドルの請求書なら940ドルが何か月もATOの側にあります。
...
監督されたシフト勤務について請求書を求められるのは偽装請負で、12%の[スーパーアニュエーション](/ja/superannuation)、アワードの賃金、割増賃金、労災補償を失います。判定の仕方は[従業員と請負業者の判定](/ja/blog/employee-vs-contractor-australia)にあり、最初の請求書の前に当てはめる価値があります。

## 出国前にやっておくべきことは何か？

2つあり、どちらも請求書の書き方ではありません。未払いの請求書は帰国後も法的には回収できますが、バックパッカーの規模で別の国から回収するのは実務上ほぼ不可能で、機能するのは短い支払条件と国内にいるうちの素早い催促です。

もうひとつはABN自体で、請負をやめたらキャンセルします。開いたままのABNはATOからの連絡と申告の督促を何年も生み、帰国後しばらくしてATOから連絡が来る理由もこれです。詳しくは[ABNのキャンセル](/ja/blog/how-to-cancel-your-abn)にあります。
...
必要なものを変える基準が2つあります。300ドル以下はその年に全額控除でき、減価償却は不要です。もう1つは2026年7月1日から使える領収書不要の1,000ドルの定額業務関連控除で、請負が軽い人には積み上げて証明できる額を上回ります。どちらを取るかは[1,000ドルの即時控除](/ja/blog/1000-dollar-instant-deduction-rule-2026)で扱っています。
...
車両費用は1キロあたりの定率か、ログブックに裏づけられた実費で申請します。本気で走る人にはログブック方式のほうが大きな控除ですが、記録がなくて失敗することが最も多いのもこの方式です。何を書くべきかは[車両ログブック](/ja/blog/vehicle-logbook-abn-working-holiday)にあります。
...
口座を閉じてしまうのは、帰国したバックパッカーに最も多い自業自得の問題です。振り込めない還付金は、海外から別の方法を手配するまでATOのところに留まります。帰国後に何が変わるかは[海外からのタックスリターン提出](/ja/blog/how-to-lodge-tax-return-from-overseas)で扱っています。
...
典型的なバックパッカーの収入では、外国人居住者より有利で、居住者より不利です。狭い例外もありますが、ビザでは決まらず、その年度の税務上の居住区分の判定を含む複数の条件が重なった場合にしか生じません。居住区分はご本人の事情によって決まるためきちんと確認が必要で、どちらの方向にも間違えやすいものです。判定が難しい理由は[ワーキングホリデーメーカーの居住性判定](/ja/blog/tax-residency-working-holiday-makers)にあります。
...
1通の申告に2種類の収入が載り、途中で税金が引かれていたのは片方だけです。給与はPAYGがすでに源泉徴収された状態で自動入力され、[ABN](/ja/abn)収入は何も源泉徴収されず自動入力もされないので、自分の記録から申告する必要があります。
...
1点300ドル以下は購入年度に全額申請します。それより大きいものは耐用年数にわたって償却し、2026年7月1日からは即時償却の基準が対象アイテムについて1,000ドルに上がります。詳しくは[1,000ドル即時控除](/ja/blog/1000-dollar-instant-deduction-rule-2026)にあります。
...
もうひとつの判断は、その支出がどの雇用主に紐づくかです。雇用主が4社あって1社がABNだった年は、控除が申告書の別々の場所に属し、置き場所の間違いが、自分で提出した申告書が後から修正される最も多い理由です。この分析は[タックスリターン](/ja/tax-return)を作成する作業の一部で、たいてい控除より大きな金額を動かす居住性やメディケアの項目とあわせて行います。
`,
  },
  ...
  'do-you-need-to-lodge-tax-return-short-stay': {
    ...
    body: `
ほぼ確実に必要です。提出義務は滞在期間ではなく収入に従い、2週間分の賃金でも2年分と同じ義務が生じます。短期滞在こそ、還付の割合が最も高くなる場所です。源泉徴収が、実際には起きなかった1年を前提に計算されているからです。

## 何が義務を生じさせるのか？

7月1日から6月30日までの会計年度中に、オーストラリアで賃金を得たこと。それだけです。滞在期間もビザも金額も変えません。ATO（オーストラリア税務署）は、雇用主があなたに何を支払ったかという報告をすでに保持しています。
...
現金の仕事はこの枠の外だと思われがちですが、外ではありません。報告されたかどうかにかかわらず課税対象で、給与明細のない期間をどう再構成するかは[現金収入がある場合のタックスリターン](/ja/blog/cash-in-hand-tax-return)にあります。

## 本当に提出しなくてよいのはどんなときか？

例外は狭いです。その年度にオーストラリアでの収入がまったくなければ、提出するものはありません。収入が少額の銀行利息だけで、正しい源泉徴収が適用されていた場合は、申告書ではなく非提出通知（non lodgement advice）が正しい答えになることがあります。

どんな期間であれ賃金の出る仕事をした人には義務があり、非提出通知はATOに対する正式な意思表示であって、何もしないことで私的に決めるものではありません。

## なぜ短期滞在ほど還付が大きいのか？

源泉徴収は、その給与期間が1年ずっと繰り返される前提で計算されるからです。3か月分の労働が12か月分として課税され、一度も負っていない納税額に対して引かれます。

8週間の収穫作業をワーキングホリデーメーカーレートで週ごとに課税すれば、引かれた税金の大半が戻せる状態になるのが普通で、金額は四桁ドルに届くこともあります。

## 短期滞在の還付をさらに押し上げるものは何か？

三つあり、最初の二つは自分では誰も申請しない項目です。TFNが雇用主に届くまでの期間が15%ではなく45%で源泉徴収されていれば、1ドルにつき30セントが請求を待っています。ワーキングホリデーメーカー雇用主としてATOに未登録の雇用主は外国人居住者レートで源泉徴収するので、これも引かれすぎです。
...
できます。短期滞在の申告のほとんどはその方法で提出されています。所得明細は元の雇用主ではなくATOのシステムから来るので、雇用主が3月に離れたパッキングシェッドでも関係ありません。
...
自動的に良い選択とは限りません。早期申告は雇用主の報告が確定する前に作成するので、数字はATOの記録ではなく自分の給与明細から来ます。同じ年度内に戻って再び働けば修正申告が必要になります。記録の揃ったきれいな出国に向き、先行きの不確かな出国には向きません。

## 提出する価値があるかどうかを決めるのは何か？

何かが源泉徴収されたかどうかと、その1年がどんな形だったかです。どんなレートであれ税金が引かれた短期滞在は、ほぼ必ず何かを戻します。全期間45%で源泉徴収されていた短期滞在は、ほぼ必ず多くを戻します。

請求されないまま終わる年度は、本人が自分を納得させてしまった年度です。3週間のプロモーションの仕事、1か月のパッキング、ひとシーズンだけ。それこそ引かれすぎの割合が最も高い年度です。オーストラリアで少しでも働いて一度も申告していないなら、その年度の[タックスリターン](/ja/tax-return)はいまも開いており、債務ではなく還付が生じていた場合にペナルティが問題になることは通常ありません。ペナルティがどこで効くかは[期限後申告](/ja/blog/late-tax-return-penalty-working-holiday)にあります。
`,
  },
...
三つあり、提出そのものは一つだけです。税理士はあなたが雇用主を全部覚えていることに頼らず、ATOのシステムから所得の記録を直接取得します。税理士の提出プログラムに載ることで得られる期限の猶予を適用します。そして提出後に何か問われたとき、あなたとATOの間に立ちます。

難しいのは送信ボタンではなく、送信する前に何を申告書に入れるかを決めることです。その年について実際に真である居住性の位置づけ、パスポートでメディケア税免除が使えるかどうか、そして支出のうちどれが「業務に関係ありそう」ではなく証拠要件を満たすのか。

## 誰が申告書を作成し、誰が署名するのか？

意図的に、別々の人です。当チームが申告書を作成します。417・462ビザの税務だけを扱い、同じ状況を毎日見ているチームです。そのうえで、ATOに提出される前に、登録税理士が確認し署名します。

この分離があるからこそ、専門的な知識と職業上の責任の両方が付いてきます。それは主張ではなく確認できる事実で、その税理士の登録は政府の公的な税務代理人登録簿に掲載されています。

## 税務の手伝いを申し出る相手が本物かどうかはどう確認するのか？

政府の公的な税務代理人登録簿でその登録を見つけることです。唯一の権威ある情報源で、1分もかかりません。登録簿では、登録が現在有効か、条件が付されていないか、そしてBASサービスだけでなく税務代理人サービスをカバーしているかがわかります。

登録簿で拾えないものをほぼすべて拾う第二のテストがあります。まっとうな税理士は、あなたの政府サービスのパスワードを必要としません。自分の代理人用の経路であなたの記録に到達するからです。それを求めてくる相手は、どう名乗っていようと税理士として動いていません。
...
違いがいちばん出るのは、申告書そのものより取得の作業です。名前を忘れた雇用主の所得明細、受け取らなかったTFN、2年前の夏の未申告年度、DASPの請求。いずれも、時差のある国のコールセンターの列より、代理人の経路の内側からのほうが到達しやすいシステムの中にあります。

## 費用はどう考えればいいのか？

料金は事前に固定額でお伝えします。成功報酬や還付金からの差し引きはありません。オーストラリアの一部の事業者が使う「還付金の◯%」という方式は、還付が大きいほど手数料も膨らむので、比較の際に確認する価値があります。料金は当社チームによる確認作業に対するものであり、結果によって変わることはありません。

税理士費用そのものは翌年度の申告で控除できます。税務に関する費用は支払った年度に控除されるので、終わった年度について10月に払った費用は、支払った年度をカバーする申告書で申請します。滞在が2会計年度にまたがる人なら、1年目の費用が2年目の課税所得を減らすのが通常です。出国時に最終の1通だけを提出する人には、申請する翌年度がありません。

## ほぼ形式で済む年はどれか？

単純な年です。1年を通して雇用主が1社、最初の週からTFNが登録されており、15%が正しく源泉徴収され、ABN収入がなく、証拠を揃えるほどの控除もなく、パスポートにメディケアの問題が付いていない。そういう年に、探しに行って見つかるものは多くありません。

形式でなくなる年こそ、この読者にはよくある年です。雇用主が複数、TFNが届くまでの空白、ABNの期間、きちんと確認されていない居住区分、メディケアの答えを変えるパスポート、そしてすでに国を離れた年度。どこでお金が失われるかは[自分で申告するか税理士に依頼するか](/ja/blog/diy-tax-return-vs-tax-agent-working-holiday)にまとめてあります。

## 自分の1年は定型からどれだけ離れているか？

税理士に頼む価値があるかは一般論ではなく、あなたのその年についての問いです。次のうち当てはまる項目が多いほど、その申告書は形式から遠ざかります。
...
まず宣言書です。雇用主の給与システムは、Tax File Number Declarationの記載を見て税率を適用します。店長に口頭で番号を伝えても、通知書の写真を見せても、その書類が提出されるまで何も変わりません。それまでは法律上45%です。

2つ目は雇用主自身の登録です。事業者は15%を適用する前に、ワーキングホリデーメーカーの雇用主としてATOに登録する必要があります。登録していない雇用主は外国人居住者の税率、該当区分では現在30%で源泉徴収する義務があり、あなたの書類が完璧であっても起こります。
...
同じ期間の源泉徴収額を総支給額で割ってください。数秒で終わり、誤った税率が何か月も積み上がる前に捕まえる確実な方法です。

給与明細には総支給、源泉徴収税、スーパー、手取りが別々の行として表示されているはずです。12%のスーパーは給与から差し引かれるのではなく、上乗せして雇用主が払うものなので、手取りを減らすことはありません。スーパーが給与から出ているように見える明細は質問すべきです。割った結果が45%で、宣言書は数週間前に出しているなら、10月に整理する税務の問題ではなく、いますぐ持ち出すべき給与計算の問題です。

## 取りすぎられた税金は失われるのか？

失われません。源泉徴収された1ドルはすべて、実際の納税額に充当される前払いです。45%取られて15%が正しかったなら、その差は[タックスリターン](/ja/tax-return)を提出したときに戻ってきます。

失われるのは、その間そのお金を使えることです。2月から8月まで1ドルにつき30セントがATOのところにあることは、海岸沿いの旅に行けるかどうかの差になります。誤った税率を、後で還付が増えるからと放置せず、いま直すべき理由です。

## 年度末に数字はどうなるのか？

雇用主は6月30日以降に給与計算の報告を確定させ、その年の賃金総額と源泉徴収税の合計が、あなたのTFNのもとでATOに報告されます。その数字が所得明細になり、申告は給与明細ではなくそこから組み立てられます。

あなたの手元に記録がなくても、収入はATOのシステムに存在します。突然辞めた仕事、その後たたんでしまった雇用主、一度も受け取らなかった給与明細があっても、その収入が申告から外れることはありません。ただし合計は、思い出すのではなく取り寄せる必要があります。

## 追いかける価値のあるPAYGの問題はどれか？

給与明細1枚が変なだけのものではなく、一定期間にわたって税率が違っていたものです。宣言書が処理されるまでの1か月が45%だった、収穫シーズンをまるごと未登録の人材派遣会社で働いた、2つ目の仕事が1年ずっと誤った税率だった。どれも実際のお金になり、どれも同じ方法、つまり申告を通して回収します。

逆向きに効く2つもあります。ワーキングホリデーメーカーが宣言書で免税枠を申請すると源泉徴収が少なすぎ、還付ではなく納付になります。現金払いの仕事は何も源泉徴収されないので、税金は年度末に全額まとめて発生します。どちらも10月に気づくより前もって備えるほうが簡単です。[給与明細の源泉徴収の行が何を意味するか](/ja/blog/what-does-tax-withheld-mean-payslip)を毎回の給与で確認すれば、これらが何か月も続くのを止められます。

## 15%に設定されるかどうかは何で決まるのか？

15%は正しく設定されたときの結果であって、自動的に与えられるものではありません。実際に何%引かれているかは次の点で決まります。
...
ビザの終了日は、[出国後のスーパー受取](/ja/superannuation)の資格がいつ発生するかを決めます。連絡が取れなくなったファンドは、やがて残高を未請求としてATOに移管します。
...
`,
  ...
  'cash-in-hand-tax-return': {
    ...
    body: `
必要です。現金で受け取った給与も、銀行口座に振り込まれた給与とまったく同じ課税所得です。違いは、途中で何も源泉徴収されていないことで、税金は給与ごとではなく提出のときに精算されます。収入は雇用主の報告ではなく、あなた自身の記録から申告します。

## 現金払いになると何が変わるのか？

変わるのは仕組みだけで、義務は変わりません。その場でPAYGが源泉徴収されず、Single Touch Payrollの記録も作られず、あなたは全額を受け取ります。納税の負担は雇用主の給与計算からあなたに移り、年度が査定されるときに支払います。

ワーキングホリデーメーカーの15%の税率は現金収入にも同じように適用されますが、処理済みのものとしてではなく、納付すべき金額として現れます。すべてを現金で働いて何も取り分けていなかった人は、還付ではなく請求を受け取ることがあります。

## 雇用主が現金で支払うことは許されているのか？

許されています。賃金を現金で支払うこと自体は適法です。適法でないのは、税金を源泉徴収しないこと、賃金を報告しないこと、スーパーアニュエーションを支払わないこと、給与明細を渡さないことです。

現金の取り決めは、それ自体では何の証拠でもありません。きちんと運営された現金の仕事には、給与明細、PAYGの源泉徴収、スーパーの支払い、ATOへの報告があります。それらが欠けているとき、欠けている義務も、その責任も雇用主のものです。

## 正直な申告を可能にする記録とは何か？

その場で自分が取ったメモです。ほかに何も存在しません。働いた日、シフトごとの時間、合意した賃率、毎回受け取った金額、そして誰が払ったか。1年後に組み立て直すより、その都度記録したほうが説得力があります。
...
これらは、携帯をなくしても残る場所に保管してください。ATOは提出から数年後まで申告について尋ねることができ、そのころにはWhatsAppのやり取りはたいてい消えています。

## 金額が正確でない場合はどうするのか？

正直な最善の見積もりを申告し、その数字に至った過程を説明できるようにしてください。現金収入は所得明細のない給与所得として報告し、自分での提出でも税理士経由でも対応できます。

誠実な見積もりと意図的な省略はまったく別のものです。問題を生むのは不正確さではなく省略で、説明できる方法に裏づけられた数字なら、正確でなくても構いません。収入を少なく申告した場合の帰結は[収入の過少申告とATOのペナルティ](/ja/blog/understating-income-ato-penalty-working-holiday)で扱っています。

## 現金の仕事のスーパーはどうなるのか？

請負業者ではなく従業員だったなら、現金で払われようと振込で払われようと、通常の労働時間の賃金に対して12%のスーパーアニュエーションが発生していました。現金払いがその義務を消すことはなく、現金の仕事でお金が消えているのはたいていここです。

取り戻せるかどうかは、収入の申告と同じ記録にかかっています。Superannuation Guarantee Chargeの手続きがどう動くかは[未払いスーパーへの対処](/ja/blog/super-employer-not-paying-what-to-do)にあります。

## 申告すると自分が困ることになるのか？

申告することがあなたを守ります。正直な申告はきれいな記録であり、源泉徴収と報告とスーパーの支払いを怠ったことは、あなたの側ではなく雇用主の側の帳簿に載っています。

リスクは逆側にあります。提出していない年度や、収入を落として提出した年度が、あとから面倒になります。オーストラリアの別のビザを申請するつもりなら特にそうです。雇用主をFair Work Ombudsmanに通報するかどうかは別の判断で、それが何を伴うかは[オーストラリアの賃金未払い](/ja/blog/wage-theft-working-holiday-australia)で扱っています。

## 現金の年が還付で終わるか請求で終わるか？

現金収入を申告するかどうかに議論の余地はありません。それがいくらの負担になるか、その年が還付で終わるか請求で終わるかは、残りの絵柄で決まります。
...
源泉徴収は計算ではなく進行中の見積もりだからです。給与計算は「今週が12か月繰り返される」前提で毎週差し引くので、途中で始まった年、途中で終わった年、形の変わった年は、実際の納税額と合わない合計を生みます。ワーホリの1年はその三つとも起こします。
...
その年を再構成するまではわかりません。計算は、実際の収入に本来適用されるべきだった税額と、全雇用主で源泉徴収された合計を比べ、源泉徴収には見えない項目を足す作業です。

引用する価値のある平均還付額は存在せず、平均を語る人は別の誰かの1年を説明しています。同じ賃金を稼いだ二人が、居住性の位置づけ、メディケアの受給資格、45%の期間によって数千ドル違う着地になることがあり、そのどれも給与明細だけからは見えません。

## 還付の大きさを決めるのは何か？

五つの事実がほぼすべてを決め、そのうち四つは調べなくても自分で知っています。五つ目の居住性だけは、思い出すのではなく判定する必要があります。
...
居住性の項目からです。最も大きな差が決まり、計算ツールが助けにならない場所でもあります。居住区分はビザでは決まらず、ご本人の事情によって決まるためきちんと確認する必要があり、判定次第で1年全体の計算が変わり得ます。

この判断は、ほとんどの人が見落とす細部で決まり、どちらの方向にも間違えやすいものです。当社は1年の実態を確認してから立場を決めます。理由は[ワーホリの税務居住性](/ja/blog/tax-residency-working-holiday-makers)にまとめてあります。

## 還付はいつ届くのか？

電子的に提出された申告書の還付は、通常は提出から7営業日から14営業日で、指定したオーストラリアの銀行口座に支払われます。7月から9月の繁忙期は数日長くかかり、雇用主の所得明細が確定する前に提出すればかなり長くかかります。

計画すべきなのは口座です。還付はオーストラリアの口座にしか支払われるので、国を離れる人は提出後少なくとも4週間から6週間、その口座を生かしておく必要があります。何が還付を止めるのかは[還付金はいつ届くか](/ja/blog/how-long-does-tax-refund-take-australia)にあります。

## 帰国した後でも請求できるのか？

できます。それでも驚くほど多くの人が請求しないままです。出国した年度の申告は海外から提出でき、それ以前の未申告の年度も後から提出できます。別の国にいることでファイルが閉じることはありません。

請求されないまま終わる年度は、ほぼ必ず短い年度です。3か月働いて、金額が小さすぎて手間に合わないと考えて離れた年度。それこそ引かれすぎの割合が最も高い年度です。3か月の年が12か月の年として課税されているからです。

## 結果を実際に変えるのは何か？

二つあり、そのどちらも努力の量ではありません。ひとつは、その年度のすべての雇用主が把握されているかどうかです。忘れられた仕事は、後からATOによる修正が入る最も多い原因であり、還付が過小になる原因でもあります。もうひとつは、源泉徴収には見えない項目が申請されたかどうかです。メディケアの扱い、居住性の扱い、そして控除です。

還付をどう最大化するかへの答えは、跳ね返ってくる強引な申請ではなく、複数の雇用主、複数の州、しばしば二つの会計年度にまたがって働いた1年の完全な絵を描くことです。[計算ツール](/ja/calculator)に数字を通せば目安が出て、それを確定させるのは[タックスリターン](/ja/tax-return)をきちんと作成することです。
`,
  },
  ...
  'how-long-does-tax-refund-take-australia': {
    ...
    body: `
オーストラリアの還付金の多くは、電子提出から7営業日から14営業日で支払われます。7月から9月の繁忙期はこれより長くかかり、ATO（オーストラリア税務署）がその年の申告の大半をその時期に処理するからです。紙での提出は別の尺度で、8週間以上かかります。

## 通常の還付までの流れはどうなるのか？

きれいに電子提出された申告書は、全体として2週間以内に完了するのが普通です。ATOは数日以内に受領して処理を開始し、還付の大半は7日目から14日目に発行され、遅いものが14日目から21日目に着地します。

繁忙期の外、10月から6月はこれより速いことがよくあります。7月から9月は同じ申告書が数日長くかかりますが、理由は件数だけです。

## 還付の速さを実際に決めているのは何か？

還付の日付を動かすものは六つあり、提出後に左右できるのは二つだけです。群を抜いて大きいのは、雇用主の所得明細が確定する前に提出したかどうかです。ATOがまだ確認していないデータの上に作られた申告書は、システムを通るのではなく列に並びます。

- **提出方法。**電子提出は日単位、紙は月単位です
- **所得明細の状態。**雇用主は年度終了後に報告を確定させます。その前の提出は不一致を招きます
- **初めての提出者。**最初の本人確認が一度だけ時間を追加し、以後は起きません
- **データの不一致。** ATOがすでに保持している数字と食い違う項目は、申告書を手動審査に移します
- **銀行口座情報。** BSBや口座番号の誤りは、小さなミスとしては最も高くつきます。支払いが弾かれ、再発行が必要になります
- **時期。** 7月から9月は誰にとっても遅くなります

## 銀行口座の誤りがなぜそこまで問題になるのか？

還付は指定されたオーストラリアの銀行口座にのみ支払われ、ATOは国際送金を快適には行いません。口座が解約されていたり数字が違っていたりすると、支払いは差し戻され、正しい情報が提供されるまでATO記録上の残高として待機します。

「還付金はどこへ行ったのか」という質問の第一の原因がこれです。ほとんどの場合、どこにも行っていません。発行され、弾かれ、待っています。オーストラリアを離れる人は、提出後少なくとも4週間から6週間は口座を開けたままにすれば、この問題をまるごと避けられます。

## 申告書が「審査中」になるのは何を意味するのか？

審査中とは、システムではなく人が申告書を見ているという意味で、トラブルの兆候ではなく日常的な処理です。よくあるきっかけは、申告書の他の部分と噛み合わない居住性の回答、ATOには見えているのに申告書にない収入、提出直前に変更された銀行口座情報です。

報告された収入に対して還付が大きい場合、選ばれる確率がやや高くなります。制度の健全性チェックであって告発ではなく、時間は追加されますが、もともと正しい申告書であれば結果が変わることはめったにありません。

## 2週間経っても還付が届かないのはなぜか？

2週間は目安であって保証ではありません。それを超える申告書の大多数は、三つのどれかで止まっています。提出時に所得明細が確定していなかった、銀行口座情報が合わない、手動審査の列にいる。どれも通常はさらに1週間から2週間で解消します。

28日を過ぎたら、何か具体的なものが止めています。当社が提出した申告書であれば、登録税理士の経路から処理状況を直接確認し、どこで止まっているかを特定して、本人の代わりにATOと対応できます。

## オーストラリアを離れると期間は変わるのか？

海外からの提出が申告書自体を遅くすることはありません。同じ7営業日から14営業日が適用され、過去の年度の申告も帰国後に提出できます。変わるのは送り先で、還付は依然としてオーストラリアの口座に支払われます。

[帰国後の税務](/ja/blog/tax-obligations-after-leaving-australia)とあわせて読む価値があります。還付もDASPのスーパー支払いも出国後に届くので、その振込先の口座は帰国便より長く生き延びる必要があります。

## 速いか遅いかは送信ボタンの前に決まるのか？

速いか遅いかを決めるのは自分の1年に関する四つの事実で、四つとも提出前に決まっています。提出してしまった後に急がせる手段はありません。
...
どれも7月第1週に急いで提出する理由にはなりません。確定前のデータで7月最初の週に出した申告書は速いのではなく、審査の列の先頭に並ぶだけです。速く戻ってくる[タックスリターン](/ja/tax-return)は、送った時点で完成していた申告書です。[還付金の試算](/ja/calculator)は提出前にできます。
`,
  },
...
税額控除は、あなたが払うべき税金そのものを減らします。所得控除は、税金が計算される元の所得を減らします。同じ金額でも結果はまったく違います。
...
この文章を読んでいる多くの人にとってLITOは使えず、提出時にどれだけ気を配っても変わりません。

## どんなときに使えるようになるのか？

その年度についてオーストラリアの税務居住者である場合で、ワーキングホリデーメーカーの少数は本当に該当します。居住性はビザでは決まらず、ご本人の事情によって決まります。きちんと確認する必要があり、自己診断は裏目に出やすい項目です。

居住者と認定された場合に何が付いてくるかは、国籍によって変わることがあります。狭い例外に届く人にはLITOより大きな話になり得ますが、当てはまる人は多くありません。なぜ判定が難しいのかは[居住性の判定](/ja/blog/tax-residency-working-holiday-makers)で説明しています。

## かわりに何を請求できるのか？

ワーキングホリデーメーカーに届く軽減は、居住者向けの税額控除ではなく、免除と控除を通してやってきます。合わせればLITOよりかなり大きな金額になります。
...
多くの人にとってLITOを追いかけるのは労力の無駄で、同じ注意をメディケアの位置づけと控除の網羅に向けたほうが報われます。

## 税額控除が税額を上回った場合はどうなるのか？

何も支払われません。LITOは還付不可なので、納税額が500ドルで控除が700ドルなら、税額はゼロになり、残りの200ドルは還付されずに消えます。

税額控除と還付が混同されやすいのはこのためです。還付は、その年に給与から源泉徴収された税金から来るのであって、税額控除から来るのではありません。税額控除が納税額を減らすことで、源泉徴収された税金のうち戻ってくる分が増えます。

## 1通の申告に複数の税額控除が適用されることはあるのか？

あります。それぞれ別々に計算されてから、納税額の合計に適用されます。給与とABN収入の両方がある年は、事業部分にスモールビジネス税額控除が乗り、メディケアの位置づけは別に処理されます。

申告が書類ではなく計算になるのはこの組み合わせのところで、年度の途中で居住性が変わった場合はとくにそうです。部分年度の居住者は、年の一部が一方のルール、残りがもう一方のルールのもとにあり、税額控除は年全体ではなくその期間に従います。

## 二つの事実だけで答えが出るのはなぜか？

決めるのは2つの事実だけです。ひとつは、その年度あるいはその一部についてオーストラリアの税務居住者だったかどうかです。ビザでは決まらず、ご本人の事情によって決まるため、きちんと確認する必要があります。もうひとつは国籍で、居住者と認定されたときに何が得られるかが変わることがあります。

どちらも、一読して自信を持ってチェックできる欄ではありません。とくに居住性は、自分で提出した申告で最も多く間違えられ、このガイドに出てくるどの控除を合わせたよりも大きな金額を動かします。次の点が実際の分岐になります。
...
2つ目は、その誤りがどこから来たかです。私たちが見る争いの多くは、最初の[タックスリターン](/ja/tax-return)の作り方にさかのぼります。深く考えずに答えた居住性の項目、既定のまま進めたメディケアの扱い、裏づけのないまま申請した控除。異議申し立ては、提出時に10秒で下した判断を直すための高くつく方法です。
`,
  },
  ...
  'amending-tax-return-australia': {
    ...
    body: `
オーストラリアのタックスリターンは、査定された後でも修正できます。期限は原則として、査定通知（Notice of Assessment）の日付から2年です。修正は両方向に働き、申請し忘れた控除も、申告し忘れた収入も足せます。ATO（オーストラリア税務署）も同じ2年の時計で動いています。

## 修正申告は何のためのものか？

提出した申告書の誤りや漏れを正すためのものです。争いでも異議でもなく、無料で日常的な手続きです。ワーキングホリデーメーカーの修正申告のほとんどは、還付が増える結果になります。
...
最後の項目が、ワーホリで単独では最も多い修正理由です。Services AustraliaのMedicare Entitlement Statementは発行まで数週間かかることが多く、その間に出した申告書はそれなしで提出されます。

## 期限はどれくらいあるのか？

個人と小規模事業については、最初の査定通知の日付から2年です。他の一部の納税者には4年が適用され、詐欺や脱税の場合は期限がありません。

2年は思うより余裕がありますが、別の国にいるとあっという間です。時計は会計年度末ではなく査定から動き出すので、2026年9月に査定された申告書は2028年9月まで修正できます。

## 修正申告と異議申立ては何が違うのか？

答えている問いが違い、混同すると期限を無駄にします。修正申告は提出した申告書の誤りを直し、異議申立てはATOが下した判断を争います。

- メディケア免除を忘れていた：修正申告
- 居住性の査定のされ方に納得できない：異議申立て
- ATOから変更を提案するレターが届いた：先回りして修正するのではなく、記録を添えて回答する

二つ目の道筋は[ATOの判断への異議申立て](/ja/blog/appealing-ato-decision-australia)にまとめてあり、独自の期限と構造があります。

## お金はどうなるのか？

修正で還付が増える場合、追加分が指定の口座に支払われ、通常は数週間から2か月です。還付が減る場合、ATOが修正後の査定を発行し、差額が支払うべき金額になります。通常は21日以内です。

忘れていた収入を足す修正は債務を生みますが、それでも正しい行動です。しなかった場合、ATOがデータ照合で見つけ、同じ金額に利息とペナルティが加わります。

## 修正すると目をつけられるのか？

つけられません。修正申告は制度の通常の一部で、記録に裏づけられた正当な訂正がフラグになることはありません。誤りの自発的な開示は、同じ誤りをATOが見つけた場合より有利に扱われます。

実際に注意を引くのは、裏づけのない大きな申請が繰り返されるパターンです。メディケア免除や忘れていた作業靴一足を足す一度きりの修正は、目に留まりません。

## オーストラリアを離れた後でも修正できるのか？

できます。この手続きに国内にいることを求める部分はなく、2年の期間はどこにいても同じです。修正は遠隔で提出でき、還付はオーストラリアの口座に支払われます。

実務的な制約は修正そのものではなく口座です。オーストラリアの口座を解約していると、代わりの支払い経路を用意する手間が加わります。飛ぶまでではなく、その年度が本当に終わるまで口座を生かしておく価値があります。
...
当社が修正する申告書のパターンは一貫しています。書類が遅れて申請されなかったメディケア免除。領収書が別のスマートフォンにあったせいで見落とされた控除。誤った場所に記載されたABN収入。TFNが届く前の45%の期間が回収されていなかったケース。ほぼすべてが上方向で、「完全に」ではなく「早く」提出された申告書から来ています。自分で[タックスリターン](/ja/tax-return)を提出して、居住性、メディケア、すべての雇用主を扱っていなかったなら、2年が開いているうちに見直す価値があります。
`,
  },
  ...
  'ato-payment-plan-tax-debt-australia': {
    ...
    body: `
できます。ATO（オーストラリア税務署）からの請求を期限までに払えない場合、支払い計画（payment plan）で分割して清算できます。一般利息課徴金（General Interest Charge）は発生し続けるため一括より高くつきますが、黙っているよりはるかに安く済みます。税金の債務はオーストラリアを離れても消えません。

## そもそもなぜワーキングホリデーメーカーが納税することになるのか？

その年のどこかに、源泉徴収の裏づけがない収入があったからです。最も多いのはABNや請負の収入で、請求額の全額が手元に届き何も引かれていません。次いで免税枠を誤って申請した宣言書、源泉徴収のない現金の仕事です。

どれもその場で気づく誤りではありません。毎週少しだけお金が多い感覚として現れ、数か月後に一つの数字として届きます。

## 支払い計画とは何で、ATOはいつ応じるのか？

一括ではなく分割で支払う正式な合意で、通常は週ごとか隔週の口座振替、多くは2年以内の完済です。計画が有効で履行されている間は、積極的な取り立てから守られます。

ATOが応じるのは、金額が身の丈に合っていて、一括で払えない事情が本当にあり、分割の裏づけとなる収入源があり、過去の取り決めを不履行にしていない場合です。追いかけざるをえなかった相手より、期限前に相談してきた相手に対してのほうが柔軟です。

## 時間をかけると何が余分にかかるのか？

一般利息課徴金です。未払い残高に日々複利で積み上がり、政策金利よりかなり高く設定されています。起算は計画を始めた日ではなく元の期限です。

支払いの遅れとは別に、提出の遅れに対するペナルティもあります。提出遅延（failure to lodge）は、申告が期限を過ぎるごとに28日につき1ペナルティ単位、現在330ドルが課され、上限は5単位の1,650ドルです。このペナルティは提出しないことに付くので、期限どおりに提出して支払いだけ遅れるほうが安く済みます。適用条件は[期限後申告のペナルティ](/ja/blog/late-tax-return-penalty-working-holiday)にあります。

## 単に離れてしまったらどうなるのか？

債務は残ります。一般利息課徴金は積み上がり、残高は将来のオーストラリアの還付に自動的に相殺されます。多くの人が出国後に提出する最終年度の申告も含めてです。そしてATOの記録に残ります。

未払いの税金の債務は、将来のオーストラリアのビザ申請の場で表に出てほしくないものです。小さな残高が償却されることはたまにありますが、それはATOが決めることで、当てにはできません。

## 飛ぶ前に何をしておくべきか？

オーストラリアの銀行がまだ使えるうちに取り決めを設定しておくことです。海外からでも機能し続けるのは、開いているオーストラリアの口座からの口座振替だけです。その口座を閉じると計画は払えなくなります。

出発前に残高を確認してください。困窮の申立てや減免の要請は海外から書面でやり取りできますが、計画を立てること自体はオーストラリア国内からのほうがはるかに簡単です。

## ペナルティが減ることはあるのか？

あります。減免は、初めての誤り、義務の本当の誤解、重い病気やその他の異常な事情、そしてその後きちんと対応してきた場合について検討されます。

減免は自動ではなく裁量で、全部より一部になることが多いです。誤解していたという主張は、放置した月数だけ弱くなります。

## 金額が間違っていると思う場合はどうするのか？

払うのではなく争ってください。誤っていると考える査定は、原則として当初の査定が発行されてから2年以内に修正できますし、納得できない判断には正式に異議申立てができます。

どちらもそれ自体では一般利息課徴金を止めず、検討中も争っている金額に利息が積み上がります。金額が大きい場合は、結論を待たず、支払い計画を用意しつつ同時に争うほうが有利です。どの誤りにどの経路が当てはまるかは[タックスリターンの修正申告](/ja/blog/amending-tax-return-australia)にあります。

## 短い不便で済むか2年の取り決めになるか？

同じ額の債務でも、下の答え次第で短い不便にも2年の取り決めにもなります。
...
決着が2017年1月1日からの15%です。ただし単独では来ませんでした。同じ一括の措置で、ワーキングホリデーメーカーのDeparting Australia Superannuation Paymentの税率が35%から65%に引き上げられ、学生など他の一時滞在ビザ保持者には35%が残されました。給与側の譲歩は[スーパー](/ja/blog/tax-on-super-withdrawal-backpacker)の側で支払われ、今もそうです。
...
変える場合には大きく変えます。届き得るかどうかは推測で片づけられません。当社は1年の実態を確認してから立場を決めます。[タックスリターン](/ja/tax-return)を提出する前に確認する価値のある分岐です。
...
そのどれも失われていません。取りすぎた税金は申告のときに精算されるので、没収ではなく先送りです。その間にかかるのは資金繰りで、ホステルの家賃を毎週払っている人にはそこが痛みます。TFNのなかった年の申告が最大の還付になることが多い理由でもあります。

## なぜTFNがないと提出できないのか？

TFNが、雇用主から報告された収入とあなたを結びつける識別番号だからです。ATOは雇用主の報告のもとで賃金と源泉徴収税を保有していますが、それを結びつけるTFNが存在するまでは、査定すべきものが存在しません。

だから人はこのお金をあきらめます。番号がなかったのだから税金は消えたのだろう、と考えるのです。消えていません。雇用主の報告のもとで照合を待っていて、TFNを申請することがその照合を成立させます。申請は無料で、本人確認を経れば海外からでも行えます。

## 何も残していなかった場合、記録はどうなるのか？

必要なものの多くは、あなたの引き出しではなくATOのシステムにあります。雇用主はSingle Touch Payrollのもとで賃金と源泉徴収を報告しており、申告はその報告から組み立てられます。給与明細を失くしたことが、感じられるほど大きな問題にならないのはこのためです。

本当に問題になるのは、雇用主がそもそも一度も報告していなかった場合で、現金払いの業種では実際に起こります。収入は手元にあるものから組み立て直すことになり、その方法は[現金払いのタックスリターン](/ja/blog/cash-in-hand-tax-return)で扱っています。

## その年度がすでに過ぎている場合はどうなるのか？

過去の会計年度は今でも提出できます。未提出の年度が回収不能になる時点は存在せず、出国した年度について提出することは日常的に行われています。

時間とともに変わるのは2つです。報告が不完全だった場合、雇用主の記録を追いかけるのが難しくなること。そして海外からの本人確認が遅くなることです。どちらも扉を閉じるものではなく、待ったからといって還付が減ることもありません。
...
初めての申告、発行されたばかりのTFN、海外の住所という組み合わせは、ATOで手動の本人確認に回りやすくなります。これは拒否ではなく遅れで、書類が完全で一貫していれば期間は短くなります。

## TFNがなかった年には、ほかに何が眠っているのか？

源泉徴収の差額だけではありません。TFNなしで働いた年は、ほかの何も設定されていなかった年でもあるからです。よくあるのはスーパーアニュエーションです。TFNが紐づかないままの拠出は、ファンドやATOのところで誰とも結びつかず置かれていることが多く、今もあなたのものです。

もうひとつはメディケア税の免除です。ドイツや日本のパスポートを持つ人は原則としてメディケアの受給資格がないので2%は本来かかりませんが、申請しない限り外れません。どちらも給与明細には現れないので、気づかれません。

## 過剰徴収の大きさは何が決めたのか？

過剰徴収を取り戻すこと自体は素直な作業です。金額の大きさと、どれだけ早く手元に届くかは、次の点で決まります。
...
TFNなしで働いた人は最も狙われやすいグループです。制度の仕組みにすでに自信がない状態だからです。バックパッカーのFacebookグループやメッセージのコミュニティには、税金を片づけてあげると申し出る人が絶えず現れます。
...
`,
  ...
  'multiple-jobs-tax-return-working-holiday': {
    ...
    body: `
会計年度中のすべての仕事が1通の[タックスリターン](/ja/tax-return)に載ります。1週間だけキッチンで働いてそれきりになった仕事も含みます。雇用主はそれぞれ別々にオーストラリア税務署（ATO）へ報告しているので、申告は合計に対して照合されます。還付は、税率が間違っていた雇用主のところに眠っています。

## ATOはなぜあなたの働いた先をすでに知っているのか？

Single Touch Payrollがあるからです。すべてのオーストラリアの雇用主は、年1回ではなく給与計算のたびに賃金、源泉徴収税、[スーパー](/ja/superannuation)をATOへ報告する義務があります。提出しようとする時点で、ATOは完全な一覧を持っています。
...
古い番号が分からない場合、回復する手続きは新規申請とは別物で、正しいのは回復のほうです。詳しくは[セカンドビザで新しいTFNが必要か](/ja/blog/do-you-need-new-tfn-second-visa)で扱っています。
...
`,
  ...
  'late-tax-return-penalty-working-holiday': {
    ...
    body: `
Failure to Lodgeペナルティは、[タックスリターン](/ja/tax-return)が遅れた28日ごとに1ペナルティユニットで、上限は5ユニットです。1ユニット330ドルなので最大は1,650ドルです。ATOがあなたにお金を払う側であっても適用されえます。実際に払うことになるかを決めるのは、これまでの提出履歴です。

## 申告の期限は実際いつなのか？

自分で提出する場合は、会計年度終了後の10月31日です。2024-25年度の申告なら2025年10月31日です。会計年度は7月1日から6月30日までで、この期限は国を出たからといって動きません。

登録税理士を通して提出すると、日付は大きく変わります。税理士は翌年5月まで続く緩和された提出プログラムのもとで仕事をしており、標準の10月の期限より前にその顧客リストに載っていれば延長が適用されます。2月に税理士と契約しても、10月に過ぎた期限がさかのぼって延びることはありません。

## ペナルティはどう積み上がるのか？

日ごとではなく28日ごとの段階で積み上がるので、2日遅れと20日遅れに差はありません。28日が1区切り経過するごとに1ユニットが加わり、5ユニットで上限に達します。期間にすると4か月を少し超えたあたりです。
...
法律上は適用され、実務上は適用されないことが多いです。ATOの立場は、提出の義務は税金を払うかどうかとは別だというもので、還付になる申告を遅れて出しても、それは遅れた申告です。

実務上ペナルティは選択的に適用されており、それを決めるのは単年ではなくパターンです。ほかに何の履歴もない人の初めての遅れと、3年続けて何も提出していない状態とでは違う扱いです。意図的に提出していない場合や、未提出の年度が一度に複数見つかった場合が、還付になる申告にもペナルティが本気で適用される場面です。

## 利息も課されるのはどんなときか？

遅れた申告が納付を生む場合だけです。General Interest Chargeは未払いの税額に当初の納付期限から課され、日々複利で、キャッシュレートよりかなり高い水準に設定されています。小さな債務を数年放置すると、かなり大きくなります。

申告が還付やゼロで終わる場合、課すべき残高がないので利息もありません。遅れた還付の申告が、ABNの年度を抱えた遅れた申告よりずっと小さな問題なのはこのためです。

## ペナルティは取り消せるのか？

免除、つまり減額または取り消しの対象で、正当な理由があればATOはその裁量をかなりの頻度で行使します。期限の前後での病気や入院、近親者の死去、自然災害、提出を妨げたATO側のシステム障害は、いずれも認められる理由です。

免除は自動ではなく、裏づけとなるものを添えて求める必要があります。他はきれいな履歴での初回が最も認められやすいケースです。同じ主張は繰り返すたびに弱くなるので、3年ためこむ前に1年の遅れをいま片づけてください。

## すでにオーストラリアを離れている場合はどうなるのか？

義務も債務もあなたについてきます。未提出の申告はATOの記録に無期限に残ります。ATOが小さなペナルティ額を国境をまたいで追いかけることはありませんが、その記録は都合の悪い場面で表に出てきます。

未払いのATOの金額は、後の還付と、状況によっては[DASPの支払い](/ja/superannuation)とも相殺されます。未解決の提出状況は、セカンドやサードのビザ申請がDepartment of Home Affairsによってより丁寧に見られる原因になりえます。そして、請求しなかった還付は今もそこに置かれたままで、実際にはこれが圧倒的に多い状況です。遅れて提出することは、提出しないことよりほぼ常に良い選択です。ペナルティには上限がありますが、還付にはありません。

## 未提出の年度が複数ある場合はどうなるのか？

年度どうしが相互に影響し、有利な方向ではありません。Failure to Lodgeペナルティは全体ではなく申告ごとに算定されるので、期限を過ぎた3年度がそれぞれ5ユニットずつを抱えることがありえます。そのパターン自体が、ATOをペナルティの選択的な適用から当然の適用へ動かします。

片づける順番も効いてきます。古い年度から提出すると、それぞれの年度の出発点が定まります。ある年度の還付が別の年度の債務と相殺されることもあるので、複数年をまとめた最終結果は、どの単年から想像したものとも大きく違うことがあります。2、3年前のワーキングホリデーで未請求だった還付は、今も日常的に回収されています。

## 遅れて提出することと修正することの違いは何か？

限度の異なる2つの別々の手続きです。遅れて提出するというのは、その申告がまだ一度も提出されていないという意味で、提出そのものに打ち切り期限はありません。2022-23年度の申告を今日でも提出できるのはこのためです。

修正というのは、申告が提出されていて、その中身に誤りがあったという意味です。個人の場合、標準的な修正の期限は査定通知が発行された日から2年で、それを過ぎると原則として立場は固定されます。だから急いで雑に出した申告は、遅れて正しく出した申告より悪い結果になりえます。遅れたほうは今からでも正しくできますが、間違ったほうはいずれ直せません。

## 還付の年度か納付の年度か、どちらなのか？

同じ遅れでも、その年度の中身で費用も緊急度も違います。還付の年度か納付の年度かでまず分かれ、そのあとは提出の履歴が効きます。
...
あなたが提出する前に、ほぼすべてを知っています。Single Touch Payrollで、すべての賃金の支払い、各給与計算での源泉徴収額、各ファンドに報告された[スーパー](/ja/superannuation)の拠出が直接ATOに流れており、申告の給与側は信用ではなく記録に対して照合されます。

ABNの側も、目立たない形でカバーされています。Uber、DoorDash、Airtasker、MenulogといったギグのプラットフォームはSharing Economy Reporting Regimeのもとで支払額を報告します。建設、清掃、宅配、道路貨物、IT、警備の事業者は、請負業者への支払いをtaxable payments reportingのもとで報告します。銀行は利息を、株式や暗号資産のプラットフォームは売却を報告します。抜けた収入は隠れているのではなく一致していないだけで、その不一致は自動的に見つかります。

## どのペナルティの段階になるかを決めるのは何か？

申告がなぜ誤っていたかについてのATOの見方で、3つの段階は金額ではなく心の状態で分かれ、順に不足額の25%、50%、75%です。

ワーキングホリデーメーカーの圧倒的多数は最初の段階に着地します。通常の原因が、忘れられた雇用主や記録のないまま申請した控除であって、意図的な何かではないからです。免除が最も認められやすいのもこの段階です。

- 合理的な注意を怠った場合：不足額の25%。バックパッカーの通常のケースです
...
そこにGeneral Interest Chargeが、未払いの税額に対して当初の納付期限から、日々複利でキャッシュレートよりかなり高い水準で走ります。データ照合による不一致は提出の直後ではなく1年か2年あとに表に出ることが多いので、利息は最終的な金額の意味のある割合を占めるのが普通です。

## 実際に確認のきっかけになるのは何か？

一致するはずの2つの記録がずれていることで、ATOの監査という言葉から想像されるより狭い一覧です。ワーキングホリデーメーカーの申告に対する確認のほとんどは提出から数週間以内に自動的に始まり、入り口は情報を求める手紙です。
...
債務は残り、回収する手段も残ります。ATOに対する未払い額は帰国しても消えず、その間もGeneral Interest Chargeは走り続けます。

そこから3つの帰結が生じます。将来の還付が債務に充てられることがあり、状況によっては当てにしていた[DASPの支払い](/ja/superannuation)も含まれます。金額が大きければ国際的な回収に回されることがあります。そして未解決の状態は記録に残り、オーストラリアの別のビザを申請するときにHome Affairsから見える位置にあります。

## 申告を守れるものにするのは何か？

まず網羅、次に裏づけです。どんなに短い仕事でもすべての雇用主を入れ、ABNとプラットフォームの収入もすべて入れること。これで、控除の当否を判断する前に不足の最も多い原因が消えます。

後半は、支えられるものだけを申請することです。記録のある控除は確認に耐え、記録のない同じ控除はペナルティの付いた不足に変わります。2年後にほどける大きな還付は、ペナルティと複利の利息が乗る分、持ちこたえる小さな還付より価値が低くなります。

TFNとパスポートと引き換えに膨らんだ還付を約束する相手を避けるべき理由もそこにあります。その仕組みは真実でないことを申請して成り立っており、ペナルティが課されるのは相手ではなくあなたです。誰があなたの情報を求めてよいのかは[TFNを守る](/ja/blog/tfn-security-protect-from-fraud)にまとめてあります。

## 見つかる前に訂正したほうが安く済むのか？

かなり有利で、その差は善意の問題ではなくペナルティの制度に組み込まれています。ATOが調査を始める前の自発的な開示は不足ペナルティを大きく減らし、調査が始まったあとの開示は減額幅が小さくなります。

実務上の帰結は、抜けに気づくことは感じられるほどの災難ではないということです。忘れていた雇用主、報告されていると知らなかったプラットフォーム収入、裏づけられなかった控除は、いずれも修正申告で直せます。手紙が届く前にやることが、費用を税金そのものの近くに留めます。

## ATOはいつまで遡って見られるのか？

多くの個人については2年で、査定通知が発行された日から数えます。それを過ぎると査定は原則として双方向に確定します。あなたが自分に有利な方向で修正できる期間でもあります。

例外があり、それが意図的な省略を別のリスクにしています。詐欺または脱税があった場合、期間の制限はまったくなく、ATOはその年度を無期限に開き直せます。2年で安全になる雑な申告と、決して安全にならない偽りの申告の違いはここです。

## 25%で終わるか75%になるかの分かれ目は？

不足が生じたときの費用は、金額そのものより、その原因と、いつ誰が先に見つけたかで決まります。次の点が、25%で終わるか75%になるかを分けます。
...
2026年7月1日からの新しいルールと関係します。即時控除の基準が1,000ドルに引き上げられ、そこそこの電動工具や電動アシスト自転車を買う人にとって計算が変わります。二つの関係は[1,000ドル即時控除ルール](/ja/blog/1000-dollar-instant-deduction-rule-2026)にまとめてあります。
...
2026年7月1日から2027年6月30日までの2026-27年度で、提出は2027年7月以降です。遡及ではないため2025-26年度以前の申告には影響がなく、[道具と機材の300ドルの基準](/ja/blog/tools-equipment-under-300-instant-deduction-whv)を含む既存の裏づけルールのもとで作成されます。
...
45,000ドルを超えると税率は30%になり、同じ控除の価値は300ドルですが、1年でその区分に届く人はごくわずかです。制度はビザの種類に中立で、417や462の保持者にもオーストラリアの居住者と同じように適用されるため、方法の選択以外に[タックスリターン](/ja/tax-return)で変わることはありません。
...
**センツ・パー・キロメートル方式**は業務走行1キロあたり91セントの定率で、車1台につき年間5,000キロが上限です。上限まで使うと年間4,550ドルです。領収書ではなく見積もりの合理的な根拠で足りるので、手間の少ない選択肢です。

**ログブック方式**は、連続する12週間の使用を記録して業務使用割合を確定し、その割合を年間の実費、つまり燃料、整備、登録料、保険、減価償却に適用します。ログブックは5年間有効です。
...
車両を使うライダーやドライバーでは、判断はたいてい逆に振れます。1キロ91セントで数千キロ走れば、他を数える前に1,000ドルを超えるからです。実際に使った額を足して1,000ドルを超えるなら、定額のほうが損です。枠組みは[1,000ドル即時控除ルール](/ja/blog/1000-dollar-instant-deduction-rule-2026)にあります。
...
その貯金は到着する前に稼いだもので、オーストラリア源泉の所得ではないからです。税金はこちらで稼いだものに付きます。逆方向も同じ原則で、[オーストラリアからの海外送金](/ja/blog/transferring-money-overseas-australia-tax)で扱っています。
...
手口は一貫しています。お金を送るからと言って銀行情報とTFNを求める相手、先に現金を送ることを条件に異常に良い為替レートを提示する相手、前払いを要求する求人、海外口座への送金で終わるロマンス詐欺。規制された事業者と認可された両替所を使えば、そのどれも必要ありません。誰にあなたの情報を尋ねる資格があるかは[TFNを詐欺から守る](/ja/blog/tfn-security-protect-from-fraud)にあります。
...
単純でなくなるのは両方が混ざった年、とくに申告された賃金の横に報告されなかった現金の仕事がある年です。[タックスリターン](/ja/tax-return)を作成する段階できちんと片づける価値があります。
...
`,
  ...
  'ato-tax-debt-failure-to-pay-penalty-australia': {
    ...
    body: `
未払いのATO債務は、当初の納付期限から日々複利で走るGeneral Interest Chargeによって大きくなります。それとは別に、債務が残っている28日ごとにFailure to Payペナルティが適用されることがあります。オーストラリアを離れてもどちらも止まらず、債務はあなたのスーパーの支払いから差し引かれることがあります。

## ワーホリの税金債務はどこから生まれるのか？

給与から生まれることはほとんどありません。給与は税金がすでに源泉徴収された状態で届くからです。債務は、課税されずに届いた収入から生まれます。
...
最もよく見る形は、入金のすべてを使えるお金として扱ったデリバリーやライドシェアの1年です。入金のたびに一定割合を取り分けておく理由は[ワーホリでUberを運転する](/ja/blog/uber-driver-working-holiday-australia)で扱っています。

## General Interest Chargeとは何か？

General Interest Chargeは、未払いの税金債務に対する日々複利の利息で、キャッシュレートを大幅に上回る水準に四半期ごとに設定され、2025-26年度では年約11%で推移しています。当初の納付期限から債務が解消されるまで適用されます。

日々複利は、最初の数か月は思うより遅く、年単位では思うより速く効きます。1,000ドルの債務を1年放置すると約115ドル、3年放置すると約370ドルが積み上がり、あなたが別の国で暮らしている間も増え続けます。

## Failure to Payペナルティとは何か？

利息とは別の課金で、債務が未払いのまま28日経過するごとに1ペナルティユニット330ドルが適用され、上限は5ユニットです。利息と違い、自動ではなくATOの裁量で適用されます。

適用されるのは、金額が大きい債務、繰り返される不払い、そして何より沈黙です。ATOとやり取りしている人と、3通の通知を無視した人では立場がまったく違い、その差が裁量の主な判断材料になります。
...
遅れて提出し、遅れて払えば両方がかかり、合計が元の税額を上回ることもあります。提出のペナルティがどこで効くかは[期限後申告のペナルティ](/ja/blog/late-tax-return-penalty-working-holiday)で扱っており、還付になる年度については、恐れられているより少ない場面です。
...
この21日という窓は、還付を期待して4月に提出し、かわりに請求を受け取った人を捕まえます。別の国からお金を工面するには長くありません。提出する前に結果を知っておくべき理由です。

## 未払いのままオーストラリアを離れたらどうなるのか？

債務はパスポートについて回りはしませんが、消えもしません。利息は日々積み上がり、債務は将来のオーストラリアの還付と相殺されることがあり、今後のビザが審査されるときに記録として残ります。

いちばん痛い相殺はスーパーです。ATOは未払いの税金債務をDASPの支払いと相殺できますが、DASPはすでに65%が源泉徴収されています。スーパーの残高4,000ドルは源泉徴収後に約1,400ドルになり、そこに2,000ドルの債務があれば全額が消え、なお600ドルが残ります。請求の前に債務を解決しておくほうが良い順番です。

## 利息やペナルティは免除されるのか？

一定の状況では免除されます。ATOには、根拠がある場合に利息とFailure to Payペナルティのどちらも減額または取り消す裁量があります。
...
免除の求めは具体的に行い、証拠を添える必要があります。金額についての一般的な不満は求めにあたりません。

## 自分が実際にいくら負っているかはどうやって知るのか？

査定通知に表示された債務は、走り続ける合計ではなくその時点のスナップショットです。利息は当初の納付期限から日々積み上がるので、4か月前の手紙の数字はすでに正しくありません。

現在の位置づけは、すべての申告と報告が提出されているかにも左右されます。BASの四半期や過去の年度が未提出のままなら、提出していれば還付になったはずの年度が、請求されないまま何も相殺できずに残ります。

## 分割払いの取り決めは何を変えるのか？

分割払いの取り決めは徴収を止め、債務を払える分割に変えます。利息は止まらず、減っていく残高に対して積み上がり続けるので、値引きではなく資金繰りの取り決めです。

12か月未満の短い計画は、求めれば一般に利用できます。それより長いものは書類が増え、どちらも満たせない人には困窮を理由とした取り決めが別に用意されています。タイミングも効きます。期限より前に求める分割払いは通常の事務手続きで、18か月沈黙したあとの同じ求めは、はるかに弱い立場からの交渉になります。

## どんな順番で片づけるべきか？

まずすべてを提出し、次に本当の金額を確定させ、それから対処します。逆にすると、誤った査定に利息を払ったり、埋められたはずの未提出の年度を請求しないまま債務だけを清算したりします。スーパーの請求も控えているなら、その前に債務を解決するほうが良い結果になります。
...
同じ金額の債務でも、最終的にいくら払うかは、債務の出どころといつ動いたかで大きく変わります。利息は自動で走り、ペナルティは裁量で決まります。
...
結果として、典型的なワーキングホリデーメーカーは口座を2つか3つ持ち、数千ドルの残高に対してそれぞれが管理手数料を、しばしば保険料まで取ります。避けたいなら、どの仕事でも標準の選択フォームで同じファンドを指定し、欄を空欄で出さないことです。すでに分かれた残高がさかのぼって統合されることはなく、[複数ファンドの統合](/ja/blog/super-multiple-funds-consolidation)は出国前にやっておく別の作業です。

## スーパーがまったく入っていない場合はどうするのか？

まず給与担当に書面で連絡してください。意図的な不払いより事務的な誤りのほうが多く、それなら1週間で直ります。給与期間、通常労働収入、ファンドの情報を示し、いつ何を送金したのかを尋ねます。

それで解決しない場合、未払いのスーパーはsuperannuation guarantee chargeの手続きを通して回収できます。これは苦情ではなく正式な執行の仕組みで、仕事が終わったあとでも、国を離れたあとでも進められます。必要なのは証拠です。スーパーの行が入った給与明細、到着額を示すファンドの明細、雇用の期間と労働時間、賃率と総収入、雇用主の名称とABNです。詳しくは[雇用主がスーパーを払わないとき](/ja/blog/super-employer-not-paying-what-to-do)にあります。
...
出国から6か月以上経っているなら、少なくとも一部は移っていると考えて、古いファンドに手紙を書くのではなく検索してください。必要なものは[なくしたスーパーを探す](/ja/blog/how-to-find-lost-superannuation)で扱っています。
...
これはTFNでの検索に現れないので、雇用主の一覧が重要です。給与明細にスーパーが載る仕事が、どのファンドにもATOの残高にも反映されていないなら、そのお金は払われなかったか紐づかなかったかで、解決の仕方が違います。前者は[雇用主がスーパーを払わないとき](/ja/blog/super-employer-not-paying-what-to-do)で扱っています。
...
一方で統合には時間がかかり、ファンドごとに手続きも違うので、口座が2つでどちらも素直なら別々に請求するほうが早いことがよくあります。どちらでも受け取る額は変わりません。手続きは[複数のスーパーファンドの統合](/ja/blog/super-multiple-funds-consolidation)で扱っています。
...
65%は高い率で、最も受け入れにくい数字です。代わりの選択肢はより低い率ではなく、残高をまるごと置いていくことで、毎年相当な額が実際にそうなっています。請求そのものは[スーパーアニュエーションのページ](/ja/superannuation)で扱っています。
...
眠っている口座を掘り起こすと、出てくるのはスーパーだけとは限りません。同じ年度のタックスリターンが未提出のままの人も多く、[ワーホリのタックスリターン](/ja/tax-return)であわせて片づけるのが早道です。
`,
  },
  ...
  'how-to-choose-super-fund': {
    ...
    body: `
ワーキングホリデーメーカーにとって最良のファンドとは、DASPの請求を早く支払い、待っている間に小さな残高を削らないファンドです。帰国するときに全額を引き出すのだから、効いてくるのは手数料、既定でついてくる保険、本人確認のしやすさで、長期の運用成績ではありません。

## なぜ一般的な基準はここでは間違っているのか？

オーストラリア人は40年の時間軸でファンドを選びます。その長さなら、利回りのコンマ数パーセントが複利で効いてきます。あなたが選んでいるのは18か月分で、そのあと残高はDeparting Australia Superannuation Paymentを通じて丸ごと国外に出ていきます。

その時間軸で関係があるのは2つだけです。お金がそこに置かれている間にそのファンドが何を差し引くか、そしてオーストラリアにもういない人からの請求をどれだけ手際よく処理できるかです。

## そもそもスーパーとは何なのか、短く言うと？

スーパーとは、雇用主があなたの名前でファンドに払い込むお金で、給与から引くのではなく給与に上乗せして12%が払われます。ワーキングホリデーメーカーにとっては、出国時に解錠される強制貯蓄口座です。
...
この65%がここで最も重要な数字です。残高10,000ドルなら支払いは約3,500ドルで、ファンドの選択がこの率を変えることはありません。

## 18か月の間に本当に効いてくる手数料はどれか？

小さな残高に効くのは定額の管理手数料で、効かないのは残高比例の手数料です。残高に関係なく週に数ドル引かれるのは、3,000ドルに対しては意味のある割合で、300,000ドルに対しては無視できる額です。

もっと大きく、しかも避けやすい漏れは既定でついてくる保険です。多くのファンドが生命保険や所得補償の保障を自動的に付け、その保険料を残高から差し引きます。2年以内にすべてを引き出す人にとって、それは決して請求されない保障に使われるお金です。たいていはファンドの会員ポータルから解除できます。

## DASPをうまく処理するのはどんなファンドか？

大手のインダストリーファンドと主要なリテールファンドは、帰国時の請求を日常業務として処理し、海外からの本人確認の仕組みを備えています。請求が止まるのは、小規模な雇用主の既定ファンドです。ビザが切れた元会員からベルリン経由で届く請求は、そこでは手続きではなく例外だからです。

DASPの申請にはHome Affairsを通したビザの確認と、海外から審査される本人確認書類が必要で、書類が揃ってからの承認には28日程度かかるのが一般的です。
...
これは機能しますが、雇用主が4社の1年で生み出されるのは分散です。口座がいくつも、手数料もいくつも、DASPの請求もいくつも。統合するか別々に請求するかは[複数ファンドの統合](/ja/blog/super-multiple-funds-consolidation)で扱っています。
...
スーパー選択のフォームでファンドをひとつ指定し、そのあとはすべての雇用主に同じ情報を渡すことです。この習慣ひとつで、このガイドが説明している問題の多くを防げます。
...
人が失くすのは会員番号です。ファンドはTFNからたどれますが、海外からの請求は口座を示せるほうが速く進みます。入会時の書類を1枚撮っておいてください。

## 最初の週の4つの判断が何を決めたのか？

結果を決めるのは4つの判断で、いずれも最初の仕事の最初の週に行われ、そのあと見直されません。ファンドをひとつ指定して以降の雇用主にも同じ情報を渡したか。既定の保険を解除したか。そのファンドの管理手数料が定額か残高比例か。そしてそのファンドが海外からの請求を日常業務として処理するところか。

間違えたときの積み重なりは劇的ではなく、静かです。3つのファンドに3つの小さな残高があり、それぞれが誰も望まなかった保障の保険料を払い、それぞれに別の請求が必要で、そのうちひとつは3週間だけ働いた、名前も思い出せない町の仕事なので完全に忘れられている。それが普通の結末なので、[なくしたスーパーを探す](/ja/blog/how-to-find-lost-superannuation)というガイドが存在します。
`,
  },
  ...
  'super-for-casual-and-part-time-workers': {
    ...
    body: `
もらえます。スーパーアニュエーションは、カジュアルでもパートタイムでもフルタイムでも同じように、通常労働収入の最初の1ドルから発生します。率は12%で、雇用主が給与から引くのではなく給与に上乗せして払います。カジュアルであることも、一時滞在であることも、ワーキングホリデービザであることも変えません。

## なぜスーパーが始まる下限があると今も思われているのか？

2022年7月1日まで実際に下限があったからです。ある雇用主のもとでその月に450ドル未満しか稼がなかった場合、雇用主には何の義務もありませんでした。複数の店にシフトが散らばるカジュアルのバックパッカーは、適法にその基準へお金を落としていました。

それはなくなりました。以降は、月の合計がいくらであろうと通常労働収入の1ドルごとに保証が発生します。パブでの2シフト、収穫の1週間、カフェでの1回の試用シフトが、いずれもスーパーの義務を生みます。唯一の例外は18歳未満の労働者で、週30時間を超えて働くことが保証の条件になります。
...
混乱はたいてい、ローディングがカジュアルに与えられないものへの補償だと説明されることから来ます。与えられないのは有給休暇と解雇予告で、スーパーはその一覧に入っていません。

## スーパーは何に対して計算されるのか？

通常労働収入に対してで、これは給与明細に載っているものすべてとは違います。カジュアル・ローディングを含む通常の労働時間分をカバーし、通常時間に紐づく割増賃金や手当も一般に含みますが、割増率で支払われる残業代は除かれます。

日曜の割増時間がロスターされた通常の時間であるホスピタリティのカジュアルは、名目上の基本時給ではなく割増を含んだ額に対してスーパーが発生しているはずです。基本給だけで計算している雇用主は少なく払っています。

## 実際に払われているかをどう見分けるのか？

給与明細ではなくファンドを確認することです。給与明細のスーパーの行は、雇用主が払うつもりだという表明であって、届いたという証拠ではありません。

スーパーは四半期ごと、10月28日、1月28日、4月28日、7月28日までに払えばよいことになっているので、給与明細と入金の間に数週間の差があるのは問題ではなく普通です。四半期の期限を越えても残っている差は普通ではありません。決着させるには、1四半期分まるごとファンドの拠出履歴と給与明細を突き合わせます。

## 帰国するときにはどうなるのか？

あなたのものであり続け、ビザが終了して国を離れたあとにDeparting Australia Superannuation Paymentとして請求できます。ワーキングホリデーメーカーのDASPは課税対象部分に65%が課されます。高い率ですが、代わりの選択肢は1ドルも受け取らないことです。
...
失われる口座です。ファンドを指定しなかった人は、雇用主ごとに誰かに選ばれた口座を持つことになり、仕事が4つなら口座は4つになりえます。そのそれぞれが、小さな残高に対して静かに手数料を取ります。

さらに、TFNがファンドに届く前になされた拠出はあなたに紐づけられないことが多く、どのファンドでもなくATOに保有されます。そのお金は取り戻せますが目には見えず、帰国するバックパッカーのスーパーが給与明細の示す額より少なくなる最も多い理由がこれです。たどり方は[なくしたスーパーを探す](/ja/blog/how-to-find-lost-superannuation)で扱っています。

## 発生した額と届いた額がずれるのはなぜか？

変数は権利があるかどうかではなく、最終的にいくら手元に残るかです。次の事実が、いくら発生したか、そのうちどれだけがあなたの名前のファンドに届いたかを変えます。
...
未払いの[スーパー](/ja/superannuation)が長く気づかれない理由もこれです。賃金を少なく払う雇用主は入金額が目に見えて違うので2週間で発覚しますが、スーパーを一度も払わない雇用主は誰にも気づかれずにシーズンを丸ごと過ごせます。それが分かるのはたいてい帰国のタイミング、最も追いかけにくいときです。

## 拠出はいつ現れるのが正しいのか？

給料日のあとではなく、四半期の期限のあとです。雇用主は四半期ごとに払えばよいので、働いてからファンドで見えるまで最大3か月あるのは正常です。スーパーが消えたと誤解される最も多い理由です。

4つの期限は、7月から9月の四半期が10月28日、10月から12月が1月28日、1月から3月が4月28日、4月から6月が7月28日です。お金はその前後数日でファンドへ着地するのが普通です。期限から1、2週間経ってもその四半期が空のままなら、そこではじめて差は本物になり、給与明細の行とファンドの明細を突き合わせる価値が出ます。

## どのファンドにいるか分からない場合はどうするのか？

ほぼ確実にどこかにあり、名前が書かれている場所は3つです。給与明細にはファンド名と、多くの場合は会員番号が載っていて、これが最短の経路です。メールにはそのファンドからの案内が届いているはずです。そしてATOは、あなたのTFNに対して拠出を受けたことのあるすべてのファンドの記録を持っています。

仕事をいくつもした人に重要なのは最後のひとつで、忘れている口座まで見せてくれる唯一の情報源です。行き着くのはホスピタリティ、小売、建設に紐づいた大手のインダストリーファンドが多く、仕事を移り続けた1年は、意図的な判断をひとつもしないまま3つか4つの口座を生みます。
...
統合が正しい手かはタイミング次第です。まだ滞在して働くなら、[口座をまとめる](/ja/blog/super-multiple-funds-consolidation)ことで重複した手数料が止まります。数週間で出国するなら、どのみちすべてDASPで請求するので、先に統合すると請求を遅らせることがあります。常に間違っているのは、忘れたままの口座を放置することです。スーパーが未請求としてATOへ移り、静かに置き去りにされる道筋です。
...
タイミングが分岐点です。5月に仕事を終えて6月に帰るなら、4月から6月分の拠出の期限は7月28日まで来ないので、すぐ請求することは、雇用主が払う義務を負う前に請求することになります。期限のあとまで待つほうがたいてい多く回収できますが、支払いにかかる[65%の源泉徴収](/ja/blog/tax-on-super-withdrawal-backpacker)と、提出後の承認に28日程度かかることと合わせて考える必要があります。

## 画面の数字は本当に合計なのか？

ひとつのファンドの残高を見るのは簡単ですが、それがスーパーの全部かは別の問題です。画面の数字が本当の合計か、一部にすぎないかは次の点で決まります。
...
すべての残高を把握してから[DASPの請求](/ja/superannuation)に進みます。オーストラリアにいるうちに確認しておくと、帰国後に書類を集める作業が楽になります。その年度の税金はスーパーとは別枠で、[ワーホリのタックスリターン](/ja/tax-return)で精算し、おおよその金額は[還付金の試算](/ja/calculator)で確認できます。
`,
  },
...
当社の[スーパー受取サービス](/ja/superannuation)が引き受けるのは、その部分です。覚えているファンドではなくすべてのファンドを見つけること、ファンドごとの書類基準を満たすこと、認証を手配すること、沈黙したファンドを追いかけること、最終年度の[ワーホリのタックスリターン](/ja/tax-return)と並行して進めることです。
...
最後のひとつが最も多く起こります。雇用主が3社いた旅行者はたいていファンドを3つ持ち、それぞれを特定して別々に請求する必要があります。中央の記録がどう機能するかは[なくしたスーパーを探す](/ja/blog/how-to-find-lost-superannuation)にあります。
...
SNSやメッセージアプリで「もっと良いレートでスーパーの請求を代行する」と持ちかけてくるものは、法律の誤解か、率直な詐欺のどちらかです。請求にはパスポート、TFN、銀行口座の情報が一か所に揃う必要があり、それが標的として魅力的な理由です。何かを渡す前に[TFN詐欺の手口](/ja/blog/tfn-security-protect-from-fraud)を読む価値があります。
...
数週間で出国するなら、たいてい間違った手です。移管には時間がかかり、移送中の口座にDASPを請求すると、閉じたと思っていたファンドに端数が残ります。その場合は、ファンドごとに別々に請求するほうが、書類の上では遅く見えて実際には速く進みます。自分で選びたい場合、ワーキングホリデーにとって何が重要かは[スーパーファンドの選び方](/ja/blog/how-to-choose-super-fund)にまとめてあります。
...
海外からの現実的な経路は、統合せずファンドごとに別々の[DASPの請求](/ja/superannuation)を出すことです。書類は増え、支払いも数回になりますが、それぞれの請求は独立していて移管の完了を待ちません。出国後も数か月はオーストラリアの電話番号を生かしておくのが、選択肢を残すために最も安い方法です。
...
長く請求されないままの残高は、ファンドが保有するのをやめ、未請求スーパーとしてATOへ移されます。損失ではありませんが、探しに行く場所は変わります。その移管が何を意味し、そこからどう取り戻すかは[なくしたスーパーを探す](/ja/blog/how-to-find-lost-superannuation)で扱っています。
...
持っているファンドを見つけます。あなたのTFNに紐づいて拠出を受け取ったことのあるファンドはすべて中央で記録されているので、お金は行方不明ではなく、どのファンドかは捜索ではなく照会の問題です。記録の仕組みは[紛失したスーパーの見つけ方](/ja/blog/how-to-find-lost-superannuation)にあります。
...
`,
  ...
  'super-employer-not-paying-what-to-do': {
    ...
    body: `
未払いの[スーパー](/ja/superannuation)は取り戻せます。そして取り戻すのはあなたではなくATOです。雇用主は通常労働収入の12%を、少なくとも四半期ごとにあなたのファンドへ払わなければならず、抜けた四半期は、個人の労働者には持ちえない権限でATOが追及できる債務を生みます。問題は、出国前に見つけられるかどうかです。

## スーパーが本当に払われたかをどう見分けるのか？

給与明細ではなくファンドを見ることです。給与明細のスーパーの行は、その額が発生したという意味であって、送金されたという意味ではありません。この隙間が、未払いスーパーの最も一般的な形です。

支払いの唯一の証拠は、ファンドの明細かATOの拠出記録です。四半期が終わり、その期限からさらに1、2週間が過ぎているのに、ファンドにその期間の記録が何もないなら、それは遅れているのではなく未払いです。それより前なら空の四半期は正常です。スーパーは給与ごとではなく四半期の周期で払われるからです。

## 雇用主は実際に何を義務づけられているのか？

Superannuation Guarantee (Administration) Actのもとで、通常労働収入の12%を、年4回の決まった期日までにあなたの指定したファンドへ払うことです。カジュアルを含むすべての従業員が対象で、適用されなくなる収入の下限はなく、417や462のビザであることも義務を変えません。

期限を逃すことは、単なる支払いの遅れではなく[Superannuation Guarantee Charge](/ja/blog/what-is-superannuation-guarantee-charge)の負担を生みます。不足額に利息と管理部分を加えたもので、雇用主の税務上の控除の対象になりません。飲み込むのではなく通報する価値があります。
...
その雇用主がまだ事業を続けているかと、抜けが意図的に見えるかどうかです。手が回らずに四半期を落とした小さな事業者は、書面で尋ねればたいてい直します。査定を待つ必要がないので、圧倒的に早い経路です。

書面での依頼に返事がない場合、実効性があるのはATOの経路です。比較に必要な材料はATOがすでに持っています。雇用主がSingle Touch Payrollで報告した賃金と、ファンドが受け取ったと報告した拠出です。賃金の未払いや給与明細の不交付といった他の違反も重なるなら、その側はFair Work Ombudsmanが扱い、2つの申し立てを並行して進められます。

## 雇用主が廃業した場合はどうなるのか？

請求は残ります。事業が清算に入った場合、ATOがスーパーの負担について債権者になり、拠出は会社と一緒に帳消しになるのではなく、その手続きを通して回収されえます。

変わるのは所要期間で、週ではなく月の単位、ときにはさらに長くなります。雇用主が破綻したときに未払いの賃金や権利の一部を補償する連邦のセーフティネット、Fair Entitlements Guaranteeは、スーパーアニュエーションを対象にしていません。選べるなら雇用主がまだ営業しているうちに未払いスーパーを持ち出すべきです。

## 帰国する人にとってなぜこれがより重要なのか？

DASPが支払うのは、実際にファンドに入っている分だけだからです。雇用主が一度も送金しなかったスーパーは支払いに含まれず、自動的に家までついてくることもありません。

これは本当のタイミングの判断を生みます。ATOが拠出を回収するまで[DASPの請求](/ja/superannuation)を遅らせれば全部が1回の支払いになりますが、海外から長く待つことになりかねません。いまファンドにある分だけを請求すればお金は動き出しますが、残りは別途追いかけることになり、2回目の支払いと追加の事務が発生します。どちらが良いかは、抜けている額の大きさと、オーストラリアの銀行口座をどれだけ長く開けておけるかで決まります。
...
確認は単純です。オーストラリアで有償の税務サービスを提供する者は、政府の公的な税務専門家登録簿に載っている必要があり、まっとうな相手なら、何かを送る前に調べられることを嫌がりません。まっとうな手続きが、スーパーファンドのパスワードを求めることはありません。
...
アワードもエンタープライズ・アグリーメントもその仕事をカバーしていない場合にだけ適用されるもので、バックパッカーが働く業界ではほぼ必ずどちらかがカバーしています。ホスピタリティ、小売、園芸、建設、清掃、高齢者介護にはいずれもモダン・アワードがあり、割増賃金が乗る前の段階で全国最低賃金を上回る独自の最低賃金を持ちます。

カフェでちょうど26.44ドルが支払われていることは、法令遵守の証拠ではなく、むしろ賃金の未払いの証拠に近いです。Hospitality Industry (General) Awardは職分ごとに独自のレートを定めており、それは全国の床ではありません。

## 数字はどう決まり、いつ変わるのか？

Fair Work Commissionが年に一度見直し、年央に結果を発表します。引き上げは7月1日以降に始まる最初の完全な給与期間から効力を持ちます。2026年の見直しでは全国最低賃金が6%、アワードの最低賃金が4.75%引き上げられました。

この違いは、すでに終わった年度について申告する場合に効きます。2025-26年度の全国最低賃金は時給24.95ドル、カジュアルは31.19ドルでした。その年度の給与明細は、現在の数字ではなくそちらと照らし合わせます。

## カジュアル・ローディングは何と引き換えなのか？

基本レートに上乗せされる25%で、有給の年次休暇も有給の病気休暇も解雇予告もないことと引き換えです。カジュアルなのに常勤の基本レートでローディングが乗っていないなら、見た目の数字が最低賃金どおりでも賃金の未払いです。

これは給与明細で他の何より先に確認してください。バックパッカーの賃金で最も多い誤りで、1行で見えます。2026-27年度のカジュアルは全国最低賃金でも時給33.05ドルから始まり、ほとんどのアワードではさらに上です。

## 実際に支払われるべきレートはどこから来るのか？

あなたのアワードと、その中でのあなたの職分（classification）からです。どちらも名指しできなければ、どんな数字も意味を持ちません。どのモダン・アワードにも経験と責任に応じた職分レベルがあり、同じ厨房の二人が合法的に違うレートで働いていることがあります。
...
どのアワードが自分をカバーし、自分がどのレベルにいるのかを聞いてください。それに答えられない雇用主は、たいていアワードを適用していません。

## 週末、深夜、祝日はどうなるのか？

アワードの対象となる仕事の多くでは、所定時間の外で働いた時間に割増賃金（penalty rates）が付き、カジュアルではローディングの上に積み上がります。土曜、日曜、祝日、深夜のレートはアワードごとに異なり、ホスピタリティと小売では稼ぎのかなりの部分がそこから来ます。

カジュアルのホスピタリティ労働者が日曜に働けば、見出しの全国最低賃金の2倍近くを合法的に稼いでいることがあります。組み合わせ方は[オーストラリアの割増賃金](/ja/blog/penalty-rates-australia)にまとめてあります。

## 数字が合わないときはどうするのか？

何かを申し立てる前に正しいレートを計算してください。アワードが適用されるのに全国最低賃金をもとに組み立てた請求は、受け取るべき額を過小に見積もります。アワードを特定し、自分の職分を見つけ、ローディングと割増を適用し、給与明細と週ごとに比べます。

証拠は後から再構成せず、そのつど残してください。ロスター、給与明細、職分について書面で確認できるもの。当事者間で解決しない場合はFair Work Ombudsmanが扱います。未払い賃金の回収にビザによる障害はなく、ワーキングホリデーメーカーは職場で他の誰とも同じ権利を持ちます。

## 受け取るべき額を決めるのはどの文書か？

全国の数字は固定されていますが、あなたが受け取るべき額は自分の仕事の事実で決まります。全国最低賃金が適用されることはめったにありません。
...
難しいのは、申告の元になる所得明細が存在しないことで、数字は自分の記録から再構成します。現金を口座に入れていれば入金の記録、シフトの日記、ロスター、仕事を取り決めたメッセージ、合意したレートがわかるもの。再構成の組み立て方は[現金収入のタックスリターン](/ja/blog/cash-in-hand-tax-return)にあります。
...
だからバックパッカーの搾取の多くが、賃金の未払いではなくABNを通して行われます。ただしラベルは決定的ではありません。監督され、ロスターを組まれ、時給で払われ、雇用主の機材を使っている実質があるなら、書類に何と書いてあろうと雇用であり、権利もついてきます。どう判定されるかは[従業員と請負業者の判定](/ja/blog/employee-vs-contractor-australia)にあります。
...
各行が何を示すべきかは[オーストラリアの給与明細の読み方](/ja/blog/how-to-read-a-payslip-australia-working-holiday)にあります。日曜を含む週に一律の賃率がひとつだけ載っている給与明細は、割増が適用されていないことを伝えています。
...
賃金未払いの請求の背後にはたいていスーパーの請求があり、順番にではなく一緒に進める価値があります。その側の仕組みは[未払いのスーパー](/ja/blog/super-employer-not-paying-what-to-do)で扱っています。
...
回収した賃金は受け取った年に課税されます。実際に支払われた額から[還付金の試算](/ja/calculator)ができます。
`,
  },
  ...
  'leave-entitlements-working-holiday-visa': {
    ...
    body: `
カジュアルには有給の病気休暇も年次休暇もありません。かわりに時給に25%のローディングが付きます。常勤のフルタイムとパートタイムの従業員は、年に4週間の年次休暇と10日の個人休暇を積み上げます。どちらの区分にいるかが、そのあとのすべてを決めます。
...
使わずに積み上がった年次休暇は、仕事が終わるときの最終給与で精算されます。ワーキングホリデーメーカーが最もよく置いていくのがこの部分です。働いた時間分だけだと思って辞め、最後の給与明細と突き合わせないからです。
...
カジュアルとして病欠すると、そのシフトは無給で、あとで精算されるものが背後で積み上がってもいません。その補償は1時間ずつすでに支払われています。だからこそ、ローディングのない素の基本賃率が載っているカジュアルの給与明細は、端数の問題ではなく未払いです。
...
この区別は両方向にお金になります。カジュアルと呼ばれながら固定の常勤のパターンで働いていた人は、積み上がった休暇を受け取る権利があるかもしれません。この区分が実際にどう判定されるかは[フルタイム、パートタイム、カジュアル](/ja/blog/full-time-part-time-casual-australia)にあります。

## 辞めるときに休暇はどうなるのか？

使っていない年次休暇は通常の賃率で全額精算され、アワードが定める休暇ローディングがあればそれも加わります。個人休暇と病気休暇は一切精算されず、カジュアルが積み上がったと感じているものも精算されません。

常勤の役職に6か月いた人にとって、この精算は意味のある金額になりえます。誰も確認しないので、退職時の未払いとして最も多いもののひとつです。最後の給与明細は合計を信じず、勤務開始日と照らして1行ずつ読んでください。

## 休暇の精算はどう課税されるのか？

受け取った年の通常の所得として、ワーキングホリデーメーカーの税率で課税されます。最終給与に着地する一時金は、源泉徴収が重くかかったように見えることがあります。給与システムが、その給与期間が1年続く前提で税率を計算するからです。

その取りすぎは一時的で、査定のときに精算されます。仕事が終わってもオーストラリアの銀行口座を閉じないほうがよい、もうひとつの理由です。最後の給与明細に他に何が載るかは[出国後の税務](/ja/blog/tax-obligations-after-leaving-australia)で扱っています。

## 長期勤続休暇が関係することはあるのか？

ワーキングホリデーではほとんどありません。州によりますが一般に同じ雇用主のもとで7年から10年が必要で、417や462のビザで可能な期間を超えています。

別のビザで繰り返しオーストラリアに戻り、同じ雇用主に留まる人は少数ながらいます。その場合、それ以前の継続勤務が数えられることがあり、この権利は退職時に精算され、所得として課税されます。

## 何かが積み上がっていたかはどう確かめるのか？

権利は雇用の区分とアワードで決まります。次の点が、何かが積み上がったのか、辞めるときに精算されたのかを決めます。
...
重要な例外があります。監督され、ロスターを組まれ、時給で払われ、1社のクライアントのためにその機材で働くという雇用の実質があるなら、誰が請求書を出したかにかかわらず分類が誤りで、スーパーアニュエーションもアワードの賃率も支払われるべきです。判定の仕方は[従業員と請負業者の判定](/ja/blog/employee-vs-contractor-australia)にあります。
...
いくつかの業種と地域では、同じ雇用主のもとで長く働くことが認められています。制限が効く場所と効かない場所は[6か月の雇用主ルール](/ja/blog/six-month-employer-rule-working-holiday-visa)にあります。
...
これは在職中ではなく出国のときに効いてきます。ファンドごとに別々の残高があり、それぞれに別々のDASPの請求が必要なので、1つを覚えていて2つを忘れた人はオーストラリアにお金を置いたままにします。出国前にたどる方法は[なくしたスーパーを探す](/ja/blog/how-to-find-lost-superannuation)にあります。
...
もうひとつの本物の面倒は、6月30日をまたいだ仕事です。賃金は稼いだ年ではなく支払われた年に課税されるので、5月から8月まで続く仕事は2通の申告に分かれ、源泉徴収はその2つに均等には割れません。どちらも[タックスリターン](/ja/tax-return)を作成する段階で申し出てください。
...
`,
  ...
  'full-time-part-time-casual-australia': {
    ...
    body: `
カジュアルは基本賃率に25%のローディングが付き、有給休暇は積み上がりません。フルタイムとパートタイムは基本賃率で払われ、かわりに年次休暇と病気休暇が積み上がります。3つとも税金の扱いはワーキングホリデーメーカー税率で同じなので、選択は税金ではなく収入の形と安定性の問題です。

## オーストラリアでフルタイムとは何を意味するのか？

フルタイムは通常週38時間の規則的な労働時間で、保証されたスケジュールとNational Employment Standardsの権利一式が付きます。カジュアル・ローディングはなく、かわりの補償が休暇です。
...
ワーキングホリデーメーカーでフルタイムに就く人は多くありません。雇用主が拒むからではなく、6か月の雇用主制限が常勤の仕事とかみ合わないからです。

## パートタイムとは何を意味するのか？

パートタイムはフルタイムと同じ取り決めを少ない時間で行うもので、合意された規則的なスケジュールがあり、すべての権利が勤務時間に比例して積み上がります。3つの中で最も理解されておらず、ワーキングホリデービザで得られる条件としては最良のことも多くあります。

見通しの立つことと積み上がることの組み合わせです。週25時間のパートタイムはその時間分の年次休暇を積み上げ、使わなかった分は仕事が終わるときに精算されます。ひとつの街で6か月働くなら、その精算はカジュアル・ローディングより大きくなりえます。

## カジュアルとは何を意味するのか？

カジュアルは保証された時間も休暇の積み上がりもなく、その補償として基本時給に25%のローディングが乗ります。ワーキングホリデーメーカーには圧倒的に一般的で、とくにホスピタリティ、小売、収穫の仕事で多くなります。
...
2026年7月1日からの全国のカジュアル最低賃金は時給33.05ドルで、全国最低賃金26.44ドルにローディングを乗せた額です。カジュアルの賃率が基本賃率と同じかそれに近いなら、ローディングが抜けています。交渉の話ではなく未払いです。

## 自分がどれなのかをどう見分けるのか？

契約書に書いてあるはずですが、食い違う場合は実態が決めます。毎週同じシフトの固定のロスターは、書類が何と呼ぼうとパートタイムのパターンで、それをカジュアルと呼ぶのは分かりやすい誤分類です。
...
規則的なパターンが6か月続くと、カジュアルからの転換の権利が生じることがあり、これが争わずに誤分類を直す仕組みです。シフトを取り消されたときの保護は[シフト取り消しのルール](/ja/blog/casual-shift-cancellation-rules-australia)にあります。

## この区分は税金を変えるのか？

変えません。3つともワーキングホリデーメーカー税率、最初の45,000ドルまで15%で課税され、25%のカジュアル・ローディングも通常の課税対象の賃金です。12%のスーパーアニュエーションも3つとも最初の1ドルから発生します。

変わるのは1年を通した収入の形で、間接的な税務上の効果があります。2週間ごとの収入が上下するカジュアルは、各給与計算がその期間を典型として課税するため忙しい期に取りすぎになりえ、修正は給与ではなく[タックスリターン](/ja/tax-return)で戻ります。

## 実際にはどれを選ぶべきか？

ワーキングホリデーの1年の多くにはカジュアルが向きます。ローディングと、予告なしに次の場所へ移れる自由があるからです。数か月ごとに移動するなら積み上がった休暇は使われずに終わることが多く、25%はいま手に入るお金です。

パートタイムが勝つのは、ひとつの街で5、6か月を見通しの立つロスターで過ごす場合です。積み上がった年次休暇が最後に精算され、病欠が本物になり、ロスターがあるからホステルではなく賃貸を契約できます。

## 実際にお金が変わるのはどこか？

3つの分岐で、どれもラベルの話ではありません。25%のローディングが本当にカジュアルの賃率に入っているか。すべてを含むという一律の賃率は、たいてい何も含んでいません。アワードでの分類の等級が実際の仕事と合っているか。レベル2の仕事にレベル1の賃率が付くほうが、カジュアルかどうかよりずっと高くつきます。パートタイムを終えたときに積み上がった休暇が精算されたか。最終給与でよく落ちます。

最後のひとつは特に確認してください。パートタイムを終える最終給与には使っていない年次休暇の残高が含まれるはずで、辞意を伝えて1週間後に州を出るときに最も多く抜け落ちます。
`,
  },
  ...
  'employer-asking-you-to-work-more-than-visa-allows': {
    ...
    body: `
条件8547は、ワーキングホリデービザで同じ雇用主のもとで働ける期間を6か月に制限していますが、免除される業種の一覧は長いものです。店長が6か月を超えてあなたを使い続けられるかどうかは、その仕事が何かで決まります。この質問をしている人の多くは、すでに免除の側にいます。
...
制限しているのはひとつの関係であって、あなたの労働の総量ではありません。ビザの期間中にいくつの雇用主のもとで働いても構わず、6か月がリセットされるのは新しいワーキングホリデービザが発給されたときだけです。フルタイムの従業員が週38時間プラス合理的な追加時間を常態的に超えるべきでないというFair Workのルールは別の話で、月ではなく週の時間についてのものです。

## どんな仕事が制限から免除されるのか？

幅広い一覧で、ワーキングホリデーメーカーが実際にしている仕事の多くが入ります。あなたの仕事がその中に入るなら免除は自動的に適用され、申請するものは何もありません。
...
一覧はHome Affairsが定めており、これまでに何度か調整されています。2年前に聞いた内容ではなく、公表されている現在の条件で確認してください。

## 自分の仕事が免除されない場合はどうするのか？

3つの選択肢があり、そのうち居心地がよいのはひとつだけです。6か月の時点で雇用主を変えることができ、これが最もきれいで、誰にも何も求めません。6か月が経過する前にHome Affairsへ書面で継続の許可を求めることもでき、これは権利としてではなく裁量で認められます。あるいは、本当に別の雇用主へ移ることです。

許可はさかのぼりません。承認が来るだろうという前提で続けるのではなく、6か月の時点で止めて待つ必要があります。免除も承認もないまま制限を超えて働くことが違反であり、書類が最終的に何を言おうと変わりません。

## 間違えるとどんな結果になるのか？

形式上のリスクはビザの取り消しで、それは実在します。ただし意図しない超過で通常そうなるわけではありません。より多いのは、静かで長く残るほうの結果です。違反はあなたの入国管理の記録に残り、セカンドやサードのビザも含め、オーストラリアに関する何かを申請するたびに考慮されます。

雇用主の側も無関係ではありません。免除されない労働者を6か月を超えて使い続けた事業者は、自身の民事上の罰則に直面します。続けるよう迫る雇用主は、自分も負っているリスクをあなたに背負わせています。それは口に出してよいことです。

## 雇用主に強制されることはあるのか？

ありません。そして圧力はたいてい親切の形をとってやってきます。ビザの条件は、給料を払っている相手と交渉できる契約条件ではなく法律上の制限であり、それを免除する権限も、問題にならないと約束する立場も、どの雇用主も持っていません。

険悪になった場合にあなたを守るものが2つあります。ビザの条件を破ることを拒むのは非違行為ではなく、それに対する不利益な扱いは、まさにGeneral Protectionsの申し立てが存在する理由です。もう1つは、あなたのビザに影響を与えられるとほのめかす雇用主は間違っているということです。ビザに関することを決めるのはHome Affairsだけで、誠実に行われた職場の申し立てがビザの審査を引き起こすことはありません。可能なら要求を書面でもらってください。残ってほしいというメッセージは、倉庫での会話とは違い、証拠になります。

## 合法的に滞在を延ばすにはどうするのか？

長い仕事ではなく、次のビザを通してです。セカンドビザには1年目の間に指定地域で88日の指定就労が必要で、サードビザには2年目の間に6か月の指定就労が必要です。

その仕事は定義を満たし、正しい郵便番号で行われる必要があります。これは6か月の雇用主制限とは別のテストで、互いに干渉しません。ひとりの雇用主との関係を延ばしても滞在は1日も延びず、農場で88日を終えても、あとから就く免除されない仕事について条件8547が外れることはありません。

## これは税金を変えるのか？

変えません。免除のもとで1年ずっと同じ雇用主にいた場合の税務上の結果は、4か月の仕事を3つした場合とまったく同じです。最初の45,000ドルまで15%、賃金に上乗せして12%の[スーパー](/ja/superannuation)、そしてそのすべてが1通の[タックスリターン](/ja/tax-return)にまとまります。

むしろ長い仕事がひとつのほうが、税務の年としては単純です。照合すべき雇用主がひとつで、宣言書も3枚ではなく1枚だからです。お金がかかるのは逆のほうで、短い仕事がいくつもあれば、誤った源泉徴収率が誰にも気づかれないまま適用される機会もその数だけ生まれます。
`,
  },
...
1日に支払われた額を、ビンを待った時間や畝の間を移動した時間も含めて実際に働いた時間で割る。結果がカジュアルの最低賃金を下回っていれば、積み増しが発生していました。合意書の書き方は[ファーム仕事のピースレート](/ja/blog/piece-rates-farm-work-working-holiday)にあります。
...
農場の雇用主はこれを飛ばす頻度がどの業種より高くなっています。Superannuation Guarantee Chargeの手続きで取り戻せますし、ビザが終了して出国したあとはDeparting Australia Superannuation Paymentとして請求できます。ABNで使われていた場合はどれも適用されません。詳しくは[ファーム仕事とABN](/ja/blog/farm-work-and-abns)にあります。
...
一般建設業入場訓練、ユニット番号CPCWHS1001を修了したことを証明します。現場の危険、緊急時の手順、労働者としての権利と義務をカバーする内容です。安全に関する資格であって、職種の資格になるわけでも、それだけで採用されるわけでもありません。

雇用主の好みではなく労働安全衛生法上の要件なので、現場監督が経験を理由に通すことはありません。まっとうな建設業者はカードなしにゲートを通しません。

## 誰に必要で、誰に必要ないのか？

建設作業をする人すべてです。労働者、大工、足場工、塗装工、建設現場の造園作業員、職人の補助、仕事で現場に定期的に入る人。求人が現場を伴うなら、カードも伴うと考えてください。

ホスピタリティ、ファーム、小売、清掃、オフィスの仕事には必要ありません。パースやダーウィン、クイーンズランドの沿岸でよくあるように数週間の労務の話が来たら、最初のシフトの後ではなく前にカードが必要です。

## 講習の中身は何で、オンラインで受けられるのか？

数時間、一度で終わり、最後に評価があります。ほとんどの州が監督付きWebカメラ評価を伴う認定オンライン講座を受け入れており、バックパッカーの多くはこの方法で取得します。カードは数日以内に届きます。

例外はクイーンズランドで、実施形式の検証について厳しめの運用をしてきました。西オーストラリアも独自の取り決めを持ってきた経緯があるので、西へ向かうなら、シドニーで発行されたカードがカラサで通ると決めつける前に雇用主か訓練機関に確認してください。

## 有効期限はあるのか？

ありません。ほとんどの州で生涯有効として発行され、更新は不要です。業界を長く離れていると雇用主や州の規制当局がリフレッシュ講習を求めることはありますが、カード自体に有効期限は記載されていません。

届いた日に写真を撮っておいてください。現物をなくすのはよくあることで、別の州から再発行を頼むのは面倒です。待つ間、スマートフォンの写真でほとんどの現場に入れます。

## 税金の控除として申請できるのか？

答えは自分の時系列に関する一つの事実で決まります。最初のWhite Cardは原則として控除できません。その仕事をする費用ではなく、その仕事をする資格を得る費用だからで、ATOは自動車の初回免許と同じ扱いをします。

すでに建設業で働いている状態での更新や再発行は、業務関連経費として控除できます。同じ「最初かその後か」の考え方が、フォークリフトの資格や大型車の免許にも当てはまります。

いずれにせよ領収書は残してください。カード自体が申請できなくても、同時に買った安全靴、ヘルメット、工具ベルト、手工具はたいてい申請でき、その多くは[300ドル未満の即時控除](/ja/blog/tools-equipment-under-300-instant-deduction-whv)に収まります。

## 講習費が控除できるのはどんな場合か？

カードの要件はどこでも同じなので、変数はどこで講習を受けたか、どこで働くつもりか、費用が控除できるかです。決めるのは次の事実です。
...
`,
  ...
  'rsa-certificate-australia-working-holiday': {
    ...
    body: `
オーストラリアでお酒を提供するには、その前にRSAが法的に必要です。講習は3時間から5時間、費用はおよそ90ドルで、たいていオンラインで受けられます。州単位で発行されるので、ある州の証明書が隣の州で通るとは限りません。費用は控除できます。

## RSAの講習では実際に何を学ぶのか？

Responsible Service of Alcohol（責任あるアルコール提供）の訓練は、店の免許保持者だけでなく、実際にお酒を注ぐ人にかかる法的な義務を扱います。
...
アルコールの提供、販売、供給に関わる役割にある人すべてで、バーのスタッフより広い範囲です。免許のあるレストランでの接客、ボトルショップ、イベント、ワイナリーのセラードアの仕事も含まれます。

厨房や清掃といったバックヤードの役割に法的な要件はありませんが、ホスピタリティの雇用主のかなりの割合が持っていることを求めます。店内のどこにでもシフトを入れられるからです。早めに取っておく本当の理由はたいていそこです。

## 証明書はどの州でも通用するのか？

しません。これがお金のかかる細部です。RSAは州単位で発行され規制されるので、ビクトリア州の証明書があってもシドニーで自動的にお酒を注げるわけではありません。相互承認がある州とない州があります。
...
有効期間は州によって決まり、幅があります。三つの州では有効期限がなく、残りは3年から5年です。
...
微妙なのはタイミングです。まだ就いていない職業に入るために受けた講習は、その職業で働きながら受けた講習より正当化が難しくなります。控除の面では、最初のホスピタリティの仕事を得る前より後にRSAを取るほうがきれいです。一般的な判定基準は[ワーホリの税金控除](/ja/blog/tax-deductions-working-holiday-makers)にあります。

## 自分で払うべきなのか？

払う前に聞いてください。採用時に講習費を負担する店はそれなりにあり、特に大きなパブグループやホテルチェーンがそうです。負担してくれたはずの店の面接の2日前に自分で払ってしまうのは、小さくて避けられる損です。

雇用主が払った場合、あなたの控除にはなりません。費用を負担していないからです。自分で払って後から払い戻された場合も同じです。控除できるのは実際に自分が負担した支出だけで、この原則はRSAやWhite Cardの費用で最も多くの人を捕まえます。

## 予約の前に分かっている三つの事実とは？

三つとも講習を予約する前にわかっています。最初にどの州で働くか。学習内容とカードが決まります。東部の州のあいだを移動するか。二つ目が必要かどうかが決まります。ホスピタリティの内定がすでにあるか。誰が払うかと、控除が使えるかが決まります。
`,
  },
  ...
  'wwcc-working-with-children-check-australia': {
    ...
    body: `
WWCC（Working With Children Check）は、オーストラリアで子どもに関わる仕事をする前に必要な、州が発行する経歴審査です。有給の仕事なら費用はおよそ80ドル、ボランティアは無料であることが多く、発行までに数週間かかります。どの州で働くかで、カードも費用も持ち運べるかどうかも変わります。

## WWCCは実際に何を審査しているのか？

州の政府機関が行うリスク評価であって、単なる犯罪歴の証明書ではありません。犯罪歴、子どもに関わる不適切な行為の認定、その他州が保持する記録を調べ、子どもに関わる仕事で許容できないリスクがある人を特定します。

見落とされがちなのは、これがある時点のスナップショットではなく継続的だという点です。発行後もあなたの記録は監視され、新しい情報が出れば取り消されることがあります。母国の一般的な警察証明書が代わりにならないのはそのためです。

## どの仕事に必要で、どの仕事が「あると望ましい」だけなのか？

子どもと定期的に接触する有給またはボランティアの役割は、法律上いずれも必要で、保育より広い範囲です。学習支援員、家庭教師、音楽の講師、スポーツのコーチ、キャンプの引率、青少年プログラムのスタッフ、学童保育の職員、ナニー、オーペアが含まれます。

驚かれるのがオーペアです。個人の家庭で行われるのに多くの州で要件が発生し、取り決めが非公式で急に決まることが多いだけに重要です。

法律が厳密には求めていない場面でも、会場や学校の一律の方針から確認を求める雇用主もいます。持っていればより多くの役割にシフトを入れられるので、学校の休暇シーズンに仕事を探すバックパッカーにとっては、それが取る本当の理由になることもあります。

## 別の州でも使えるのか？

使えません。これがお金のかかる細部です。州ごとに独自の制度、カード、費用、有効期間があり、自動的に移せません。ニューサウスウェールズはOffice of the Children's Guardianが発行し、ビクトリアは独自のWorking with Children Checkを運用し、クイーンズランドはBlue Cardの制度を使います。

ニューサウスウェールズでのサマーキャンプの後にビクトリアのスイミングスクールで働くなら、申請も費用も待ち時間も二つずつです。ルートが決まっているなら、最初の仕事がある州で申請し、得られるとは限らない承認を当てにせず二枚目の予算を見込んでください。

## どれくらいかかり、審査中でも働けるのか？

現実的な計画としては数週間で、ボトルネックは審査そのものより本人確認の工程です。多くの州では原本の身分証明書を持って対面で、たいていAustralia Postの窓口で確認を受ける必要があり、それが済むまで時計は動き出しません。

審査中に働けるかは州によって違います。申請して受付番号が出れば監督下での就労を認める州もあれば、カードが届くまで子どもに関わる仕事を一切禁じる州もあります。雇用主ではなくその州の当局に確認してください。雇用主は両方向に間違えますし、罰則は店にもあなたにもかかります。

## カードはどれくらい有効なのか？

ほとんどの州で3年から5年です。2年のワーキングホリデーなら、カードはほぼ必ずビザより長持ちします。ニューサウスウェールズとビクトリアは5年で発行し、クイーンズランドのBlue Cardなどはそれより短いです。

繰り返しかかる費用ではなく一度きりの判断です。問いは更新ではなく、同じ旅のあいだに二つ目の州のカードが必要になるかどうかです。

## ワーキングホリデーメーカーでも取得できるのか？

できます。417・462ビザは障害にならず、市民権も永住権も要件ではありません。必要なのは、通知を受け取れるオーストラリアの住所、書類のあいだで一致した身分証明、多くの州では対面確認の予約です。

考えておく価値があるのは住所です。10日後に出るホステルは郵送先として良くない選択で、返送されたカードはこの申請で最も多い自滅的な遅延です。

## 費用は控除できるのか？

すでにやっている仕事がその審査を必要としている場合、費用は業務関連経費で、領収書とともに申告書に入ります。子どもに関わる仕事がない段階で見込みで取得した場合は正当化が難しくなります。判定基準が、実際に得ている収入との結びつきを見るからです。

同じ原則がWhite CardやRSAでも人を捕まえます。雇用主が払った場合や払い戻された場合は、費用を負担していないのであなたの控除ではありません。

## どの州の規則に縛られることになるのか？

審査そのものは単純です。単純でないのは、どの州の規則に縛られるかと、カードが届く前に働き始められるかで、自分の予定に関する事実で決まります。
...
`,
  ...
  'public-holidays-australia-working-holiday': {
    ...
    body: `
祝日はオーストラリアの雇用で最も高い割増賃金が付く日で、通常率のおおむね225%から250%が一般的です。ワーキングホリデーメーカーも他の誰とも同じ条件で対象です。どの祝日が適用されるかは働いている州、いくら支払われるかはその仕事をカバーするアワードで決まります。
...
King's Birthdayは名称の上では全国ですが日付は全国ではありません。多くの州は6月の第2月曜、クイーンズランド州と西オーストラリア州は別の時期に観測します。その時期に州をまたいで移動しているなら効いてきます。

## 州ごとに何が加わるのか？

1年で3つの州にまたがって働くバックパッカーが、聞いたこともない祝日に出くわす程度には加わります。どれも割増賃金の日なので、移動の予定を組むときに知っておく価値があります。
...
多くのアワードで通常率の225%から250%、つまり2.25倍から2.5倍です。一定時間を超えた分ではなく、その日に働いたすべての時間に適用されます。カジュアルの場合、ローディングと祝日の割増の組み合わせ方は、単純な足し算ではなくアワードが定めます。

通常時給が25ドルなら、225%は時給56.25ドル、250%は62.50ドルです。地元の人が避けるシフトに自分から入ることが、その月の収入を上げる最も確実な方法である理由がこれです。

## 祝日に働かない場合はどうなるのか？

常勤のフルタイムとパートタイムの従業員は、通常なら働く日に祝日が当たった場合、休みのまま基本賃率で支払われます。働いていないので割増は付きませんが、無給の日にもなりません。

カジュアルは、働かなかった祝日については何も受け取りません。見落としではなく、25%のローディングが補償している内容の一部です。その日に実際に働いたカジュアルは、給与明細で明確に高い賃率を目にするはずです。

## 雇用主は働くことを強制できるのか？

雇用主は要請でき、その要請が不合理であればあなたは断れます。合理性は、事業の性質、どれだけ前に知らされたか、あなたの個人的な事情、その役職がもともと祝日の勤務を含むものかどうかを考慮して判断されます。

不合理な要請を断ったことは、解雇の適法な理由になりません。実際には、カジュアルが祝日のシフトを断って問題になることはめったにありません。ホスピタリティの常勤従業員がクリスマスを断るのは難しい議論です。祝日の営業がその業界の本質だからです。

## 残業は上に積み上がるのか？

一般には積み上がりません。祝日の賃率はすでに割増の構造の頂点にあり、残業と複合するのではなく吸収するのが普通なので、祝日の長いシフトは通しで祝日の賃率になります。

別の扱いにしているアワードもあり、一定時間を超えた分に追加の扱いを定めるものもあります。実際のアワードの条項を読むのに10分かける価値のある場面です。2.5倍の日にかかる金額は小さくありません。

## 給与明細には何が表示されているべきか？

祝日の時間が、週の合計に一律の数字で溶け込まされるのではなく、それ自身の賃率で分けて表示されているべきです。その分離が割増を検証可能にし、それがないことが支払われていない最も明快な兆候です。
...
どの祝日が付き、いくら支払われるかは、全国一律のルールではなく、あなたの仕事に固有の事情で決まります。
...
`,
  ...
  'casual-shift-cancellation-rules-australia': {
    ...
    body: `
多くの場合、支払いを受け取れます。雇用主がカジュアルのシフトをキャンセルすること自体は違法ではありませんが、ロスター通りに出勤した人や途中で帰らされた人に対しては、ほとんどのモダン・アワードが2〜3時間分の最低勤務（minimum engagement）の支払いを義務づけています。何時間分になるかを決めるのは雇用主でも雇用契約でもなく、あなたの職種を担当するアワードです。

## 最低勤務（minimum engagement）とは何で、なぜ存在するのか？

最低勤務とは、シフトに就くことが決まったカジュアルに支払われる最短の時間数です。出勤すること自体にコストがあるからです。交通費を使い、予定をシフトに合わせ、他の仕事の誘いを断っている。アワードはその価値をゼロではなく数時間分と定めています。

数字を決めるのはあなたの業界を担当するアワードで、雇用主の裁量ではありません。
...
8時間のシフトのために出勤して入口で「今日は暇だから帰っていい」と言われた場合、雇用主が節約したのは8時間分ではなく6時間分の賃金です。

## 出勤前にキャンセルされた場合も対象になるのか？

ここが本当に不確かな部分です。シフトが始まる前のキャンセルは、ほとんどのアワードで最低勤務条項の外側に置かれます。就労（engagement）がまだ始まっていないからです。

それでも効いてくるのが、アワードのロスターおよびロスター変更に関する条項です。いくつかのアワードは変更前の通知を求め、変更が常態化している場合には協議を求めています。前夜にメッセージ一本で繰り返しキャンセルする運用は、単発なら問題にならなくてもこれらの条項に触れることがあります。エンタープライズ・アグリーメントの適用を受けているなら、アワードより有利な条件が書かれていることがあります。

## シフトの途中で帰らされた場合はどうなるのか？

就労が始まった時点から同じ最低時間が適用されます。アワードが3時間と定めていて1時間で帰らされたなら、原則として3時間分が支払われるべきで、早上がりの理由は通常関係ありません。客が少ない、急な休業、ロスターの入れすぎ、これらはあなたではなく雇用主側の商業リスクです。

ホスピタリティでよくあるのが、閉店までのシフトで入っていたのにランチのピークが終わった時点で帰らされるパターンで、最低勤務条項はこの状況のために書かれています。
...
そのローディングは雇用主の善意ではありません。カジュアルなのに給与明細の時給がアワードの基本レートのままなら、それ自体が賃金未払いで、シフトキャンセルの問題より頻繁に起きています。

## 雇用主にはシフトを与える義務があるのか？

ありません。カジュアル雇用に保証された労働時間はなく、週4シフトが週1シフトに減ったこと自体はどの規則にも違反しません。柔軟性は双方向で、あなたの側もシフトを断ることができ、断ったことを理由にした報復は正当な扱いではありません。

長期間にわたって規則的に働くカジュアルには、条件によって常勤雇用への移行の道が開かれる場合があります。ただしワーキングホリデービザの滞在期間より長い勤続が前提の仕組みなので、この読者に当てはまることはほとんどありません。

## 未払いを疑うとき、何を残しておけばいいのか？

ロスターの証拠とキャンセルの証拠、この二つで全部です。ロスターは公開された時点でスクリーンショットを撮ってください。管理アプリは履歴を残さず上書きするものが多いからです。キャンセルを伝えたメッセージや通知も消さずに保存します。

そのうえで給与明細と突き合わせます。この種の未払いの申し立ては、法律の解釈ではなく実際に何が起きたかをめぐる争いで、スクリーンショット一枚が決着させます。当事者間で解決しない場合はFair Work Ombudsmanが扱い、直前キャンセルが繰り返されているケースは証拠として示しやすい部類です。

## 支払われるべき額を左右するのはどの点か？

最低勤務はあなたのアワードが定める数字で、適用されるかどうかはシフトがいつキャンセルされたかで決まります。左右するのは次の点です。
...
どの免除にも当てはまらない場合、いちばん単純な答えはたいてい許可を求めることではなく雇用主を変えることで、税金とスーパーへの影響はわずかです。同じ15%のレートが通して適用され、[スーパーアニュエーション](/ja/superannuation)も12%で積み上がり続け、賃金はすべて年度末に1通の[タックスリターン](/ja/tax-return)にまとまります。管理が必要なのはスーパーだけです。雇用主が増えるたびにファンドの指定が必要で、全員に同じファンドの情報を渡せば、1年で口座4つと請求4件を生みません。
`,
  },
...
時間ではなく出来高に対して支払われるので、お金は畝に立っていた時間ではなく、摘んだ量、量った重さ、詰めた数に付きます。いちご1キロあたり、りんご1ビンあたり、梱包した1点あたりです。

この仕組みは速さに報いるので、農場は好み、経験のあるピッカーはそれで稼ぎます。最初の1週間は別の話です。技術は身につくまでに時間がかかり、慣れない果物で覚えている人が摘む量は、戻ってきた作業者のごく一部です。この差こそが、保証された床が存在する理由です。
...
時給33.05ドルなら計算は単純です。その賃率で20時間なら661.00ドルです。その20時間で出来高による収入が400ドルだったなら、実効の時給は20.00ドルで、雇用主はその期間について261.00ドルの積み増しを負っています。400ドルだけを払う雇用主は、事前に口頭で何を合意していようとFair Work Actに違反しています。
...
形式の話であると同時に実務の話でもあります。書面の合意は賃率を記録するので、シーズンの途中で下に動くことを防ぎ、あとから請求するときの基礎になります。書面の合意がない場合、既定として通常の時給が適用され、たいてい口で言われた何かより労働者に有利です。

## どんなやり方に注意すべきか？

仕事量を減らさずに、記録上の出来高か時間を減らすやり方です。どれも園芸農業でよくあることなので、当然だと考えずに個別に確認する価値があります。
...
日次の記録をつけてください。この保証は、何が起きたかを示せるピッカーだけを守ります。開始と終了の時刻、休憩、摘んだ数量または発行されたタリーの票を記録し、農場が書き留めたものは引き出しにしまわれる前に写真を撮っておきます。

期間の終わりに2つの数字を出します。収入を時間で割ると実効の賃率が出て、自分の分類の最低時給と比べると不足が出ます。床を下回る結果が続くなら、原因は単位あたりの賃率が適法でないほど低いか、条件のせいで目標が達成不可能だったかです。どちらも、話し合いはあなたの記録から始まり、Fair Work Ombudsmanの回収の手続きも同じ証拠で動きます。そこから先は[賃金の未払いと回収](/ja/blog/wage-theft-working-holiday-australia)で扱っています。

## ピースレートの収入はどう課税されるのか？

他の雇用による収入とまったく同じです。TFNが登録されていればPAYGは15%で源泉徴収され、総収入に対して12%の[スーパー](/ja/superannuation)が上乗せで支払われ、その全額が所得明細と[タックスリターン](/ja/tax-return)に載ります。

ひとつだけ結果を変える分岐は、そもそも従業員かどうかです。[ABN](/ja/abn)を通して行うピースレートの仕事には源泉徴収がなく、スーパーも付かず、保証された床もありません。一部の事業者がそれを好む理由です。その分類が実態を伴うかは、書類ではなく仕事の回り方で決まります。判定の仕方は[ファーム仕事とABN](/ja/blog/farm-work-and-abns)にあります。
`,
  },
  ...
  'labour-hire-agencies-working-holiday-australia': {
    ...
    body: `
人材派遣（レイバーハイヤー）会社を通して働くとき、あなたの雇用主はその会社であり、農場や現場は行く場所にすぎません。この1点が、賃金、スーパー、その他の権利を誰が負うかを決めます。派遣の仕事は、その権利が最も頻繁に消える場所でもあります。
...
この分離が、直接雇用より派遣の取り決めで問題が起こりやすい理由です。賃金が足りないとき、受け入れ先は派遣会社に言えと言い、派遣会社は時間を決めているのは受け入れ先だと言い、書面の条件を持たない労働者には責任を負う相手がいなくなります。始める前に誰が雇用主かを書面で確定させれば、その大半は消えます。

## 派遣の仕事で得られるものは何か？

主に速さで、宣伝ではなく実際の利点です。派遣会社は数週間ではなく数日で人を配置し、複数の業種を同時に扱い、直接採用よりはるかに少ない手続きで済みます。着いたばかりで、来月ではなく今週仕事が必要なときには意味があります。

複数の配置にまたがる給与の事務も引き受けるので、1か月に3つの現場に行っても、雇用主はひとつ、TFNの宣言書も1枚、スーパーファンドもひとつで済みます。移動して回る人には1年が単純になり、下に書くリスクがあってもバックパッカーが使う理由になります。
...
ほかの失敗も、見方が分かれば見分けられます。誰がどう見ても雇用である仕事について請負としてABNに載せること、週末のシフトに割増賃金が一度も適用されないこと、給与明細が発行されないこと、配置を完了するまで賃金を留め置くこと。最後のものはどの時点でも適法ではありません。派遣に別のルールが適用されるという説明は事実ではなく、Fair Work Actは完全に適用されます。

## 実際に何を受け取る権利があるのか？

受け入れ先に直接雇われた場合と同じもので、派遣だからといって差し引かれるものはありません。受け入れ先での仕事が該当する分類のアワード賃率、週末と祝日と残業の割増賃金、各支払いから1営業日以内の給与明細が含まれます。
...
署名する前に確認する価値があります。いくつかの州では免許が必要だからです。ビクトリア州、クイーンズランド州、南オーストラリア州、オーストラリア首都特別地域は、公開の登録簿を持つ労働者派遣の免許制度を運用しており、それらの管轄で免許なく営業することは違法です。

免許は良い振る舞いの保証ではありませんが、必要な州でそれがないことは多くを教えます。知られたスーパーファンドに払っているか、条件が書面で来るか、給与明細が明細化されているか、支払いが毎回同じ日に届くか。これらと合わせれば、まっとうな事業者かどうかは午後のうちに選り分けられます。

## 署名する前に何を尋ねるべきか？

5つで、答えはカウンター越しではなく書面で来るべきものです。答えられない、答えようとしない派遣会社は、それ自体が答えです。
...
下回っていれば、請求の相手は受け入れ先ではなく派遣会社です。Fair Work Ombudsmanは賃金未払いの申し立てを無料で扱い、未払いのスーパーはかわりにATOへ行きます。417や462のビザであることは、そのどちらも弱めません。どんな証拠があれば請求が動くかは[賃金の未払いと回収](/ja/blog/wage-theft-working-holiday-australia)で扱っています。
`,
  },
...
取りすぎた分は失われず、[タックスリターン](/ja/tax-return)を提出したときに精算されます。ただしそれまではATOのところにあります。誤った税率を、年度末ではなく最初の2週間のうちに持ち出すべき理由です。

## スーパーの行はどう確認するのか？

スーパーの金額を総支給額で割り、12%を期待します。2025年7月1日からの率です。スーパーは賃金に上乗せして雇用主が払うので、手取りを減らすことはありません。スーパーが自分の稼ぎから出ているように見える給与明細は質問すべきです。

重要な区別は、発生と支払いの違いです。給与明細のスーパーの数字は、その期間について雇用主が負っている額であって、ファンドに届いた額ではありません。スーパーは四半期ごとに払われるので、この2つは最大3か月離れます。実際に届いたかは、四半期の期限のあとにファンド自体を確認して分かります。届いていなかったときの対処は[未払いのスーパー](/ja/blog/super-employer-not-paying-what-to-do)にあります。
...
給与明細がないということは、時間も賃率も税もスーパーも記録がないということで、それらの義務を避けたい雇用主があなたに置きたい状態です。その時点から日付入りの労働時間の記録をつけ、銀行の入金をすべて保存し、その不在を警告として扱ってください。そこから先は[給料が正しく支払われていないとき](/ja/blog/employer-not-paying-correctly)で扱っています。
`,
  },
  ...
  'wage-theft-working-holiday-australia': {
    ...
    body: `
法的な権利を下回る賃金しか払われていない場合、それは取り戻せます。そして誠実に行った通報がビザに影響することはありません。2026年7月1日からの床は時給26.44ドル、ローディングの付くカジュアルなら33.05ドルで、多くのアワードはそれより上にあります。請求できるかどうかは気持ちではなく計算の問題です。

## 何が賃金の未払いにあたるのか？

実際に働いた時間に対して、アワードか全国最低賃金が定める水準を下回っているものすべてです。時給が低いことより広い分類で、最も多い形のいくつかは、その場では別のものに見えます。
...
このうちの一部は意図的で、一部は本当に給与処理の未熟さです。その区別は話の進み方を変えますが、受け取るべき額は変えません。

## 自分の賃金をどう確認するのか？

支払われた額を、シフトの前後の無給の時間も含めて実際に働いた時間で割ります。結果がカジュアルとして33.05ドルを下回っていれば、全国の床の時点で未払いです。仕事をアワードがカバーしているなら、本当の床はたいていそれより上です。

次に、合計ではなくパターンを見ます。割増賃金があるので、週末と祝日の時間は通常率の倍数で払われるはずです。日曜を含む週のすべての時間が同じ賃率で払われている給与明細は、平均が妥当に見えても誤っています。曜日とアワードごとの倍率は[割増賃金](/ja/blog/penalty-rates-australia)、肩書きではなく実際にしている仕事に対する正しい賃率は[アワードの分類](/ja/blog/award-classifications-working-holiday-australia)で扱っています。

## どうすればよいのか？

まず書面で持ち出してください。請求の多くは対決ではなく書面の履歴から始まります。時間、支払われた賃率、適用されるべき賃率を並べた短いメッセージは、間違えていた雇用主には直す手段を与え、意図的な雇用主には答えるべきものを残します。

それで駄目な場合、Fair Work Ombudsmanが賃金未払いの申し立てを無料で扱い、417や462のビザであることが請求を弱めることはありません。ただしスーパーは別で、未払いのスーパーはFair Workではなく、ATOが[Superannuation Guarantee Charge](/ja/blog/what-is-superannuation-guarantee-charge)を通して回収します。両方の問題がある仕事は、2つの別々の請求になります。安全であれば、持ち出しながら働き続けるほうが証拠が積み上がり、事案は強くなります。

## 通報するとビザに影響するのか？

賃金の未払いで雇用主を通報しても、ワーキングホリデービザが危うくなることはありません。その恐れは、少なく払われているバックパッカーを黙らせている最も効果的なもので、オーストラリアの法律に根拠がありません。

保護は意図的なものです。誠実に行われた職場の申し立てが、ビザの審査を引き起こすことはありません。雇用主は、何をほのめかそうと、あなたのビザに対する権限をそもそも持っていません。Workplace Justiceの仕組みは、一時滞在ビザの保持者が入国管理上の立場を盾に取られずに搾取の請求を進められるように用意されています。

## どんな記録が請求を成立させるのか？

時間とお金を結びつけるもので、雇用主が取り上げられない場所に保管したものです。請求の強さはほぼ証拠で決まり、その証拠はまだそこにいる間がいちばん集めやすいです。
...
開始と終了の時刻を日々メモすることは数秒で終わり、争いを最も多く決める記録です。それがなければ、議論はあなたの言い分と給与システムの対立に縮みます。給与明細は受け取った端から保存してください。

## 帰国したあとでも取り戻せるのか？

取り戻せます。Fair Work Ombudsmanを通した賃金未払いの請求も、ATOへの未払いスーパーの通報も、あなたの出国後も生き続け、どちらも国内にいることを要求しません。

難しくなるのは証拠と連絡です。アクセスできなくなったシステムのロスターや給与明細を別の大陸から取り出すのは困難で、出国の途中で閉じた銀行口座は、回収した賃金の支払いを面倒にします。どちらも、こちらでの最後の2週間なら安く片づき、あとからだと高くつきます。
`,
  },
  ...
  'workplace-injury-working-holiday-rights': {
    ...
    body: `
対象です。有給の就労中にけがをしたワーキングホリデーメーカーは、州または特別地域の制度で労災補償を請求できます。医療の治療、リハビリ、そして失った賃金の一部をカバーします。この権利は、ビザにも、その仕事にどれだけいたかにも、雇用主が実際に保険に入っていたかどうかにも左右されません。

## この制度は実際に何をカバーするのか？

有給の就労から生じた、あるいはその過程で生じた、あらゆるけがや病気です。多くの人が思うより広い範囲で、事故には見えないものも含まれます。
...
これは無過失の制度です。そのけがが誰かの過失である必要も、雇用主の過失である必要もなく、仕事が原因で起きたのであれば請求は成り立ちます。

## 給付はどれくらいになるのか？

そのけがに対する医療の治療が直接支払われ、働けない間は週ごとの支払いがあります。加えて通院の交通費、職場復帰の支援、後遺障害が残った場合の一時金があります。

週ごとの支払いは通常の週給の80%から95%が典型で、州によっては時間の経過とともに割合が下がり、けががあなたの働く能力に影響している間は州ごとの上限の範囲で続きます。制度は州ごとなので、ニューサウスウェールズ州、ビクトリア州、クイーンズランド州で詳細が違います。基準になるのは雇用主の本社ではなく、あなたが働いている州です。

## メディケアがないこととどう関係するのか？

そのけがについては、この問い自体を置き換えます。労災補償は仕事上のけがの治療の第一の支払者で、あなたに請求が来ることはないはずです。メディケアの受給資格がないワーキングホリデーメーカーの大多数に、これは非常に大きな意味を持ちます。

仕事中の転倒による手首の骨折は、メディケアの受給資格がなく、有効な旅行保険もない人でもカバーされます。受給資格の問題がどこに位置するかは[ワーキングホリデーメーカーとメディケア](/ja/blog/what-is-medicare-working-holiday-makers)で扱っています。

## 請求が動き出すには何が必要なのか？

順番に4つで、最初の2つが遅れやすいところです。けがをしたらすぐ、できれば書面で雇用主に報告します。医師の診察を受け、労災補償用の診断書を取得します。通常の病気の証明書とは別の書式です。

そのうえで請求が雇用主の保険会社に提出され、雇用主は法律上、多くは5営業日以内にそれを回付しなければなりません。働けない期間が続く場合は継続の診断書が必要です。雇用主が請求の提出を適法に拒むことはできず、拒むこと自体が州の規制当局に通報できる違反です。

## そのことで脅された場合はどうするのか？

その脅しは実体を持ちませんが、よくあります。請求すれば解雇される、国外退去になる、ビザが取り消されると言われたという報告が、ワーキングホリデーメーカーから届きます。

労災補償の請求を理由とする解雇は、どの州でも違法です。請求がビザの取り消しを引き起こすことはなく、雇用主が何をほのめかそうと、あなたのビザの状態に対する権限は持っていません。圧力を受けているなら、州の規制当局とFair Work Ombudsmanのどちらも使えます。

## ABNで働いていた場合はどうなるのか？

その場合カバーは自動ではなく、ここが本当の穴です。実態のある請負業者は原則として発注者の労災保険の対象にならず、自分で手配することが期待されます。

ただしホスピタリティとファーム仕事でABNに載せられている人の多くは、誤って分類された従業員です。分類が直れば、アワードの賃率とスーパーアニュエーションとともにカバーも戻ります。決まった時間、監督、雇用主が支給する機材、単一のクライアントが指標になります。判定の仕方は[従業員と請負業者の判定](/ja/blog/employee-vs-contractor-australia)にあり、請求がないと決めつける前に解いておくべきです。

## けがはその年の税金に何をするのか？

たいてい収入を下げるので、査定の計算はあなたに有利な方向に動きます。無給や一部支給の週がいくつもあった年は、フルタイムの給与を前提に計算された源泉徴収が行きすぎた年で、大きめの還付として現れます。

補償の支払いは性質によって扱いが変わります。週ごとの賃金の補填は原則として課税対象で、後遺障害に対する一時金は原則として課税対象になりません。この区分を正しく取ることが重要で、けがが申告を複雑にする数少ない領域のひとつです。

## 補償の中身を決めるのは州か分類か？

対象になるかどうかは変数ではありません。何をどれだけ受け取り、どれだけ素直に進むかは事実で決まります。次の点が、何がいくら支払われ、どれだけ続き、税金の時期にどう扱われるかを決めます。
...
これらは、解雇の申し立てがあってもなくても、国内にいてもいなくても回収できます。賃金の側をどう追うかは[給料が正しく支払われていないとき](/ja/blog/employer-not-paying-correctly)で扱っています。
`,
  },
...
確認する価値があるのは3つです。実際に働いた時間にアワードの賃率が支払われているか、完了した四半期ごとに12%の[スーパー](/ja/superannuation)がファンドに届いているか、給与明細が発行されているか。これらは別の手続きを持つ別の請求で、その職場を辞めても生き続けます。追い方は[給料が正しく支払われていないとき](/ja/blog/employer-not-paying-correctly)と[未払いのスーパー](/ja/blog/super-employer-not-paying-what-to-do)で扱っています。
`,
  },
...
ホスピタリティの店での土曜1日をきちんと計算すると、祝日の倍率が乗る前でも意味のある金額になります。ローディングがどう組み合わさるかは[オーストラリアの割増賃金](/ja/blog/penalty-rates-australia)にあります。基礎の目安として、2026年7月1日からの全国最低賃金は時給26.44ドル、カジュアルは33.05ドルで、多くのアワードはそれより上にあります。
...
Tax File Number Declarationが整っていない状態で届いた支払いは、15%ではなく45%で源泉徴収されることがあります。それを左右する期間は[Tax File Number Declarationの解説](/ja/blog/tax-file-number-declaration-form)で扱っています。
...
週15ドルの洗濯代が見た目以上に注意に値するのはこのためです。私たちが[タックスリターン](/ja/tax-return)を作成するときは、ATOに報告された内容と給与明細を比べます。少なく報告するパターンはそこで見えます。
...
人が取り違えるのはカバーしないほうです。独立したレストランやカフェはRestaurant Industry Award、ファストフード店はFast Food Industry Awardのもとにあります。ホテル内のレストランと隣のレストランのウェイターは、同じ仕事でも別のアワードで、賃率も日曜の割増も違います。その線の向こう側は[Restaurant Industry Award](/ja/blog/restaurant-industry-award-working-holiday)で扱っています。
...
未払いの賃金を取り戻すことは、3つを同時に増やします。遡及の支払いを受け取った年の課税所得、雇用主が負っていたスーパー、帰国時に請求するDASPの残高です。賃金そのものの回収は税制ではなくFair Workを通して進み、スーパーの側は[未払いのスーパー](/ja/blog/super-employer-not-paying-what-to-do)で扱っています。
...
小麦や大麦のような大規模穀物、牛や羊のステーションでの畜産、養殖はカバーしません。それらはPastoral Awardなど別のアワードの下にあり、レートも違います。正しいアワードの特定は、技術的な細部ではなく最初の一歩です。

## 最低時給の保証とはどういうものか？

どのような支払い方であれ、働いた時間に対する稼ぎは、自分の職分の最低時給に相当する額以上でなければなりません。出来高は賃金の計算方法であって、床を回避する手段ではありません。

1日のピッキングが、働いた時間に対する最低時給を下回った場合、雇用主は差額を補填しなければなりません。その補填を払わないファームは、オーストラリアの園芸で最も多い未払いのパターンで、Fair Work Ombudsmanが繰り返し全国的な取り締まりを行ってきた対象です。この保護の働き方は[ファームの出来高払い](/ja/blog/piece-rates-farm-work-working-holiday)にまとめてあります。

## 自分は実際どの職分にいるのか？

職分は給与明細のレベルではなく、実際にやっている仕事で決まります。静かな未払いはここに隠れています。アワードはLevel 1からLevel 5まであり、ワーキングホリデーメーカーの多くはLevel 1かLevel 2にいます。
...
アワードがLevel 2に移すはずの3か月を過ぎてもLevel 1に据え置かれるのは、よくある、そして完全に回収可能な未払いです。開始日とレートを誰かが照らし合わせない限り、表に出ません。

## 割増やローディングはどう適用されるのか？

園芸の割増はホスピタリティより狭いですが、農作業に割増がないというのは事実ではありません。基本レートの上に25%のカジュアル・ローディングが適用され、残業、祝日、一部の職分では週末の割増も適用されます。
...
ビザの側と賃金の側は同じ書類でつながっています。指定労働は時間ではなく日数でセカンドビザに算入され、内務省が依拠する証拠は、あなたが適正に雇用され報告されていたという記録です。

アワードにもとづいて支払われ、シングルタッチ・ペイロールでATOに報告されていれば、ビザの証拠は給与明細と所得明細から自然に揃います。現金払いだった場合、その証拠を立てるのははるかに難しく、セカンドビザの申請でそれが現実の問題になります。ファームで現金の取り決めを断るべき理由は、税務上の理由よりずっと前にここにあります。

## 未払いは賃金以外に何を失わせるのか？

未払いの賃金は一つの損失ではなく三つです。賃金そのものが不足し、12%の[スーパーアニュエーション](/ja/superannuation)はその不足した額をもとに計算されるので同じく不足し、やがて請求するDASPの支払いも小さくなります。

Fair Work Ombudsmanを通じた賃金の回収は無料で、手続きも機能します。ただしスーパーとその後のDASPは、元になる賃金が是正されて初めて是正されます。回収の側は[スーパーが支払われていない場合](/ja/blog/super-employer-not-paying-what-to-do)にあります。

## ファームでの最初の1週間に何を確認すべきか？

最初の1週間は、問題を直すのが安く、放置するのが簡単な時期です。その作物にどのアワードが適用されるのか、自分はどの職分か、レートにカジュアル・ローディングは含まれているのか、支払いは時給か出来高かを尋ねてください。

出来高払いの合意を書面でもらうことが最も有用です。最低保証は、照らし合わせる文書化された合意があって初めて機能します。最初の数日、自分のビンの数と時間を記録すれば、「なんとなく少ない気がする」が「ファームに提示できる数字」に変わります。
...
難しいのは、ATOに報告された内容と本来支払われるべきだった額を突き合わせることです。二つは別の場所にあり、ファームも人材派遣会社もその比較を出してはくれません。その突き合わせは、ファームで働いた人の[タックスリターン](/ja/tax-return)を作成する作業の一部で、支払われた賃金との差が最も大きく出るのは一貫してファームの仕事です。
`,
  },
  ...
  'restaurant-industry-award-working-holiday': {
    ...
    body: `
Restaurant Industry Award、コードMA000119は、独立したレストラン、カフェ、同種の飲食店の最低賃率、分類、割増を定めます。Hospitality Awardとは別の文書で、違いが最も表に出るのは日曜日です。どちらがカバーするかは、仕事の内容ではなく施設で決まります。

## このアワードは何をカバーし、何をカバーしないのか？

単独で成り立つ飲食の店です。ホテルに付属しない独立したレストラン、カフェ、コーヒーショップ、ブランチの店、ティールーム、ケータリング事業、宿泊施設に接続しない宴会場やレセプション施設で、テイクアウトの店も状況によっては入ります。

カバーしないのはホテル内のレストランで、[Hospitality Award](/ja/blog/hospitality-award-working-holiday-makers)のもとにあります。ファストフード店も独自のアワードを持ち、企業協定がアワードに置き換わる職場も対象外です。どの文書が適用されるか自明でないときは[アワードの分類](/ja/blog/award-classifications-working-holiday-australia)で扱っています。

## 自分にはどの分類が当てはまるのか？

6つの等級のいずれかで、等級は肩書きではなく職務を追います。導入レベルは関連する経験のない最初の期間。レベル1はテーブルのセットと片づけ、グラスの回収。レベル2は飲み物を注ぐこと、注文を取ること、料理の提供、基本的な調理。レベル3は小さな部門の監督かクックのグレード1。レベル4から6は、クックのグレード2、シェフ・ド・パルティ、ヘッドシェフ、レストランマネージャーへと上がります。

フロントの多くはレベル1かレベル2、経験のあるバリスタはレベル2かレベル3です。職務は分類より速く上へ流れ、そこがこのアワードが静かに適用不足になる形です。注文を取って飲み物を注ぐ人は、ロスターが何と呼ぼうとレベル1の労働者ではありません。

## 賃率と割増はどう積み上がるのか？

出発点は毎年7月1日に見直される分類ごとの基本賃率です。カジュアルなら25%のローディングが適用され、そのうえに曜日と時間帯に応じた割増が乗ります。

- 月曜から金曜の19時から深夜まで：控えめな夜間のローディング
- 土曜日：カジュアルで50%が典型で、分類によってはカジュアル・ローディングを取り込んだ数字になります
- 日曜日：カジュアルで75%が典型です
- 祝日：カジュアルで150%が典型です
- 深夜から午前7時まで：より高い深夜のローディング

正確な数字と区切りの時刻は現行のアワードにあります。重要なのは、レストランの割増がホテルの割増と同じではない点です。誤ったアワードを適用する雇用主は、形式的な誤りではなく違う日曜の賃率を払っています。

## どんな手当があるのか？

多くの人が申請している以上にあります。休憩なしで残業したときの食事手当、雇用主が制服を要求して支給しない場合の衣類または制服の手当、制服を洗う洗濯手当、指名された救護担当への救急手当、包丁のような自分の道具を求められる場合の道具の手当です。

道具の手当はとくに厨房で重要です。シェフや調理人は自分の包丁を持ち込むことが多く、税金の時期の控除に加えて補償を受ける権利があります。

## 誤ったアワードが適用されていた場合はどうなるのか？

誤った賃率表で支払われ、不足は毎週積み上がります。飲食サービスで最も一貫した未払いのパターンで、一部は意図的、一部は小さな店の給与設定が見直されないためです。

正しいアワードの特定は細部ではなく最初の一歩です。Restaurant Awardが適用される仕事の給与明細をHospitality Awardの賃率と比べれば誤った答えが出て、請求も弱くなります。

## 税金とスーパーには何をするのか？

未払いの賃金は下流のすべてを少なく見せます。ATOに報告される所得は本来より低くなり、その賃金で計算される12%のスーパーアニュエーションも低くなります。

あとから回収した賃金は、稼いだ年ではなく受け取った年の課税対象で、訂正後の金額に発生するスーパーは別に取り戻せます。その側は[未払いのスーパーへの対処](/ja/blog/super-employer-not-paying-what-to-do)にあり、賃金そのものの追及はFair Work Ombudsmanを通します。

## 賃金の請求は最初のどこから組み立てるのか？

アワードは公開され、賃率も公表されています。何が支払われるべきだったかは、その店とロスターの事実で決まります。次の点が請求の土台で、最初のひとつが残りを決めます。

- その店が独立しているか、ホテルの中にあるか。適用されるアワードが決まります
- 肩書きではなく、実際の職務がどの分類に対応するか
- 導入レベルが適用される時期を過ぎても、そこに置かれていないか
- カジュアルかどうか。すべての割増の上にローディングが乗ります
- どの時間帯に働いたか。土曜、日曜、夕方、祝日の割増はHospitality Awardと違います
- 制服、洗濯、自分の道具の手当が支払われたか
- アワードのかわりに企業協定が適用されていないか

各店で源泉徴収された分は年度末に精算されます。年度累計の数字があれば[還付金の試算](/ja/calculator)ができます。
`,
  },
...
2022年のアワードの改正以降、ピースレートの合意は、平均的な能力のピッカーが少なくともカジュアルの時給の最低額を稼げる設定でなければなりません。計算すると最低額のごく一部にしかならないバケツ単価の広告は、厳しい条件ではなく違法です。この保証の機能は[ピースレート](/ja/blog/piece-rates-farm-work-working-holiday)で扱っています。
...
フルーツピッカーの多くは従業員であるべきで、税金が源泉徴収され、12%の[スーパーアニュエーション](/ja/superannuation)が支払われ、アワードが適用されます。かわりにピッカーをABNに載せる農場もあり、それはスーパーの義務と従業員としての最低保証を消し、税金の負担をすべてあなたに移し、たいてい労災補償のカバーも消します。

分類は書類ではなく仕事の実態で決まります。農場がいつ始めるか、どこで摘むか、どうやるかを決め、機材を支給し、代わりの人を送れないなら、契約書が何と言おうとあなたは従業員です。判定の仕方は[従業員と請負業者の判定](/ja/blog/employee-vs-contractor-australia)にあり、ファーム仕事で最も高くつく誤分類です。
...
最初の1週間、自分のキロ数と時間を記録することが、ピッカーにできる最も役に立つことです。少なく払われているという感覚が数字に変わります。実効の時給がカジュアルの最低を下回っていれば、その差額は農場が負っており、Fair Work Ombudsmanを通した回収は無料です。税金の側は別に進みます。賃金も、スーパーも、[タックスリターン](/ja/tax-return)も、実際に報告された内容から出てくるので、その地域を離れる前に片づける価値があります。
`,
  },
  ...
  'farm-hand-jobs-working-holiday-australia': {
    ...
    body: `
ファームハンドは、フルーツピッキング以外の農業の仕事の総称です。家畜、フェンス、機械、作物、敷地の維持管理が含まれます。その多くはセカンドビザのための88日に数えられます。どのアワードがカバーし、いくら支払われるべきかは、肩書きではなくその農場の主たる活動で決まります。

## その仕事は実際に何をするのか？

その敷地が必要とすることは何でも、としか言いようがなく、求人が漠然と書かれるのもそのためです。ステーションでの家畜の世話、集畜、駆虫、分娩の介助。大規模作物の播種、除草、収穫。フェンス、水槽、一般的な保守。トラクターと機械の作業。羊毛刈りの作業場の補助。干し草や酪農の仕事。

役職名より、敷地の種類のほうが仕事を大きく変えます。ノーザンテリトリーの牛のステーション、西オーストラリアの小麦農場、ビクトリアの酪農場は、どれもファームハンドを募集し、どれも別のことを意味します。受ける前の質問は、日々の作業が何で、何時から何時までかです。
...
アワードの中の分類が賃率を決め、等級は伴う責任とともに上がります。監督なしで機械を操作し家畜を扱っている人は、入口の分類にはいません。そこにいるかのように払われることが、ピースレートの問題に次いでファーム仕事で多い未払いです。正しい等級の見つけ方は[アワードの分類](/ja/blog/award-classifications-working-holiday-australia)で扱っています。

## いくら支払われるべきなのか？

少なくとも全国の床、実際にはそれ以上です。農業の分類のアワード賃率はその上にあるからです。2026年7月1日から、あらゆる仕事のカジュアル最低賃金は時給33.05ドル、全国最低賃金26.44ドルに25%のカジュアル・ローディングを乗せた額です。賃率は毎年7月1日にFair Work CommissionのAnnual Wage Reviewで見直されます。

そこから数字を動かすものが2つあります。技能と責任とともに上がる分類の等級と、週末、祝日、残業の割増賃金です。割増は農場でも他の職場と同じように適用されます。Fair Workの賃金計算ツールが、どのアワードのどの分類についても現行の数字を出します。

## ファームハンドの仕事は88日に数えられるのか？

その多くは数えられますが、4つの条件が同時に満たされる必要があります。指定された地方の郵便番号にあること、植物と動物の栽培・飼育を含む指定就労の区分に入ること、有償であること、日付と場所にあなたを結びつける形で記録されていることです。

数えられないのが、人が捕まる部分です。農業の事業の事務仕事、農場の直売所や市場で農産物を売る小売の仕事、物理的に農業でない役職の多くは、雇用主が明らかに農場であっても定義の外に落ちます。争いを決めるのは給与明細で、支払いの取り決めが非公式な僻地の仕事に88日の証拠の問題が集中します。実際に通用する証拠は[ファーム仕事での権利](/ja/blog/farm-work-rights-working-holiday-australia)で扱っています。

## 住み込みの取り決めでは何を確認すべきか？

受ける前に手取りの数字です。ステーションや僻地の農場の仕事では宿泊と食事がまとめて組み込まれるのが一般的で、その天引きが適法なのは、書面で合意され、合理的で、給与明細にきちんと記載されている場合だけです。

賃金から明示された天引きを引き、早出も含めて実際に働く時間で割り、町の仕事からホステル代を引いた額と比べてください。僻地が明確に勝つこともあれば、勝って見えるだけのこともあり、差はたいてい賃率ではなく時間にあります。警告になるのは、農場の裁量で取られる、給与明細で指し示せない天引きです。
...
例外は農場で最も効きます。[ABN](/ja/blog/farm-work-and-abns)の請負として使われている場合、自動的な労災補償のカバーは原則として適用されません。最寄りの病院まで何時間もかかる敷地では大きな話です。分類が正しいかは書類ではなく仕事の実態で決まり、判定の仕方は[従業員と請負業者](/ja/blog/employee-vs-contractor-australia)にあります。実際に起きたときにどうするかは[職場でのけがと権利](/ja/blog/workplace-injury-working-holiday-rights)で扱っています。

## ファームハンドは税金の時期に何を申請できるのか？

その仕事が買わせた装備で、農場ではほとんどの職種より長い一覧になります。保護用と防水の安全靴、蛍光の装備を含む作業着、日焼け対策、手袋、自分で用意した小型の工具や刃物、電話代の業務按分、別々の作業場所の間を移動した車両の費用です。

個別に積み上げるかは、その年と合計次第です。2026-27年度以降は、すべてを証明する代わりに[領収書なしの定額1,000ドル](/ja/blog/1000-dollar-instant-deduction-rule-2026)が使えます。ファームハンドの多くは実際の合計が1,000ドル前後に着地するので、定額が理にかなう選択になります。何が対象になるかは[ワーホリの控除](/ja/blog/tax-deductions-working-holiday-makers)で扱っています。
`,
  },
...
同じ仕事、同じドリンク、違う日曜の賃率です。アワードの特定が給与明細を確認する最初の一歩であり、雇用主の数字と食い違う最も多い理由でもあります。
...
提供を始めたあともレベル1に置かれ続けるのはよくある分類の違反で、差額は取り戻せます。分類は肩書きや2週間前にグラス回収から始めた事実ではなく、実際にしている職務に従います。

## お金は実際どこから来るのか？

基本賃率ではなく割増からです。バーの営業時間は、まさに割増の付く夕方、金曜、土曜、日曜、祝日に集中しています。カジュアルはそのそれぞれの上に25%のローディングを受け取ります。

木曜から日曜の夜に入るカジュアルは週の大半で上乗せされた賃率にいるので、同じ基本分類でも平日のカフェより多く払われます。2026年7月1日から、あらゆる仕事のカジュアルの床は時給33.05ドルで、夕方と週末の割増が乗ったアワードの賃率はそれをかなり上回ります。

## RSAはどう機能し、誰が費用を払うのか？

アルコールを提供する前に必要で、数時間で取れ、たいていオンラインで受講でき、州単位で発行されます。ビクトリア州の証明書があっても、自動的にシドニーで注げるわけではありません。どの州がどれを認めるかは[RSAの証明書](/ja/blog/rsa-certificate-australia-working-holiday)で扱っています。

払う前に尋ねてください。採用時に費用を負担する店は相当数あります。雇用主が払った、または払い戻された場合は控除になりません。自分で払った受講料は、いましている仕事に関連するなら控除の対象です。

## チップはどうなるのか？

オーストラリアのチップの習慣はアメリカよりはるかに薄く、基本の賃金が高くチップを前提に組み立てられていないからです。チップは法律上の賃金の一部ではなく、任意の追加の支払いです。

それでも課税対象の所得で、現金で受け取った場合も店がまとめて分配した場合も申告が必要です。アワードの順守には数えられず、雇用主が支払うべきだった賃率との不足をチップで埋めることはできません。どう報告するかは[チップと税金](/ja/blog/do-working-holiday-makers-pay-tax-on-tips)で扱っています。

## バーで最もよく起きる問題は何か？

一貫したパターンがいくつかあり、証拠が揃えば取り戻せます。どれも給与明細とロスターを並べれば見えます。
...
閉店は勤務の終わりではありません。実際の終業ではなく閉店時刻で書かれたロスターは、毎晩同じ幅だけ少なく払います。課金については[違法な制服と洗濯の天引き](/ja/blog/uniform-laundry-deductions-illegal-australia)で扱っています。

## バーテンダーは税金の時期に何を申請できるのか？

控えめな額です。自分で払って払い戻されなかったRSAの受講料、店が要求する場合の滑りにくい靴、まれに自分で用意するバーの器具、電話代の業務按分、そして交通手段のない場所でのシフトのための車両の費用です。
...
人手の足りない店では、そこから上がるのが速く、数か月ではなく数週間のこともあります。決め手は、機会が現れる前にRSAを持っていることです。金曜の夜の穴を埋める店長は、すでに注げる人にシフトを渡すからです。

## バーとロスターの何が時給を分けるのか？

仕事の中身はどこでも同じで、いくら払われるかは店とロスターで決まります。名目上の賃率が同じ2人が、次の各点によって1か月で数百ドル離れることがあります。
...
Grade 2の仕事をしながらGrade 1に置かれ続けることは、オーストラリアのカフェで最も多い未払いです。3か月目で土曜の混雑を監督なしでマシンを回している人は、給与明細が何と言おうと見習いではありません。正しい等級は[アワードの分類](/ja/blog/award-classifications-working-holiday-australia)で説明しています。
...
オーストラリアでこの違反が最も多いのがカフェです。賃金はFair Work Ombudsmanを通して無料で回収でき、その仕事に就けなかった場合も対象です。線がどこにあるかは[無給のトライアルシフト](/ja/blog/unpaid-trial-shifts-australia-legal)で扱っています。
...
カフェが要求していても、普通の黒い服は控除になりません。その線がどこにあるかは[税務上の控除](/ja/blog/tax-deductions-working-holiday-makers)で扱っています。
...
`,
  ...
  'waiter-waitress-working-holiday-australia': {
    ...
    body: `
オーストラリアでのフロアサービスは、チップ前提ではなく本物の賃金が支払われます。基本の賃率をアワードが定めており、どのアワードかは店で決まります。レストランなら[Restaurant Industry Award](/ja/blog/restaurant-industry-award-working-holiday)、ホテルなら[Hospitality Award](/ja/blog/hospitality-award-working-holiday-makers)です。そしてお金が取れるかどうかは分類のところで決まります。
...
つまり金曜と土曜のディナーのロスターは、同じ時間数の平日ランチよりかなり価値が高くなります。日曜を含む週の給与明細に同じ時給の数字しか並んでいなければ、それは1行で違反を示しており、最も速く確認できます。曜日とアワードごとの倍率は[割増賃金](/ja/blog/penalty-rates-australia)にあります。
...
重要なのは、そのチップがどう届いたかです。カードのチップとサービス料は店の給与計算を通るので、税が源泉徴収され所得明細にも自動的に載ります。直接手渡された現金は誰も報告しないので、[タックスリターン](/ja/tax-return)で申告するのはあなたの責任で、週ごとのメモがあれば記録として十分です。両方について[チップと税金](/ja/blog/do-working-holiday-makers-pay-tax-on-tips)で扱っています。
...
その大半を捕まえる週ごとの確認は2分です。働いたシフトに正しい上乗せ後の賃率を掛け、手当を足し、給与明細と比べるだけです。制服と破損の側は[違法な天引き](/ja/blog/uniform-laundry-deductions-illegal-australia)で扱っています。

## アルコールを提供すると立場は変わるのか？

2つの意味で変わります。まずアルコールを提供する前にRSAの証明書が必要で、短い講座、たいてい自己負担で、業務関連の支出として控除できます。

そして分類にも効きます。飲み物を注ぐことはRestaurant Industry AwardではGrade 2の仕事なので、RSAを持ちバーもカバーするウェイターは、ロスターがそのシフトを接客と呼んでいてもGrade 2で支払われるべきです。RSAはその等級が前提にする能力の書面での証拠なので、分類の主張として最も明快なもののひとつです。取り方と時間の目安は[RSAの証明書](/ja/blog/rsa-certificate-australia-working-holiday)で扱っています。
`,
  },
...
`,
  ...
  'construction-laborer-working-holiday-australia': {
    ...
    body: `
建設の労務は、職人の資格を持たないワーキングホリデーメーカーに開かれた仕事で最も条件がよい部類で、現場に入る前にWhite Cardが必要です。賃率はBuilding and Construction General On-site Award（MA000020）が定めています。実際にいくら払われるかは、その中のあなたの分類と、バックパッカーがまず目にしない各種の手当で決まります。

## どんな仕事なのか？

一般の現場労務で、資材の運搬と移動、コンクリート作業、現場の清掃、解体、足場の組み立て、土工の補助、大工、配管、電気の職人の補助です。体を使い、屋外で、現場のペースで進みます。

これだけの賃金が付く理由は、安全の仕組みが必要な理由と同じです。建設はワーキングホリデーメーカーが入るどの分野よりけがの発生率が高く、だから受け入れ研修が義務で、保護具は任意ではなく、労災補償がカフェよりはるかに重要です。

## なぜ先にWhite Cardが必要なのか？

それなしで建設現場にいることが、あなたにも雇用主にも違法だからです。General Construction Inductionの講座を修了すると発行され、対面なら1日、オンラインも同等で、すべての州と特別地域で通用します。

細部が2つあります。カードに有効期限はありませんが、2年間建設の仕事をしないと失効します。受講料は政府ではなく研修機関が決めるので州と事業者で変わり、比べる価値があります。この受講料は業務関連の支出として控除できます。州ごとの詳細は[White Cardの要件](/ja/blog/white-card-australia-working-holiday)で扱っています。

## 時給を決めるのは何か？

アワードのもとでのあなたの分類の等級で、誰も教えてくれない数字です。Building and Construction General On-site Awardは、Construction Workerの等級ごとに賃率を定め、技能と責任とともに上がります。CW3の仕事をしながらCW1で払われるのはよくあり、目に見えない未払いです。

そのうえにローディングが乗ります。カジュアルの雇用には休暇の代わりのローディングが付き、土曜、日曜、祝日の勤務には割増賃金が付き、残業は通常率の倍数です。土曜を含む週の給与明細は含まない週と違って見えるはずで、そうでなければ最初に尋ねてください。実際の職務に合う等級の見つけ方は[アワードの分類](/ja/blog/award-classifications-working-holiday-australia)で扱っています。

## 支払われないままになる手当はどれか？

何よりも産業手当（industry allowance）で、そのアワードのもとで働くすべての建設労働者に支払われます。建設の条件全般を補償するもので、満たせずに落ちる資格要件もありません。給与明細にそれがないことは、アワードが適用されていない最も確かな兆候です。

ほかにもいくつかあり、全員ではなく特定の状況に付きます。どれも賃率ではなく、その週の事実で決まります。
...
あなたを守るものすべてが適用されなくなるので、受ける前に確認してください。建設現場での人材派遣は一般的で一部は実態のある請負ですが、決まった時間で働き、道具を支給され、監督者に指示され、他にクライアントを持たない労務者は、請求書に何と書かれていようと従業員です。

誤分類の代償は具体的です。12%の[スーパー](/ja/superannuation)がなく、けがをしても労災補償のカバーがなく、カジュアル・ローディングも割増賃金もアワードの手当もありません。けがのリスクが高い現場では労災補償が最も重要です。判定の仕方は[従業員と請負業者](/ja/blog/employee-vs-contractor-australia)、派遣会社が入るときに法的な雇用主が誰かは[人材派遣](/ja/blog/labour-hire-agencies-working-holiday-australia)で扱っています。

## 現場でけがをしたらどうなるのか？

労災補償が最初のシフトからカバーします。最低勤続期間はなく、ビザも関係ありません。医療の治療、働けない間の週ごとの支払い、後遺障害に対する一時金が対象です。

うまくいかなくなるのは2つで、どちらも最初の48時間の話です。その場で雇用主に報告されなかったけがは、あとから立証するのが難しくなります。仕事中に起きたと伝えずに受けた治療は、請求とつながらない診療記録を作ります。請求を思いとどまらせる雇用主は違法な行為をしており、ビザの種類はこの手続きで考慮されません。全体の枠組みは[職場でのけがと権利](/ja/blog/workplace-injury-working-holiday-rights)で扱っています。

## 税金の時期に何を申請できるのか？

他の多くの職種より多くあります。建設は、あなたに物を買わせるからです。安全靴、蛍光の作業着、自分で用意したヘルメットと手袋、屋外作業の日焼け対策、手工具、White Cardの受講料が、いずれも業務関連の支出です。

個別に積み上げるかは、どの会計年度にいるかで決まります。2026-27年度以降は[領収書なしの定額1,000ドル](/ja/blog/1000-dollar-instant-deduction-rule-2026)を取ることも、実額を証明することもできます。建設は実際の合計が1,000ドルを超える数少ない職種のひとつで、その場合は初日から領収書を残す価値があります。1日のうちに2つの現場の間を移動した分は控除でき、自宅から最初の現場への通勤は控除できません。
`,
  },
  ...
  'uber-eats-delivery-rider-working-holiday-australia': {
    ...
    body: `
フードデリバリーは雇用ではなく請負です。[ABN](/ja/abn)が必要で、支払いからは何も源泉徴収されず、税金は査定時にまとめて1本の請求として来ます。GSTは売上が75,000ドルを超えるまでデリバリーには適用されません。人を乗せるライドシェアでは1ドル目から適用されます。
...
アカウントにABNが登録されていなければ、支払う側はABNなしの源泉徴収ルールで47%を源泉徴収しなければなりません。TFNのない賃金に適用される45%とは別の、より高いレートです。この分類が正当な場合と、雇用を避けるための手段になっている場合の違いは[ABNとは何か](/ja/blog/what-is-an-abn)にあります。

## デリバリーの収入はどう課税されるのか？

デリバリーの収入はワーキングホリデーメーカー税率で課税され、最初の45,000ドルまで15%、そこから135,000ドルまで30%と、賃金とまったく同じです。違うのはレートではなくタイミングで、年間を通じて何も源泉徴収されないため、全額が[タックスリターン](/ja/tax-return)の査定時に発生します。
...
罠は両方やることです。フードデリバリーに加えて乗客を乗せると、ライドシェアのルールがギグ収入全体をGSTの制度に引き込み、数回の乗客運送が1年分のデリバリーの扱いを変えます。その境界は[ワーホリでUberを運転する](/ja/blog/uber-driver-working-holiday-australia)にあります。
...
すべての支払いの15%から25%を別の口座に取り分けておくことが、きれいに終わる1年と、別の国から清算する1年の分かれ目です。すでにそちらにいる場合にどうなるかは[ATOの支払い計画](/ja/blog/ato-payment-plan-tax-debt-australia)にあります。
`,
  },
  ...
  'uber-driver-working-holiday-australia': {
    ...
    body: `
ライドシェアは、オーストラリアのギグワークで最も厳しい税務のルールを背負っています。ABNが必要で、売上にかかわらず最初の運賃からGST登録が必要で、四半期ごとにBusiness Activity Statementを提出しなければなりません。この1ドル目からのGSTのルールがライドシェアをフードデリバリーと分け、思いがけない債務を作ります。

## なぜライドシェアだけ独自のGSTのルールなのか？

旅客の輸送がGST上はタクシー輸送として扱われ、タクシー輸送には登録の基準額がないからです。通常のABNの仕事なら75,000ドル超で必要になるGST登録が、ライドシェアでは稼ぎが500ドルでも50,000ドルでも、最初の運賃から必要になります。

これはUber、Ola、Didi、運賃を受け取って乗客を運ぶあらゆるプラットフォームに適用されます。フードデリバリーや荷物と物流の仕事には適用されず、そちらは標準の基準に従います。その側は[デリバリーのライダー](/ja/blog/uber-eats-delivery-rider-working-holiday-australia)で扱っています。

複数アプリを掛け持ちする人が捕まるルールです。少しでも旅客を運べば登録の義務が発生し、その義務はひとつのアプリではなく事業全体にかかります。

## GST登録は実際に何を求めるのか？

すべての運賃の11分の1はATOのもので、納めるために四半期ごとにBusiness Activity Statementを提出します。同時に事業経費にかかったGSTの控除を申請でき、実質の負担は見出しの割合より低くなります。

実務上、価格にGSTを上乗せすることはありません。運賃はプラットフォームが決め、総額を報告します。義務は、受け取った額のGST部分を納めることと、燃料、整備、部品、車両のファイナンスにかかったGSTの控除を申請することです。実際に走っているドライバーなら、控除後の実質負担は運賃収入の5%から8%あたりに着地するのが典型で、11分の1をまるごと負担するわけではありません。

これを放置することが債務を生みます。報告をせずに6か月走ったドライバーは、受け取ったすべての運賃について遡って責任を負い、形式ではなくかなりの金額になります。

## 報告の期限はいつか？

四半期ごとで、日付は固定です。7月から9月は10月28日、10月から12月は2月28日、1月から3月は4月28日、4月から6月は7月28日です。

税理士を通して提出すると、通常この日付は延びます。ひとつ逃すと、遅れた申告と同じ基準で28日ごとに提出遅延のペナルティが課されます。計算の仕方は[期限後提出のペナルティ](/ja/blog/late-tax-return-penalty-working-holiday)で扱っています。

## そもそも走り始める前に何が必要なのか？

ABN以外に2つです。要件を満たす車両と、州の旅客運送の許可です。車両の要件はプラットフォームが定めており、一般には年式の上限を満たす4ドアのセダン、ハッチバック、SUV、ワゴンで、状態がよく、登録が有効で、車検に相当する基準を満たし、総合保険に入り、プラットフォームの点検を受けたものです。

許可は州の管轄で、通常の運転免許とは別のものです。ニューサウスウェールズ州はPassenger Transport Authorisation、ビクトリア州はCommercial Passenger Vehicleの認定、クイーンズランド州はDriver Authorisation、南オーストラリア州はGeneral Passenger Transport Accreditation、西オーストラリア州はPTDの許可、ACTはPublic Vehicle Licenceを求めます。どれも警察の照会、健康診断、手数料を伴い、その手数料は控除の対象です。

適した車を持たないドライバーはライドシェア用のレンタルを使うこともあり、そのレンタル料も収入に対して控除できます。

## 何を控除できるのか？

バックパッカーのほぼどの仕事より多くを控除できます。車両が事業そのもので、走らせる費用が対象に入るからです。次の一覧はどれも業務按分したうえで申請できます。
...
車両費用は、年5,000キロが上限のセンツ・パー・キロメートル方式か、上限はないが連続12週間の記録が必要なログブック方式のどちらかを通ります。フルタイムのドライバーは数か月で5,000キロの上限を超えるので、ほぼ常にログブックのほうが価値が大きくなります。ログブックに何を書くべきかは[車両ログブック](/ja/blog/vehicle-logbook-abn-working-holiday)で扱っています。

## ATOはすでにあなたの稼ぎを知っているのか？

知っています。プラットフォームはSharing Economy Reporting Regimeのもとでドライバーの収入を直接報告するので、あなたが提出する前から総額はATOのシステムにあり、申告と照合されます。

必要な記録は収入の証明ではなく経費の証明です。収入の記録はすでに存在し、経費の記録はあなたが残したものにしかありません。

## 走りながらいくら取り分けておくべきか？

2つの別の義務に足りるだけです。運賃のGST部分はATOのもので、四半期ごとに納めます。利益にかかる所得税は2つ目の金額で、年度末に査定されます。

どちらもあなたのために源泉徴収されていません。プラットフォームからの入金をまるごと稼ぎとして扱うドライバーは両方を使ってしまい、申告のときではなく最初のBASでそれを知ります。毎週、手をつけない口座に取り分けておくことが、週で稼いで四半期で払う人に確実に機能する唯一の仕組みです。

## 走るのをやめたら何をしなければならないのか？

2つの終了手続きで、たいていどちらもされません。GST登録をキャンセルして最後のBASを提出し、それからABNをキャンセルします。日付は思い出した日ではなく、実際にやめた日です。

開いたままのGST登録は、国を離れた人にも四半期ごとの義務を生み続け、不在のあいだに提出遅延のペナルティが積み上がります。キャンセルの日付より前に片づけておくべきことは[ABNのキャンセル](/ja/blog/how-to-cancel-your-abn)にまとめてあります。
...
家賃が賃金から引かれる場合、それは適法な天引き、つまり書面での合意があり、合理的で、給与明細に表示されているものでなければなりません。決める前に手取りを計算してください。賃金から宿泊費を引き、実際にロスターに入る時間で割り、町の仕事と比べます。判定の基準は[賃金からの天引きが適法になる条件](/ja/blog/uniform-laundry-deductions-illegal-australia)で扱っています。
...
起きるけがは派手なものだけではありません。指導やパトロール中の転倒、リゾートの建物内での滑り、レンタル店での持ち上げによる負傷、夜間の造雪シフトでの寒さによる障害が典型です。シーズンの終わりではなく、起きたその時に報告してください。記録されなかったけがは、あとから立証するのがはるかに難しくなります。枠組みは[職場でのけがと権利](/ja/blog/workplace-injury-working-holiday-rights)で扱っています。
...
真剣に扱う価値がある例外はインストラクターです。指導資格の講座費用、その役職で使うゴーグルや眼鏡、指導に使う自分のスキーやボードは控除の対象で、私用の分は按分します。60%を指導に、40%を自分の滑走に使った用具は60%が控除対象で、その按分は当て推量ではなく、正直で記録されたものである必要があります。3、4か月に凝縮されたシーズンは同じ会計年度の他の収入と並ぶので、[タックスリターン](/ja/tax-return)を作成する前に知っておく価値があります。
`,
  },
...
チェーンはどの都市でも継続的に採用しているので、ほぼ常に選べる控えの選択肢になります。オンライン注文のピッキングとカートの回収は入れ替わりが絶えず、夕方と週末に入れることが応募を見てもらえるかどうかを決めます。
...
静かにお金を失うのは分類のところです。レベル1は標準的な職務、レベル2はより広い責任、レベル3は権限を委ねられて他の人を教える立場をカバーし、等級は在籍期間ではなく実際に何をしているかで決まります。新人を教え、部門を回しながらレベル1に分類されている人は少なく払われており、等級の存在を知らなければ給与明細からは見えません。判定の仕方は[アワードの分類](/ja/blog/award-classifications-working-holiday-australia)にあります。

## 企業協定は何を変えるのか？

対象となる労働者についてアワードを完全に置き換え、基本を上げるだけでなく割増の構造そのものを組み替えます。協定は一般に基本賃率をアワードより高く設定し、ローディングを上下に調整し、休憩や残業のルールも変えます。

守りになるのはBetter Off Overall Testで、各従業員がアワードのもとより協定のもとで全体として有利であることを要求します。承認の際にFair Work Commissionが実際に適用するテストで、日曜のローディングが低い協定でも、基本賃率がそれを十分に補っていれば適法でありえます。だからColesの給与明細をGeneral Retail Awardと比べても何も証明できません。確認すべき文書は協定で、Fair Work Commissionのサイトで公開されています。

## なぜ夜間のシフトはこれほど条件がよいのか？

ローディングが積み上がるからです。夜間の補充は多くの場合22時ごろから朝6時ごろまでで、日中よりかなり高いシフトのローディングが付き、協定によってはその上に日ごとの手当も付きます。

もうひとつの利点は仕事の形です。夜間のシフトは、ホスピタリティによくある分断のパターンではなく、まとまった時間を通しで走ります。8時間の支払いは8時間であって、ランチの営業、4時間の空白、ディナーの営業ではありません。

## 大手チェーンでも何がうまくいかないのか？

ホスピタリティよりはるかに少ないものの、ゼロではありません。大手の給与処理は概して機能し、スーパーは届き、給与明細は明細化され、ロスターは前もって出ます。問題は分類と、割増の構造の縁のところにあります。
...
その場で報告してください。起きた日に店舗の事故記録に書かれたけがは請求を支えます。同じけがを3週間後に持ち出すと、仕事と結びつけるのがはるかに難しくなります。枠組みは[職場でのけがと権利](/ja/blog/workplace-injury-working-holiday-rights)で扱っています。

## スーパーマーケットで働く人は何を申請できるのか？

正直なところ多くはありません。スーパーマーケットの仕事は必要なものの多くを支給するので、実際の控除は滑りにくい靴、支給されなかった指定の衣類、雇用主が洗濯しない場合の支給された制服の洗濯代、酒類売り場で働くために自分で払ったRSAの費用、そしてシフトの連絡に使う電話代の業務按分です。
...
`,
  ...
  'station-hand-cattle-station-working-holiday-australia': {
    ...
    body: `
ステーションの仕事はPastoral Award（MA000035）のもとにあり、セカンドビザのための88日の指定就労に数えられ、ほぼ必ず宿泊と食事が付きます。賃金はそのパッケージを入れるまで都市の仕事より低く見え、混乱の大半もそこにあります。

## その仕事は実際に何をするのか？

家畜と施設を、その季節が求める割合で扱います。馬、バイク、バギーでの集畜、選別、駆虫、焼印、ワクチン接種を含むヤードでの牛の取り扱い、分娩と新生子の世話、フェンス、井戸と水槽の保守、機械とトラクターの操作、敷地全般の維持です。

大きなステーションにはキャンプの調理担当や、少ないもののステーションの事務もあります。何をするかは敷地の種類と地域、季節で変わり、牛のステーションと羊のステーションは別の事業です。

## ステーションはどこにあり、いつ採用するのか？

主な4つの地域が、それぞれ独自のカレンダーで動きます。ノーザンテリトリーはバークリー台地、ビクトリアリバー地区、トップエンド。西オーストラリアはキンバリー、ピルバラ、ミッドウェスト、南部の小麦地帯。クイーンズランドはチャンネルカントリー、北西部、ガルフ。南オーストラリアは北部の遠隔地とエア半島です。

北部は夏と冬ではなく雨季と乾季で動き、集畜は乾季です。南部は暑い夏と涼しい冬で動き、この違いがいつ仕事があるかを決めます。

## Pastoral Awardは何を定めているのか？

分類ごとの最低時給と労働条件です。Farm and Livestock Hand Level 1は監督のもとで基本作業を行う新しい労働者、Level 2はある程度自律的に働く経験者、Level 3は機械を扱うか小さなチームを率いる熟練者で、上はリーディングハンドやヘッドストックマンへ続きます。羊毛刈り、作業場の仕事、大規模作物には別の分類があります。

アワードの賃率は相場ではなく床です。2026年7月1日から、カジュアル最低賃金は時給33.05ドル、全国最低の26.44ドルに25%のローディングを乗せた額です。牧畜の分類は経験が認められるにつれ上がります。企業協定や個別の取り決めで運用するステーションも多いですが、それでもアワードより全体として有利でなければなりません。

## 宿泊と食事込みの取り決めはどう機能するのか？

ステーションはスタッフ用の宿舎か母屋の部屋と、厨房からの食事、遠隔のキャンプでは食料を支給し、それ以外は現金の賃率で払います。これがオールファウンドの取り決めで、地方では標準です。

宿泊と食事が賃金から天引きされる場合、天引きは適法で、アワードが定める限度の内側でなければならず、確認すべきはそこです。実際に提供される場合、本当に遠隔の敷地には遠隔地の付加給付の優遇が適用されることが多く、現金の数字から想像するよりパッケージ全体が税務上有利になりえます。分類によっては家を離れて働く手当も適用されます。

## セカンドビザに数えられるのか？

数えられますが、4つの条件が成り立つ場合です。指定された地方の郵便番号にあること。ステーションのほとんどはそうです。指定就労の区分に入ること。家畜を含む動物の飼育は入ります。有償であること。給与明細とATOへの収入の報告によって記録されていることです。

セカンドビザの申請が失敗するのは仕事の中身ではなく記録です。一部を現金で払うステーションや給与明細を出さない雇用主のもとでは、働いた日は残っても証拠が残らず、入国管理が必要とするのは記憶ではなく証拠です。

## そこでけがをしたらどうなるのか？

労災補償は、遠隔でも勤続が短くても、ステーションのすべての従業員と搬送の費用をカバーします。最寄りの病院まで飛行機という場所では大きな意味を持ちます。医療の治療、働けない間の週ごとの支払い、後遺障害に対する一時金を支払います。

ステーションの仕事は多くの産業よりけがの発生率が高くなります。蹴られる、挟まれる、落ちるといった動物の取り扱い、荒れた地面での車両と機械の事故、熱中症、ヘビとの遭遇、そのどれをも悪化させる孤立です。Royal Flying Doctor Serviceが唯一の医療へのアクセスであることもあります。請求の進み方は[職場でのけがと権利](/ja/blog/workplace-injury-working-holiday-rights)で扱っています。

## ステーションハンドは税金の時期に何を申請できるのか？

他の多くの職種より多く申請できます。ステーションハンドは本当に装備を用意するからです。作業靴と乗馬用のブーツ、保護のための帽子、長袖の作業着と日焼け対策、手袋、ナイフやフェンス用の工具、自分の鞍と馬具です。

基準は、その品が私用ではなく主に仕事のためかどうかです。フェンス用のペンチなら分かりやすく、休みの日にもかぶる帽子は違います。2026年7月1日からは領収書なしの定額1,000ドルの業務関連控除も使え、多くの場合は個別に積み上げるより簡単です。

## 仕事を受ける前に何を決めておくべきか？

条件を書面にしておくことです。最寄りの町から4時間の敷地に着いてから交渉し直すのは現実的ではありません。分類と時給、宿泊と食事が提供されるのか天引きされるのか、天引きの金額、想定される時間と日数、支払いの方法と時期を確認してください。

給与明細とスーパーアニュエーションは名指しで尋ねてください。どちらも厚意ではなく法律上の要件で、そこで言葉を濁す敷地は、まだ動けるうちに役に立つことを教えています。セカンドビザが行く理由の一部なら、その郵便番号が指定就労の対象かも確認してください。

## 孤立は正しく支払われることにどう影響するのか？

ルールではなく、確認の難しさが変わります。携帯の電波は途切れ、銀行の手続きも断続的で、インターネットが1日1時間しか使えない場所では、給与明細をアワードの条項と突き合わせるのは別の作業です。

だから給与明細は届くたびに写真を撮り、最初の週から日々の労働時間を記録します。敷地を離れたあとで集畜シーズンの4か月を組み立て直すのはほぼ不可能で、賃金の争いが記憶と記憶の対立になるのはそのためです。

## その敷地の取り決めで何が変わるのか？

アワードはどの敷地でも同じで、いくら支払われ実際にどれだけの価値になるかは、その敷地の取り決めで決まります。受ける前に次の点を確認してください。

- 実際の職務がどの分類に対応するか。Level 1とLevel 3では賃率が違います
- アワードのかわりに企業協定が適用されていないか
- 宿泊と食事が提供か天引きか、天引きがアワードの限度の内側か
- その敷地が付加給付の優遇が適用されるほど遠隔か
- 郵便番号と仕事の種類が88日の対象で、しかもそれが記録されているか
- 給与明細が発行されたか。ビザの証拠と賃金の請求の両方が決まります
- 現金部分に対して12%のスーパーアニュエーションが払われたか

その年は[ワーホリのタックスリターン](/ja/tax-return)で精算します。源泉徴収された額が分かれば[還付金の試算](/ja/calculator)ができます。
`,
  },
  ...
  'what-is-medicare-working-holiday-makers': {
    ...
    body: `
多くの場合、使えません。[メディケア](/ja/medicare)はオーストラリアの市民と永住者のための公的医療制度で、417・462ビザはどちらにもあたりません。例外を決めるのはビザではなくパスポートです。相互医療協定（RHCA）を結ぶ11か国の国民には限定的なカバーがあり、それ以外は自費で医療を受けます。日本はこの11か国に入っていません。
...
パスポートが日本、ドイツ、フランス、韓国、台湾、カナダ、アメリカ、イスラエル、チリなどであれば協定はなく、メディケアもありません。これはワーキングホリデーメーカーのおよそ3分の2にあたり、日本市場とドイツ市場はまるごとこちら側です。どちらの方向にも勘違いが起きるので、[協定国の一覧](/ja/blog/countries-with-medicare-agreement-australia)を確認してください。
...
免除の申請は[ワーホリのタックスリターン](/ja/tax-return)の一部として行います。免除ありとなしの差が自分の収入でいくらになるかは[還付金の試算](/ja/calculator)で見られます。
`,
  },
  ...
  'countries-with-medicare-agreement-australia': {
    ...
    body: `
11か国です。オーストラリアは英国、アイルランド、ニュージーランド、スウェーデン、オランダ、フィンランド、ノルウェー、ベルギー、スロベニア、マルタ、イタリアと相互医療協定（RHCA）を結びます。これらの国の国民で有効なワーキングホリデービザを持つ人は、限定的な[メディケア](/ja/medicare)の給付を利用できます。それ以外の国の国民は利用できず、日本はこのリストに入っていません。
...
協定のないドイツや日本の旅行者は、[メディケア税の免除](/ja/blog/medicare-levy-working-holiday-makers)がたいてい使え、25,000ドルの収入に対して約500ドルの価値があります。英国やアイルランドの旅行者には、この税がそのまま適用されます。同じ収入、同じビザ、違うパスポート、違う査定です。
...
メディケア税の扱いは[ワーホリのタックスリターン](/ja/tax-return)を提出した時点で確定します。2%が自分の収入でいくらになるかは[還付金の試算](/ja/calculator)で確認できます。
`,
  },
  ...
  'medicare-levy-working-holiday-makers': {
    ...
    body: `
多くの場合、払う必要はありません。2%のメディケア税はメディケアの受給資格がある人に課されるもので、417・462ビザ保持者の多くは資格がないため適用されません。25,000ドルの収入なら約500ドルにあたります。ただし自動的に外れるものではなく、お金が失われるのはそこです。

## 免除を受けられるかどうかを決めるのは何か？

あなたのパスポートと、ほとんどのバックパッカーが存在すら知らない1枚の書類です。決め手はメディケアの受給資格があるかどうかで、その資格は相互医療協定（RHCA）を結ぶ11か国のパスポートから生じます。英国、アイルランド、ニュージーランド、イタリア、マルタ、オランダ、ベルギー、フィンランド、ノルウェー、スウェーデン、スロベニアの11か国です。

日本、ドイツ、フランス、韓国、台湾、カナダ、アメリカ、その他の国はこのリストに載っていないので、その国民には免除がたいてい適用されます。これはワーキングホリデーメーカーの大多数をカバーしており、そもそも課されるべきではなかったお金です。
...
この書類は発行までに6週間程度かかることが多く、そのリードタイムがこの免除の実務上の問題のすべてです。多くの人は10月にその存在を知り、申告期限が目前なので、6週間の手続きを始めるより約500ドルを静かにあきらめます。提出のことを考える前、7月のうちに申請してください。

## 実際にいくらの価値があるのか？

課税所得の2%なので、定額ではなく稼いだ額に応じて増えます。
...
答えはたいてい逆になります。11の協定国のいずれかのパスポートを持っている場合、登録したかどうか、実際に使ったかどうかにかかわらず、原則としてメディケアの受給資格があるとされます。決め手は利用実績ではなく資格です。

したがって英国やアイルランドの旅行者の多くにとって免除は選択肢から外れ、この税は査定の一部としてそのまま適用されます。それでも部分的なケースはあり、年度の途中で資格が生じた人や事情が変わった人は、資格がなかった期間について免除を受けられます。その場合は日付が正確である必要があります。
...
メディケア税免除は、自分で提出したワーホリの申告書で最も見落とされる項目のひとつです。年度ごとに別々に確認してください。2年の滞在は2通の申告、2通の書類、2回の修正の可能性を意味します。

## 2%の免除を申請できる側にいるのか？

この免除は25,000ドルの収入に対して約500ドルの価値があります。申請できるかどうかを決めるのは次の点です。

- あなたのパスポート。受給資格を決め、したがって問い全体を決めます
- 年度の途中でメディケアに登録したかどうか。カバーがなかった期間について部分免除になります
...
`,
  ...
  'tax-file-number-declaration-form': {
    ...
    body: `
Tax File Number Declarationは、新しい雇用主が正しい税率で源泉徴収できるように渡す書類です。税金を決めるのは、その中の3つの答えです。税務上オーストラリアの居住者かどうか、ワーキングホリデーメーカーかどうか、そして免税枠を申請するかどうか。それ以外の欄はすべて本人確認です。
...
お金が実際に決まるのはTFNの申請ではなく宣言書のほうです。申請は無料で10分の行政手続きです。給与明細を変えるのはこの書類で、手渡されるのは初日、たいてい最もそれを考える余裕がないときです。

## 3つの答えは何をするのか？

それぞれの答えが税率を別の場所へ動かします。誤った組み合わせのうち2つは、あとから戻ってくる遅れではなく、あとから払う債務を生みます。
...
それでも宣言書は記入でき、それが28日の期間の意味です。申請中であることをリファレンス番号とともに記録すれば、その期間はワーキングホリデーメーカーの税率が維持され、初日から45%で始まることを避けられます。

何も言わなければ高い税率がその場から適用され、45%の週が1週間続くたびに、給与が申告まで戻ってこない形でATOに置かれます。その間に雇用主へ何を渡せばよいかは[TFNが届く前に働く](/ja/blog/tfn-reference-number-before-tfn-arrives)で扱っています。

## 1枚の書類ですべての仕事をカバーできるのか？

できません。短期のカジュアルでも2週間の収穫の仕事でも、雇用主ごとに宣言書が必要です。ある給与システムに渡したTFNが別のシステムに共有されることはなく、前の雇用主が書類を持っていても新しい雇用主には効果がありません。

雇用主が複数の年が高い頻度で狂うのは、この機械的な理由です。仕事が4つなら宣言書も4枚で、記入されなかった1枚がたいてい45%で源泉徴収している場所であり、提出のときに収入を忘れられる仕事でもあります。
...
多くの人にとってはワーキングホリデーメーカーという答えが正しく、居住性の欄も素直です。長く滞在している人にはそうとは限らず、推測で答えると裏目に出やすい欄です。なぜ判定が難しいのかは[ワーキングホリデーメーカーの居住性判定](/ja/blog/tax-residency-working-holiday-makers)にあります。

## 間違って記入してしまった場合はどうするのか？

修正した宣言書を雇用主に提出します。給与システムはさかのぼらず、その時点から先が更新されるので、修正は今後の給与を直し、それ以前の差は申告で精算されます。

取りすぎていた場合は還付の一部として戻ります。免税枠を申請したせいで少なすぎた場合、その不足は納付になります。それを10月ではなく7月に知れば、備える時間ができます。修正したあとは効いているはずだと考えず、次の給与明細を確認してください。

## 署名した時点で何が決まっていたのか？

書類は短いものですが、いくらの負担になるかは署名した時点の状況で決まります。次の点が、年度末に還付になるか納付になるかの差です。
...
- 雇用主がワーキングホリデーメーカーの雇用主としてATOに登録されているか。未登録なら書類が正しくても外国人居住者の税率です
...
年度末に誰かが記入する書類ではなく、雇用主の給与ソフトから来ます。Single Touch Payrollのもとでは、給与計算のたびに総支給額、源泉徴収税、スーパーアニュエーションがオーストラリア税務署（ATO）へ報告されており、インカムステートメントはその報告の累計です。

その記録は前の雇用主ではなくATOのシステムに属しています。メールに返事をしなくなったミルデュラの農園も、あなたの賃金はすでに報告しており、その数字は相手を通さずに取り寄せられます。

## いつから使えるようになるのか？

年度は6月30日に終わり、雇用主は7月14日ごろから確定作業を始め、多くは7月31日までに終えます。確定するまで、明細は年度累計の数字を表示しますが、完全であるとはまだ宣言されておらず、確定すると状態がTax readyに変わります。

Tax readyでない明細に対して提出することは、誤った査定とあとからの修正を招く最も確実な方法です。数字はまだ変わりうるので、変われば申告はATOの保有する内容と一致しなくなります。

## 確認すべき3つの数字は何か？

総支給額、源泉徴収税、その横に表示されるスーパーです。この3つが、あなたの1年が本来どおりに課税されたかどうかを教えてくれます。
...
雇用主の抜けは最も多い不備で、原因は3つあり、それぞれ対応が違います。まだ確定していないだけなら、待てば解決します。誤った氏名や生年月日で報告されている場合、記録は存在するのにあなたに紐づいていません。賃金をまったく報告していない場合が、現金払いのケースです。
...
明細の誤りは、給与明細に合わせて申告を調整するのではなく、雇用主が訂正します。よくあるのは、合わない総額、誤った居住区分を反映した源泉徴収の数字、給与システムの入れ替え後に重複した給与期間です。

雇用主が対応する場合、訂正は給与サイクルの1、2回のうちに行われるのが普通です。対応しない場合、裏づけのある見積もりで提出し、報告が直ったあとに修正できます。修正には2年の期間があります。うまくいかないのは、ATOが保有していない数字を黙って使うことで、それが申告を手動の確認に回す不一致になります。

## 申告がどれだけ完全になるかを決めるのは何か？

その年のすべての雇用主が特定されたかどうかです。ワーキングホリデーの1年は、2つの州にまたがる3社、4社、5社になることが普通で、2つの会計年度にまたがることもよくあります。人が忘れるのはほぼ必ず短いほうです。2月の3週間のパッキング、2週間の販促の仕事、派遣で入った1シフト。

そのすべてを勘定に入れずに提出することが最も多い誤りで、両方向に働きます。源泉徴収の重かった忘れられた雇用主は、請求しなかった還付です。申告しなかった収入のある忘れられた雇用主は、あとからの修正と利息です。当社が[タックスリターン](/ja/tax-return)を作成するとき、先に完全な一覧をATOのシステムから取り寄せるのは、移動し続けた1年について記憶が当てにならないからです。

## 自分で残しておくべきものは何か？

給与明細、賃金の入金が分かる銀行明細、賃率について書面で残っているものです。インカムステートメントは何が報告されたかを教えます。報告された内容が本来支払われるべき額かどうかを教えるのは、あなた自身の記録だけです。

この区別が最も効くのは、ファーム仕事とホスピタリティです。報告された数字が、賃金の未払いの記録として完全に正確なことがありうるからです。申告は報告された数字で作成しますが、その差は知っておく価値があります。Fair Workを通した回収は、別の、しかも無料の手続きです。

## 明細の1枚が自分の申告に何を意味するのか？

次の点が、いつ提出できるかと、その年の還付がいくらになるかを決めます。
...
すべてはタックスファイルナンバーを経由します。ATOが番号を発行し、すべての賃金報告、すべてのスーパー拠出、オーストラリアの口座の利息、提出したすべての申告書をつなぐ糸として使います。

より広い所管は、所得税、GST、事業者登録、スーパーアニュエーション保証制度などをカバーします。そのほとんどはバックパッカーに直接触れず、多くの人にとっては上の四つの接点がすべてです。
...
給与明細が1枚もなくても別の国から申告できるのはこのためです。報告を確定させないまま放置した雇用主が本当の問題を作る理由でもあります。収入は存在し、あなたも知っているのに、ATOの記録には現れない。その差を埋めるのがあなたの給与明細です。

## ATOから連絡が来るのはどんなときか？

ワーキングホリデーメーカーのほとんどは直接連絡を受けません。連絡が来るのは、申告を処理するために追加の情報が必要なとき、ATOの数字が申告内容と一致しないとき、納税額が未払いのとき、本人確認が還付を止めているとき、そしてまれに調査が始まったときです。

正当な連絡は登録住所への郵送か、あなたの代理人である税理士を通じて来ます。古い住所が重大なのはこのためで、見なかった手紙も受け取ったものとして扱われます。

## 本物の連絡と詐欺はどう見分けるのか？

何を求められ、どれだけ急かされているかで見分けます。ATOは電話で即時の支払いを要求しませんし、ギフトカードや暗号通貨での支払いを受け付けず、逮捕や国外退去をほのめかすこともせず、店に行く間ずっと電話をつないでおくよう求めることもありません。

ワーキングホリデーメーカーはこれを狙って標的にされています。この国に来たばかりで、何が普通かがわからず、ビザに問題が起きるという脅しが、地元の人とは違う説得力を持つからです。正しい対応は電話を切り、自分で確認し直すことです。

## スーパーを取り戻す過程でATOはどんな役割を担うのか？

多くの場合、支払う側ではなく門番です。DASP（出国時のスーパー支払い）が請求されると、ATOはビザが終了していることと出国していることを確認し、請求はスーパーファンドに渡され、ファンドが65%の源泉徴収を適用して残高を放出します。

例外は、ATOがすでに保持しているスーパーです。ファンドがあなたとの連絡を失った場合、残高は未請求スーパーとしてATOに移管され、その場合はATOが直接支払います。住所を更新しないまま半年以上前にオーストラリアを離れた人は、その状態の可能性が十分あります。どちらの経路も[出国後のスーパー受取](/ja/superannuation)にまとめてあります。

## オーストラリア税務署が持つ記録は最新か？

四つの定型的なやりとりが円滑に進むかどうかを決めるのは、ATOが保持しているあなたの記録の状態です。
...
`,
  ...
  'gross-pay-vs-net-pay-australia': {
    ...
    body: `
グロス（Gross Pay）は税引き前に稼いだ額、ネット（Net Pay）は銀行口座に届く額です。TFNが登録されたワーキングホリデービザなら、その二つの間にあるのはグロスの約15%です。スーパーアニュエーションはこの差の一部ではありません。賃金から引かれるのではなく、上に乗せてファンドに支払われます。

## 給与明細の数字はそれぞれ何を意味するのか？

オーストラリアの給与明細は四つの数字を分けて表示します。二つを取り違えることが、未払いでないのに未払いだと結論する原因です。グロスは時間×レートに割増、ローディング、手当を足したもの。源泉徴収税額は雇用主があなたの名前でATOに送る額。ネットはグロスから源泉徴収を引いたものです。
...
登録されたワーキングホリデーメーカー雇用主のもとでグロス1,000ドルの賃金なら、15%の150ドルが源泉徴収され、850ドルが口座に入り、12%の120ドルのスーパーがファンドに行きます。スーパーはその850ドルには現れません。

## なぜスーパーは控除ではないのか？

スーパーアニュエーションは賃金の上に乗る雇用主のコストで、賃金の一部を切り取ったものではないからです。通常の所定収入に対して12%で計算され、あなたの名前のファンドに支払われます。雇用主が払うことを覚えていようといまいと、グロスは同じです。到着したばかりの人が給与明細を読み違える最も多いパターンです。

給与明細でスーパーがグロスから差し引かれているなら、表示の癖ではありません。給与計算の誤りか、賃金にスーパーが含まれるものとして扱う雇用主かのどちらかで、どちらも受け取るべき額を変えます。対処は[スーパーが支払われていない場合](/ja/blog/super-employer-not-paying-what-to-do)にあります。
...
銀行アプリで1年を追いかけていた人がここで戸惑います。口座に届いた数字はATOが使う数字のおよそ85%なので、その1年は銀行の側から見るといつも小さく見えます。

## グロスのうちどれだけ手元に残るかを決めるのは何か？

グロスとネットの差を決めるのは自分の1年に関する三つの事実で、どれも固定されていません。最大のものが源泉徴収レートです。登録済みのワーキングホリデーメーカー雇用主のもとでTFNが登録されていれば15%、TFNがなければ45%、雇用主がワーホリ雇用主として登録していなければ外国人居住者レート。同じグロスでも、まったく違うネットになります。
...
グロスを一から組み立て直す作業は5分ほどで終わり、シフトを覚えているうちに雇用主ごとに一度やっておく価値があります。
...
数字が合わない場合、原因はたいてい意図的な搾取ではなく、アワード上の職分がひとつ低く設定されていることです。書面で給与担当に提起する価値があり、雇用主が素早く直すのもこのパターンです。

## どこから先は給与明細の問題ではなくなるのか？

その差が、計算ではなくあなたの税務上の位置づけによって生じた瞬間からです。45%での引かれすぎ、未登録の雇用主、受給資格のない人に課されたメディケア税、そして誤って答えた居住性の項目。どれも年度中のネットを小さくし、申告で戻るかどうかが決まります。

給与明細は引かれた額を示しますが、それが引かれるべきだったかについては何も言いません。自分の1年にどれが当てはまったのかを突き止めることが[タックスリターン](/ja/tax-return)の目的であり、同じグロスの二人が数千ドル違う着地になる理由です。
`,
  },
  ...
  'do-working-holiday-makers-pay-tax-on-tips': {
    ...
    body: `
かかります。チップはどんな形で届いても、オーストラリアでは課税対象の所得であり、給与と並んでワーキングホリデーメーカー税率の、最初の45,000ドルまで15%で課税されます。変わるのは課税されるかどうかではなく誰が報告するかで、それはチップがどう手元に届いたかで決まります。

## すでに報告されているチップはどれか？

店のレジを通ったものは、あなたが何もしなくてもATOに届きます。カードのチップ、伝票に加算されるサービス料、トロンクの取り決めで分配されるプール制のチップは、いずれも給与計算を通るのでPAYGが源泉徴収され、年度末の所得明細に賃金と一緒に載ります。

その部分は報告も納税も済んでいます。やることは、給与明細でチップが別の行になっているか、総支給に吸収されているかを見るだけです。分配していると言うのに、どの給与明細にも何も現れない店は、尋ねてみる価値があります。

## 自分で申告すべきチップはどれか？

直接手渡された現金です。誰も記録せず、PAYGも源泉徴収されず、所得明細にも現れないので、申告する義務は会計年度末のあなただけにあります。

どれだけ重要かは金額で決まります。静かな郊外のカフェなら現金のチップはほとんど発生しません。金曜と土曜の夜に忙しい都心のバーなら、シーズンを通じて意味のある金額になり、申告するかしないかの差が[タックスリターン](/ja/tax-return)の上で実際のお金になります。
...
累計が分かれば十分です。ATOはチップを1件ずつ記録することを期待しておらず、日付と店名を添えた週ごとの金額を消えない場所に書いておけば記録の要件を満たします。

そうしなければ、3月に終わったシーズンについて10月に当て推量することになります。何も申告しない人は、たいてい金額が分からず、いちばん安全そうに見える答えがゼロになるだけです。携帯のメモひとつでこの問題は消えます。

## 現金のチップを申告しないとどうなるのか？

提出した翌週に確認の手紙が届く、という形のリスクではありません。ホスピタリティはデータ照合の対象業種で、申告されなかった収入は、すぐにではなく、店単位の報告や銀行入金のパターンを通してあとから表に出ます。

帰結は、本来払うべきだった税金に加えて、不足に対するペナルティと利息がその年度に課されることです。一方、1シーズン分のチップを15%で申告したときの税額は、多くの人が計算する前に思っているより小さくなります。セカンドやサードの年を考えている人には実務的な論点もあります。未解決のATOの状態は、今後のあらゆる行政手続きに持ち込む、ほどけていない糸だからです。

## チップにスーパーは付くのか？

付くこともあり、税の報告と同じ区別で決まります。雇用主の給与計算を通して分配されるチップは通常労働収入の一部になりえて、その場合は給与の他の要素と同じように12%の[スーパー](/ja/superannuation)が発生します。客が手渡した現金は雇用主が払ったものではないので、スーパーの義務は付きません。

どちらになるかは、アワードと、その店が支払いをどう分類しているかによります。役に立つ確認は、トロンクの分配も含めた総収入と、スーパーの拠出額が整合しているかを見ることです。差があれば、それは[スーパーが払われていない](/ja/blog/super-employer-not-paying-what-to-do)場合と同じ話になります。

## 自分から書き足す金額は残っているのか？

チップに税金がかかるかどうかは変数ではありません。変数なのは、誰がそれを報告し、あなたの側に何が残るかです。次の点が、その年の申告で自分から書き足すべき金額があるかを決めます。
...
- [DASP（出国時のスーパー支払い）](/ja/superannuation)でスーパーを請求する
- 個人事業主として登録した[ABN](/ja/abn)を取り消す
...
標準の期限は会計年度終了後の10月31日です。登録税理士を通じて提出した申告には、原則として翌年5月まで延長された期限が適用されます。手順は[海外からの申告](/ja/blog/how-to-lodge-tax-return-from-overseas)にまとめてあります。
...
実際に人が損をするのは、ファンドが複数あるのに覚えている一つだけに請求するパターンです。1年で雇用主が4社いればファンドが複数あることは多く、それぞれが別の残高と別の請求を必要とします。探し方は[紛失したスーパーの見つけ方](/ja/blog/how-to-find-lost-superannuation)にあります。
...
利息もあなたのものです。このルールの目的は、雇用主が正しく期限内に払っていた場合の状態を回復することなので、あなたが得ていたはずの運用益は補われます。ファンドではなくATOが保有している場合でも、帰国時の[DASPの請求](/ja/superannuation)の対象になります。
...
分岐が2つあります。給与明細にスーパーの行がない場合、たいていは雇用主があなたを請負業者として扱っており、その場合の問題は未払いのスーパーではなく[分類が正しいかどうか](/ja/blog/employee-vs-contractor-australia)です。一度もログインしたことのないファンドの口座は、見ていないだけで入金を受けているかもしれません。最悪を想定する前に確認してください。
...
機能する組み合わせは両方持つことです。賃金、税金の還付、スーパーを受け取るオーストラリアの銀行口座と、お金を母国に動かす送金サービスです。税務上の扱いは[オーストラリアからの海外送金](/ja/blog/transferring-money-overseas-australia-tax)で扱っていますが、要するに何もありません。
...
ワーキングホリデーメーカーは意図的に狙われます。来たばかりの人はATOからの正常な連絡を知らず、ビザへの脅しは、そのビザがここにいる理由である人に強く刺さるからです。迷ったら、そのメッセージに反応せず別の経路で確認してください。誰に情報を尋ねる資格があるかは[TFNを詐欺から守る](/ja/blog/tfn-security-protect-from-fraud)にあります。
...
出国するすべての旅行者が利用でき、ワーキングホリデーメーカーも含まれます。ビザで資格は変わらず、利用してもタックスリターンや[スーパー](/ja/superannuation)の請求に影響しません。
...
TRSは、オーストラリアを離れる手続きで唯一、後からやり直せない部分です。ゲートを通過した時点で請求は永久に消えます。一方で[タックスリターン](/ja/tax-return)もDASPのスーパー請求も、数か月後に自宅から提出できます。
...
問われるのは資格であって、登録したかどうか、医者にかかったかどうかではありません。診療所に一度も近づかなかった英国のバックパッカーにも資格はあり、この税は適用されます。ドイツや日本の国民は逆で、協定がなく原則として資格がないので、書類を揃えれば免除を申請できます。該当する人向けの免除の手続きは[ワーホリのメディケア税](/ja/blog/medicare-levy-working-holiday-makers)にまとめてあります。
...
州の安い救急車のカバーは、年に数十ドルで最も起こりやすい高額請求に対処できます。英国のバックパッカーが買えるもののなかで、いちばん割の良い買い物です。どの商品がどの穴を埋めるかは[旅行保険とOVHCの違い](/ja/blog/travel-insurance-vs-health-insurance-working-holiday)にあり、この二つは互換ではありません。
...
部分年度のケースは指摘する価値があります。3月に到着した人は到着時から資格があり、それ以前にはありません。11月に出国した人はその部分だけです。この日付を[タックスリターン](/ja/tax-return)で正しく扱うことには実際のお金の価値があり、急いで作られた申告書が丸めて間違えがちな細部です。
`,
  },
  ...
  'german-european-health-insurance-australia-working-holiday': {
    ...
    body: `
使えません。ドイツはオーストラリアと相互医療協定を結んでいないので、ドイツのワーキングホリデーメーカーは[メディケア](/ja/medicare)の受給資格がなく、治療費は自費になります。同じ事実が税金の時期にも効きます。受給資格がないことが、2%のメディケア税の免除を使える条件だからです。
...
ドイツはこの一覧にありません。フランス、スペイン、オーストリア、スイス、アメリカ、カナダ、日本も入っていません。協定が実際に何をカバーするかは一様ではなく、詳しくは[メディケア協定のある国](/ja/blog/countries-with-medicare-agreement-australia)で扱っています。
...
実際には、総合的な旅行保険か、民間の健康保険で購入するOverseas Visitors Health Cover（OVHC）か、その両方でこれを満たしています。旅行保険はキャンセルや本国搬送を含む幅広いリスクをカバーしますが、多くは12か月が上限です。OVHCは国内の医療のために作られ、滞在中は無期限に更新でき、医療以外の旅行リスクはカバーしません。どちらがどの穴を埋めるかは[旅行保険とOVHCの比較](/ja/blog/travel-insurance-vs-health-insurance-working-holiday)にあります。
...
免除は自動ではありません。申告書で申請し、Services Australiaが発行するMedicare Entitlement Statementが必要で、申請する会計年度ごとに別々の書類が要ります。発行には数週間かかることが多く、多くの人が一度も手にしないのはこのためです。この書類の存在を知るのが、申告期限が目前の10月だからです。手続きは[メディケア税](/ja/blog/medicare-levy-working-holiday-makers)で扱っています。
...
2週間の旅行よりワーキングホリデーで重くなるのは、働く場所が理由です。ファーム仕事、建設、ステーションの仕事には実際の身体的リスクがあり、しかも大きな病院から数百キロ離れた場所へ人を連れて行く仕事です。保険なしで受診するといくらかかるかは[メディケアなしでの救急医療](/ja/blog/emergency-medical-care-working-holiday-no-medicare)で扱っています。
...
ビザ以上に変わります。オーストラリアは11か国と相互医療協定を結んでおり、その国民は[メディケア](/ja/medicare)に登録して、滞在中に医学的に必要な治療で公的制度を使えます。
...
[タックスリターン](/ja/tax-return)に影響するのはメディケアの受給資格そのものです。2%のメディケア税はメディケアの受給資格がある人に課されるので、協定国以外のパスポートを持つ人はたいてい[メディケア税の免除](/ja/blog/medicare-levy-working-holiday-makers)を申請でき、公的制度を使える英国やアイルランドのパスポートを持つ人はたいてい申請できません。免除は自動ではなく、Services AustraliaのMedicare Entitlement Statementが必要で、取得に数週間かかります。資格のある人の多くが一度も申請しない理由です。
...
`,
  ...
  'emergency-medical-care-working-holiday-no-medicare': {
    ...
    body: `
オーストラリアの公立病院は、[メディケア](/ja/medicare)も保険もお金もなくても緊急時には治療し、そのうえで自費の患者として請求します。その請求書を抱えきれるかを決めるのはパスポートと保険で、どちらも救急車を呼ぶより前に決まっています。
...
11か国とは、英国、アイルランド、ニュージーランド、イタリア、マルタ、オランダ、ベルギー、フィンランド、ノルウェー、スウェーデン、スロベニアです。英国のバックパッカーは、ドイツ、日本、フランス、カナダのバックパッカーが持たない公的制度への入口を持って到着します。同じ受給資格が、税金の時期には[メディケア税の免除](/ja/blog/medicare-levy-working-holiday-makers)を外します。病院でカバーされる国の国民が、[タックスリターン](/ja/tax-return)で2%を払う国の国民です。
...
結果は医療の記録の先にも及びます。長く働けない期間はその年の収入を変え、たいてい還付を小さくではなく大きくします。予定より早く出国すれば、[スーパー](/ja/superannuation)の位置づけとDASPのタイミングも変わります。回復がビザの期限を越えそうなら、早めにHome Affairsに持ち出すべき別の問題です。待つことが本当に選択肢を減らす数少ない領域です。
...
仕事中の保障の答えは、ほぼ決して旅行保険ではありません。労災補償の請求が実際にどう進むかは[職場でのけがと権利](/ja/blog/workplace-injury-working-holiday-rights)にあります。

## メディケアはどこに位置するのか？

受給資格のある人にとってだけで、その資格はパスポートに従います。英国とアイルランドを含む相互医療協定11か国の国民は、原則としてメディケアの受給資格があり、登録できます。

それ以外の人、ドイツと日本のパスポートを含めて、原則として受給資格はありません。その人たちにとって保険はメディケアへの上乗せではなく、労災補償の外にある安全網のすべてです。そして同じ受給資格が、申告書の2%のメディケア税も決めます。受給資格があれば払い、なければ免除を申請できます。その側は[メディケア税](/ja/blog/medicare-levy-working-holiday-makers)で扱っています。
