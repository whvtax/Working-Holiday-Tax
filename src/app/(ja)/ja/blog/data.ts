...
誰に頼むにせよ、避けたいものが1つあります。還付金の何%という成功報酬型の料金です。金額が大きくなるほど作成した側の取り分が増えます。当社の[料金](/ja/tax-return)は作業を始める前に固定額でお伝えし、還付金から差し引くことはありません。還付金が当社の料金を下回った場合は、差額を返金します。
...
給与明細が揃っていなくても、収入の記録はATO側に残っています。[お問い合わせ](/ja/contact)いただければ、提出前に全雇用主の源泉徴収を確認します。還付金が当社の料金を下回った場合は、差額を返金します。
`,
  },
...
[お問い合わせ](/ja/contact)いただければ、すべての雇用主の源泉徴収を確認したうえでお答えします。当社では、当チームが申告書を作成し、提出前に登録税理士が確認し署名します。還付金が当社の料金を下回った場合は、差額を返金します。
`,
  },
...
料金は事前に固定額でお伝えします。成功報酬や還付金からの差し引きはありません。オーストラリアの一部の事業者が使う「還付金の◯%」という方式は、還付が大きいほど手数料も膨らむので、比較の際に確認する価値があります。還付金が当社の料金を下回った場合は、差額を返金します。
