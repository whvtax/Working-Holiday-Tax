...
const FAQS = [
  ...
  },
  {
    ...
    answer: '料金は、当社チームによる確定申告の全面的な確認作業に対するものであり、結果によって変わることはありません。還付や課税額はATOが決定するため、料金の返金はできません。すべてのワーホリの1年に還付が出るわけではありませんし、見込みが薄いのであれば、引き受けて期待させるより先にお伝えします。',
  },
  {
