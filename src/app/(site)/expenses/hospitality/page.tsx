...
const UI = {
  ...
  "guaranteeHeading": "The fee covers a full review of your tax return by our team and is not dependent on the outcome. Refunds and assessments are decided by the ATO, so the fee is non-refundable.",
