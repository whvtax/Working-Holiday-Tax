...
export async function POST(req: NextRequest) {
  try {
    ...
    // All file URLs pre-uploaded by prior requests
    ...
    const bankUrl = formData.get('bankStatementUrl') as string | null
    const fileUrls = [
      ...(bankUrl && bankUrl.startsWith('https://') ? [bankUrl] : []),
      ...allUrls,
    ]
    ...
    console.error('[tax-form/finalize] FAILED:', err)
