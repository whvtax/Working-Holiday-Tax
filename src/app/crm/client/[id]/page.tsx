        ...
        <div className="cp-overlay">
          <div className="cp-modal">
            ...
            <p className="cp-modal-text">
              This will permanently delete: email, address, TFN, bank details, employer, and documents.<br/><br/>
              <strong>Kept:</strong> full name, date of birth, WhatsApp.
            </p>
      ...
      {showHandle && (
        <div className="cp-overlay">
          <div className="cp-modal">
            ...
            <p className="cp-modal-text">This client will move to the Handled tab and be removed from the Pending list.</p>
            <div className="cp-modal-btns">
      ...
      <div className="cp">
        ...
        <div className="cp-profile">
          ...
          <div>
            ...
            <div className="cp-meta">
              ...
              {client.handled
                ? <span className="cp-tag-d">✓ Handled</span>
                : <span className="cp-tag-p">⏳ Pending</span>
              }
            </div>
        ...
        <div className="cp-grid">
          <Section title="Personal details">
            ...
            <Row label="Marital status" value={client.marital} field="marital"   editing={editing} form={form} setForm={setForm}/>
          </Section>
          ...
          <Section title="Tax & employment">
            <Row label="TFN 🔒"        value={client.tfn}         field="tfn"         editing={editing} form={form} setForm={setForm} ltr sensitive/>
            <Row label="Bank details 🔒" value={client.bankDetails} field="bankDetails" editing={editing} form={form} setForm={setForm} ltr sensitive/>
            <Row label="Primary employer" value={client.primaryJob} field="primaryJob"  editing={editing} form={form} setForm={setForm}/>
...
function Row({label,value,field,editing,form,setForm,type='text',ltr=false,sensitive=false}:{
  label:string;value:string;field:string;editing:boolean
  form:Record<string,unknown>;setForm:(f:Record<string,unknown>)=>void
  type?:string;ltr?:boolean;sensitive?:boolean
}) {
  return (
    <div className="cp-row">
