...
const S = {
  ...
  sbTitle: { fontSize:13.5, fontWeight:650, color:'#fff', lineHeight:1.2 },
  sbSub: { fontSize:9, fontWeight:500, color:'rgba(255,255,255,0.5)', marginTop:2, letterSpacing:'0.6px' },
  ...
  main: { flex:1, background:'#f7f8fa', marginLeft:260, height:'100vh', overflowY:'auto' as const },
