...
const CATEGORY_INTRO: Record<string, CategoryIntro> = {
  ...
  'abn': {
    paragraphs: [
      ...
      'Sie sind für alle, die von einer Farm, einer Lieferplattform oder einem Gastrobetrieb aufgefordert wurden, eine ABN zu holen, und für alle, die schon eine haben und nicht sicher sind, was sich dadurch ändert. Zwei Punkte tragen fast alles. Von einer ABN-Zahlung wird nichts einbehalten und es wird keine Super gezahlt, die Steuer kommt also am Jahresende auf einen Schlag statt nach und nach. Und eingestuft wird nach dem tatsächlichen Ablauf der Arbeit, nicht nach dem Wort auf dem Vertrag. Deshalb ist der Wechsel von der Gehaltsliste zur Rechnungsstellung bei gleicher Arbeit, gleichen Stunden und gleicher Weisung das Erste, was du hier lesen solltest.',
    ],
  ...
  'tax-return': {
    paragraphs: [
      ...
      'Das ist die Kategorie für jemanden, der entscheidet, ob er selbst einreicht oder es abgibt. Deshalb stehen die entscheidenden Punkte hier vollständig. Dein steuerlicher Wohnsitz, der sich danach richtet, wie du tatsächlich in Australien gelebt hast und nicht nach einer Tageszahl. Ob deine Staatsangehörigkeit ändert, welche Sätze nach der Wohnsitzfrage gelten. Die Wochen mit 45 Prozent Einbehalt, bevor die TFN bei der Lohnbuchhaltung war. Die Medicare Frage. Und die Abzüge, die zu deiner tatsächlichen Arbeit gehören. Nichts davon lässt sich in einer Tabelle nachschlagen, und alles davon muss an deinem eigenen Jahr gerechnet werden.',
    ],
  ...
  'super': {
    paragraphs: [
      ...
      'Sie sind für alle am Ende einer Working Holiday, und besonders für alle, die bei mehreren Arbeitgebern gejobbt haben und vermuten, dass das Geld auf mehreren Konten liegt. Zwei Dinge entscheiden über Betrag und Dauer. Ob vor dem Antrag jedes Konto unter deiner TFN gefunden wurde, denn ein Antrag leert nur die Fonds, die du nennst. Und wann der Antrag im Verhältnis zum Ablauf deines Visums gestellt wird. Die Auszahlung selbst wird bei Working Holiday Makern mit 65 Prozent besteuert. Das ist hoch, gesetzlich festgelegt und nicht gestaltbar. Was sich lohnt, ist, kein Konto zurückzulassen.',
    ],
  ...
  'medicare-and-other': {
    paragraphs: [
      ...
      'Eine kleine Kategorie mit einer sehr konkreten Zahl. Bei 25.000 Dollar Einkommen sind das 500 Dollar. Die Befreiung gibt es nicht automatisch, und das ATO wendet sie nicht von sich aus an. Sie muss in der Erklärung geltend gemacht werden, und dafür brauchst du ein Medicare Entitlement Statement von Services Australia, das beantragt werden muss und in der Regel Wochen dauert. Ob die Befreiung für dich überhaupt in Frage kommt, entscheidet dein Pass. Um diese beiden Punkte, die Vorlaufzeit und den Pass, geht es hier immer wieder.',
    ],
