...
const CATEGORY_INTRO: Record<string, CategoryIntro> = {
  ...
  'tax-return': {
    paragraphs: [
      ...
      'Das ist die Kategorie für jemanden, der entscheidet, ob er selbst einreicht oder es abgibt. Deshalb stehen die entscheidenden Punkte hier vollständig. Dein steuerlicher Wohnsitz, der eine Beurteilung deines ganzen Jahres ist und kein Kästchen, das sich beim ersten Lesen sicher ankreuzen lässt. Die Wochen mit 45 Prozent Einbehalt, bevor die TFN bei der Lohnbuchhaltung war. Die Medicare Frage. Und die Abzüge, die zu deiner tatsächlichen Arbeit gehören. Nichts davon lässt sich in einer Tabelle nachschlagen, und alles davon muss an deinem eigenen Jahr gerechnet werden.',
    ],
