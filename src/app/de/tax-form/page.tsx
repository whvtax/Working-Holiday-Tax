...
export const metadata: Metadata = {
  ...
  description: 'Reiche deine australische Steuererklärung als Working Holiday Maker online ein - meistens innerhalb von 24 Stunden unter Aufsicht eines registrierten Steueragenten beim ATO eingereicht.',
