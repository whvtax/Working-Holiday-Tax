...
const CATEGORY_INTRO: Record<string, CategoryIntro> = {
  ...
  'tax-return': {
    paragraphs: [
      ...
      '自分で提出するか任せるかを決める段階の人のためのカテゴリーなので、金額を動かす要素はすべてここに書いてあります。ご本人の事情によって決まり、きちんと確認する必要がある税務上の居住区分。その判定が1年全体の計算に及ぼし得る影響。TFNが給与担当に届く前に45%で引かれていた期間。メディケア税の扱い。そして実際にした仕事に対応する控除。どれも表を見て調べられるものではなく、すべてあなた自身の1年に当てはめて計算する必要があります。',
    ],
