...
const MYGOV = [
  ...
  },
  {
    ...
    us: '日本のパスポートでも非課税枠が適用され得ます。当社はその立場を取り、根拠をもって申告します。',
  },
  {
        ...
        <div className="max-w-[1280px] mx-auto px-5 md:px-8 lg:px-12">
          <div className="max-w-[680px]">
            ...
            <p style={{ fontSize: '15px', lineHeight: 1.85, color: '#2A3C34', marginBottom: '14px' }}>
              3つあり、どれもこのページには入っていません。1つ目は居住区分です。日本のパスポートでも、最初の1ドルからワーホリ税率がかかるのではなく、18,200ドルの非課税枠が使える場合があります。滞在日数で自動的に決まるものではなく、状況を踏まえた判断であり、他のどの要素よりも金額への影響が大きい部分です。
            </p>
            <p style={{ fontSize: '15px', lineHeight: 1.85, color: '#2A3C34', marginBottom: '14px' }}>
