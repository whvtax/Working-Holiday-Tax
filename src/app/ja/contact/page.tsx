...
const blockers: { q: string; a: string; link?: { href: string; label: string } }[] = [
  ...
  {
    q: 'この会社は信用できますか？',
    a: 'ウェブサイトに対して当然の質問だと思います。タックスリターンは当社のチームが作成し、ATOに提出される前に登録税理士（registered tax agent）が確認して承認します。ご同意いただく契約条件はクライアント規約にすべて掲載していますし、Googleのレビューは実際にお手伝いしたワーホリの方々によるものです。',
