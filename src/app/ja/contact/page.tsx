...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'はい。日本に帰国された後でも、オーストラリアのタックスリターン還付金、スーパー（DASP）、その他の税務手続きを日本からオンラインで申請できます。すべての手続きはオンラインで完結し、オーストラリアに戻る必要はありません。還付金は日本の銀行口座でもお受け取りいただけます。',
  },
  {
        ...
        <div className="max-w-[640px] mx-auto px-5 md:px-8 lg:px-12">
          ...
          <div className="contact-hours-block">
            ...
            <p className="contact-hours-detail">
              月曜〜金曜、9時〜18時（AEST オーストラリア東部標準時）<br />
