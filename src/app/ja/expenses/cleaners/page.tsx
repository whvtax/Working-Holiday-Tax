...
const SECTIONS: Section[] = [
  {
    ...
    "paras": [
      ...
      "清掃が特殊なのは、仕事そのものが移動することです。1日に3軒回れば控除できる移動が2区間あり、1年で見ればモップ、クロス、洗剤をすべて足したよりも大きい、申告のなかで最大の項目になるのが普通です。"
    ]
  },
  {
    "kind": "items",
  ...
  },
  {
    ...
    "h2": "清掃では何を残しておきますか？",
    "paras": [
      "どの控除も3つのテストを通ります。自分で支払ったこと、誰からも払い戻されていないこと、申告する収入を得るために使ったことです。清掃なら、洗剤と道具の領収書、そして移動した日付、住所、距離のメモがそれにあたります。",
      "記録は領収書でも請求書でも銀行明細でもよく、金額、日付、支払先、内容が分かれば足ります。スマホの写真でも構いません。5年間は保管してください。その年の仕事関連の控除が合計300ドル以下なら書面の証拠は不要ですが、金額の根拠は説明できる必要があります。掃除機1台をどう償却するかを決める300ドルとは、別のルールです。"
    ]
  },
  {
    "kind": "tables",
    ...
    "note": "1日に3、4軒回れば5,000kmは多くの人が思うより早く超えます。そこを過ぎると通常は運転日誌のほうが大きくなります。定額ではなく、ガソリン、保険、登録費用、整備、減価償却、車のローン利息まで拾えるからです。代償は12週間の記録と、すべての領収書です。"
  },
  {
    "kind": "traps",
    "h2": "清掃で働く人がよく間違えることは？",
    ...
    "missed": [
      ...
      {
        "t": "公表された単価での洗濯",
        "d": "保護衣類と必須制服の洗濯は1回1ドルまたは50セントで控除できます。申告する人はほとんどおらず、そもそも単価があること自体があまり知られていません。"
      },
      {
        "t": "始める準備として買った機材",
