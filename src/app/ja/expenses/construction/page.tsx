...
const SECTIONS: Section[] = [
  {
    ...
    "paras": [
      ...
      "リストが長いのは、この仕事が具体的な費用を生むからです。安全靴は落ちてきたブロックから、ヘルメットは頭上の危険から、日焼け止めは日陰のないスラブでの6時間から守ります。控除の判定が探しているのはこの結びつきで、だからこのサイトの職種のなかで現場作業は控除合計が最も大きくなります。"
    ]
  },
  {
    "kind": "items",
  ...
  },
  {
    ...
    "paras": [
      ...
      "領収書、請求書、銀行明細、スマホの写真のいずれでも、金額、日付、支払先、内容が分かれば足ります。5年間は保管してください。その年の仕事関連の控除が合計300ドル以下なら、書面の証拠は不要です。丸のこを一度に償却するか耐用年数で配分するかを決める300ドルとは、別のルールです。"
    ]
  },
  {
    "kind": "numbered",
