...
const FAQS = [
  ...
  },
  {
    ...
    "answer": "走行距離と車の維持費によります。キロメートル単価方式は領収書が不要な代わりに年5,000kmで頭打ちになり、それを超えた分は失われます。運転日誌方式には上限がなく、ガソリン、保険、登録費用、整備、減価償却、ローン利息を仕事使用割合で拾えますが、連続12週間の記録とすべての支出の領収書が必要です。"
  },
  {
