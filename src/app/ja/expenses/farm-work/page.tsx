...
const faqs = [
  {
    ...
    answer: 'いいえ、必要ありません。1回のタックスリターンで、その会計年度（7月1日〜翌年6月30日）全体をカバーします。その間に何軒の農場や雇用主で働いたかは関係ありません。それぞれの雇用主が給与と源泉徴収税を個別にATOへ報告し、タックスリターンではそれらすべてがまとめて1つの申告になります。短期の仕事をいくつも掛け持ちした場合の一番のリスクは、そのうちの一つ、特に1週間程度の短い仕事を申告し忘れてしまうことです。登録税理士の監督のもとで、提出前にまさにこの点を確認しています。',
  },
  {
          ...
          <div className="max-w-[760px] mx-auto px-5 md:px-8 lg:px-12 reveal">
            ...
            <div className="rounded-2xl" style={{ padding: '20px 22px', background: '#FDF0D5', border: '1.5px solid #F9D88A', borderLeft: '4px solid #E9A020', margin: '22px 0' }}>
              ...
              <p className="font-light" style={{ fontSize: '13px', color: '#587066', lineHeight: 1.75 }}>
                具体的にどの業種、どの郵便番号や地域、どの期間が指定労働として認められるか、そして何日必要かを定めているのは税法ではなく内務省（Department of Home Affairs）であり、これまでに何度もルールが変更されてきました。こうした移民関連の詳細を追跡することは、登録税理士の監督のもとで行う当社の税務サービスの範囲には含まれません。特定の仕事がビザの条件を満たすと決めてかかる前に、
        ...
        <section className="bg-white" style={{ paddingTop: '38px', paddingBottom: '8px' }}>
          <div className="max-w-[680px] mx-auto px-5 md:px-8 lg:px-12 text-center">
            <p className="font-light" style={{ fontSize: '12.5px', color: '#8AADA3', lineHeight: 1.7 }}>
              これは一般的な情報であり、個別の税務アドバイスではありません。また、移民や渡航に関するアドバイスでもありません。農場でのシーズンは、どの雇用主で働くか、どの地域か、ビザとの関わり方まで、一人ひとり少しずつ異なります。当社にご依頼いただいた場合、タックスリターンは登録税理士の監督のもとで作成され、お客様の具体的な雇用主や状況を確認したうえで、請求できるものはすべて、請求できないものは含めないようにいたします。
            </p>
          </div>
        </section>
