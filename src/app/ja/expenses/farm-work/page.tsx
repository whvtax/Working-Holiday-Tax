...
const SECTIONS: Section[] = [
  {
    ...
    "paras": [
      ...
      "日焼け止めはオーストラリアではほとんどの人にとって私的な支出です。あなたの場合に控除できるのは、仕事が何時間も直射日光の下に置くからで、ATOはそれを生活上の選択ではなく業務上の曝露として扱います。"
    ]
  },
  {
    "kind": "items",
  ...
  },
  {
    ...
    "paras": [
      ...
      "領収書、請求書、銀行明細、スマホの写真のいずれでも、金額、日付、支払先、内容が分かれば足ります。5年間は保管してください。その年の仕事関連の控除が合計300ドル以下なら、書面の証拠は不要です。1点を一度に償却するか耐用年数で配分するかを決める300ドルとは、別のルールです。"
    ]
  },
  {
    "kind": "traps",
  ...
  },
  {
    ...
    "paras": [
      ...
      "より大きいのは税務上の居住区分です。高等裁判所のAddy判決が示すとおり、ここに大きな金額がかかることがあります。このページのどの領収書より価値があり、ご本人の状況によって決まるため、当社は1年の実態を確認してからでなければ立場を決めません。",
