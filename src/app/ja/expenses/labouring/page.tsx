...
const SECTIONS: Section[] = [
  {
    ...
    "paras": [
      ...
      "冷蔵倉庫で1週間、造園クルーで1週間、週末はイベントの撤収となれば、必要な費用は3種類生じます。控除は1つの職種名ではなく、実際の作業に従います。"
    ]
  },
  {
    "kind": "items",
  ...
  },
  {
    ...
    "paras": [
      ...
      "領収書、請求書、銀行明細、スマホの写真のいずれでも、金額、日付、支払先、内容が分かれば足ります。5年間は保管してください。その年の仕事関連の控除が合計300ドル以下なら、書面の証拠は不要です。装備を一度に償却するか耐用年数で配分するかを決める300ドルとは、別のルールです。"
    ]
  },
  {
    "kind": "traps",
  ...
  },
  {
    ...
    "paras": [
      "どれだけ巡回的な働き方だったかが、移動のどこまでを控除できるかを決めます。ルールではなく事実認定です。現場がどれだけ変わったか、いつも戻る拠点があったか、エージェンシーが移動を求めていたか、1週間がどう組まれていたか。同じエージェンシーの2人でも控除額は大きく変わります。",
      "エージェンシーはそれぞれ別の雇用主なので、Tax File Number Declarationも源泉徴収の関係もインカムステートメントも別々になります。ワーキングホリデーメーカーはどの雇用主からも非課税枠を受けられないので、危ないのは非課税枠の二重取りではありません。誤った税率の適用と、申告から抜ける雇用主です。",
...
const FAQS = [
  {
    ...
    "answer": "エージェンシーはそれぞれ法的に別の雇用主で、Tax File Number Declarationも源泉徴収も、年度末のインカムステートメントも各社別々です。それらはすべて1つの申告に入ります。ワーキングホリデーメーカーの賃金は非課税枠ではなくワーキングホリデーメーカーの税率で課税されるため、複数社で危ないのは税率ではなく、どこか1社が抜けることです。"
  },
  {
