...
export const metadata: Metadata = {
  ...
  description:
    'オーストラリアのワーキングホリデー（417・462ビザ）専門。登録税理士の監督のもとで、タックスリターン還付金の受取、TFN申請、スーパー返金（DASP）、ABN登録までオンラインで完結。',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'オーストラリアのワーホリ（417・462ビザ）専門。登録税理士の監督のもとで、タックスリターン還付金、TFN、スーパー返金（DASP）まですべてオンライン。',
    images: [{
