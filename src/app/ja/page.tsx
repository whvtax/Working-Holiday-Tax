...
const STEPS = [
  ...
  { n: '4', title: '還付金をお受け取り',     body: '還付金は、ご指定のオーストラリアまたは日本の銀行口座へ直接お振り込みします。' },
]
...
const FAQS = [
  ...
  },
  {
    ...
    answer: 'はい、もちろん対応いたします。すでにオーストラリアを離れて日本に帰国された方のワーホリ タックスリターンや、スーパーアニュエーション返金（DASP）も、日本からオンラインで申請可能です。還付金はオーストラリアの口座でも、日本を含む海外の口座でもお受け取りいただけます。',
  },
  {
