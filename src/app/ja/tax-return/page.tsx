...
const faqs = [
  ...
  },
  {
    ...
    answer: 'はい、日本帰国後でも世界中どこからでも提出できます。当社の登録税理士サービスを通じてオンラインで完結し、タックスリターン還付金はオーストラリアの口座でも日本の口座でも受け取り可能です。帰国後でも数年遡って申請できるケースもあります。',
  },
  {
...
const STEPS = [
  ...
  { n: '4', title: '還付金をお受け取り',     body: '通常7〜14営業日でご指定のオーストラリアまたは日本の銀行口座に還付金が振り込まれます。' },
]
