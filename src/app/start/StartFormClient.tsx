...
const COPY = {
  en: {
    ...
    doneTitle: 'Thank you',
    doneBody: 'We\u2019ve received your details and will review them shortly.',
  ...
  de: {
    ...
    doneTitle: 'Danke',
    doneBody: 'Wir haben deine Angaben erhalten und prüfen sie in Kürze.',
  ...
  ja: {
    ...
    doneBody: 'ご入力内容を受け付けました。確認のうえご連絡いたします。',
