        ...
        <div className="max-w-[1280px] mx-auto px-5 md:px-8 lg:px-12 reveal">
          <div className="max-w-xl mx-auto">
            ...
            <div className="space-y-0">
              {[{ n:'01', label:'Passport', hint:'For identity verification' }, { n:'02', label:'Tax File Number (TFN)', hint:'Your unique tax ID' }, { n:'03', label:'Super fund details', hint:'Or we help you find them' }, { n:'04', label:'Bank account', hint:'Where to send your refund' }].map((item, i) => (
