              ...
              <div className="space-y-3 mb-5 max-w-[460px]">
                {[
                  ...
                  <div key={i} className="flex items-start gap-2.5">
                    ...
                    <p className="text-[13px] font-light text-body leading-[1.7]">{point}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="space-y-0">
                {[
                  ...
                  <div key={i} className="py-4" style={{ borderTop: '1px solid #E2EFE9' }}>
                    <p className="text-[13px] font-semibold text-ink mb-1" style={{ letterSpacing: '-0.01em' }}>{item.label}</p>
              ...
              <div className="space-y-3 mb-5">
                {[
                  ...
                  <div key={i} className="flex items-start gap-2.5">
                    ...
                    <p className="text-[13px] font-light text-body leading-[1.65]">{item}</p>
                  </div>
                ))}
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 reveal delay-1">
            {MISTAKES.map((m, i) => (
              <div key={i} className="rounded-xl p-4 flex flex-col" style={{ background: '#FFFCF5', border: '1.5px solid #F0D99A', boxShadow: '0 1px 4px rgba(0,0,0,.04)' }}>
                ...
                <p className="text-[12px] font-light text-muted leading-[1.7] flex-1">{m.body}</p>
              </div>
            ))}
          </div>
