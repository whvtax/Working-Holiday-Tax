...
export const formStrings = {
  ...
  // The expense-invoice picker (Jo, 28 Aug). Required once the client says they
  // HAVE work expenses (Jo, 2 Sep): if you claim expenses you must attach the
  // receipts before the form will move on to the residency page.
  ...
  invoicesRequired:    { en: 'Please upload your receipts to continue.', de: 'Bitte lade deine Belege hoch, um fortzufahren.', ja: '続行するには領収書をアップロードしてください。' },
